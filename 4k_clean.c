...
#define A_8(a, b, c, d, e, f, g, h, i, j...) i
#define A_9(a, b, c, d, e, f, g, h, i, j, k...) j
#define A_10(a, b, c, d, e, f, g, h, i, j, k, l...) k
...
G(1, [[nodiscard]] S(1) A(1, i32, u32, i64, u64) atoi(const char* restrict string) {
  A(1, i32, u32, i64, u64) result = 0;
  while (*string)
    result = result * 10 + *string++ - '0';
  return result;
})

G(1, typedef struct [[nodiscard]] {
...
[[nodiscard]] S(1) u64 get_time() {
  ...
  return G(2, ts.tv_nsec) + G(2, G(3, ts.tv_sec) * G(3, 1000 * 1000 * 1000ULL));
})
...
G(1, // Non-standard, gets but a word instead of a line
  ...
  while (true) {
    ...
    const A(1, char, i8, u8, i32) ch = *string;
    if (ch <= ' ') {
      *string = 0;
      return ch != '\n';
    }
...
G(1, S(0) void exit_now() {
  asm volatile("syscall" : : "a"(60));
  __builtin_unreachable();
})

G(1, [[nodiscard]] static bool strcmp(const char* restrict lhs, const char* restrict rhs) {
  while (*lhs || *rhs) {
    if (*lhs != *rhs) {
      return true;
    }
...
G(1, S(0) void putl(const char* const restrict string) {
...
G(7, [[nodiscard]] S(1) bool move_string_equal(G(8, const char* restrict rhs), G(8, const char* restrict lhs)) {
  return (G(9, *(const u64a*)rhs) ^ G(9, *(const u64a*)lhs)) << 24 == 0;
})

G(7, [[nodiscard]] S(1) u64 flip_bb(const u64 bb) { return __builtin_bswap64(bb); })
G(7, [[nodiscard]] S(1) A(4, i8, u8, i16, u16, i32, u32, i64, u64) lsb(u64 bb) { return __builtin_ctzll(bb); })

G(7, [[nodiscard]] S(1) u64 shift(H(10, 1, const A(2, i8, i16, i32, i64) shift), H(10, 1, const u64 mask), H(10, 1, const u64 bb)) {
  return shift > 0 ? G(11, bb << shift) & G(11, mask) : G(12, bb >> -shift) & G(12, mask);
})

G(7, [[nodiscard]] S(1) A(5, i8, u8, i16, u16, i32, i64) count(const u64 bb) { return __builtin_popcountll(bb); })
...
G(13, [[nodiscard]] S(1) u64 east(const u64 bb) { return G(15, bb << 1) & G(15, ~0x101010101010101ull); })

G(16, [[nodiscard]] S(1) u64 southeast(const u64 bb) {
  return G(17, shift(H(10, 2, -7), H(10, 2, ~0x101010101010101ull), H(10, 2, bb)));
  return G(17, G(18, east)(G(18, south)(bb)));
})

G(16, [[nodiscard]] S(1) u64 northeast(const u64 bb) {
  return G(19, G(20, east)(G(20, north)(bb)));
  return G(19, shift(H(10, 3, 9), H(10, 3, ~0x101010101010101ull), H(10, 3, bb)));
})

G(16, [[nodiscard]] S(1) u64 northwest(const u64 bb) {
  return G(21, shift(H(10, 4, 7), H(10, 4, ~0x8080808080808080ull), H(10, 4, bb)));
  return G(21, G(22, west)(G(22, north)(bb)));
})

G(16, [[nodiscard]] S(1) u64 southwest(const u64 bb) {
  return G(23, G(24, west)(G(24, south)(bb)));
  return G(23, shift(H(10, 5, -9), H(10, 5, ~0x8080808080808080ull), H(10, 5, bb)));
})
...
G(25, [[nodiscard]] S(0) u64 xattack(H(27, 1, const u64 blockers), H(27, 1, const u64 bb), H(27, 1, const u64 dir_mask)) {
  return G(28, dir_mask) &
    G(28, (G(29, (G(30, blockers) & G(30, dir_mask)) - bb) ^ G(29, flip_bb(flip_bb(G(31, blockers) & G(31, dir_mask)) - flip_bb(bb)))));
})

G(32, [[nodiscard]] S(0) u64 king(const u64 bb) {
  const u64 vertical = G(33, north(bb)) | G(33, south(bb));
  const u64 vertical_inclusive = G(34, bb) | G(34, vertical);
  return G(35, vertical) | G(35, east(vertical_inclusive)) | G(35, west(vertical_inclusive));
})

G(32, [[nodiscard]] S(0) u64 knight(const u64 bb) {
...
G(32, [[nodiscard]] S(0) u64 rook(H(41, 1, const u64 blockers), H(41, 1, const u64 bb)) {
  assert(count(bb) == 1);
  return G(42, // West
    ray(H(26, 2, blockers), H(26, 2, ~0x8080808080808080ull), H(26, 2, bb), H(26, 2, -1))) |
    G(42, // East
      ray(H(26, 3, blockers), H(26, 3, ~0x101010101010101ull), H(26, 3, bb), H(26, 3, 1))) |
    G(42, xattack(H(27, 2, blockers), H(27, 2, bb), H(27, 2, bb ^ 0x101010101010101ULL << lsb(bb) % 8)));
})

G(32, [[nodiscard]] S(0) u64 bishop(H(43, 1, const u64 blockers), H(43, 1, const u64 bb)) {
  assert(count(bb) == 1);
...
G(46, S(1) void swapu32(G(47, u32a* const lhs), G(47, u32a* const rhs)) {
  const u32 temp = *lhs;
  *lhs = *rhs;
  *rhs = temp;
}

S(1) void swapmoves(G(48, Move* const lhs), G(48, Move* const rhs)) { swapu32(G(49, (u32a*)rhs), G(49, (u32a*)lhs)); })

G(46, S(1) void move_str(H(50, 1, const A(5, bool, i8, u8, i16, u16, i32, u32, i64, u64) flip), H(50, 1, const Move* restrict move),
  ...
  G(51, str[4] = "\0\0nbrq"[move->promo];)
    ...
    G(51, // Hack to save bytes, technically UB but works on GCC 14.2
      for (A(4, i8, u8, i16, u16, i32, u32, i64, u64) i = 0; i < 2; i++) {
...
G(46, [[nodiscard]] S(1) bool move_equal(G(53, Move* const rhs), G(53, Move* const lhs)) { return G(54, *(u32a*)lhs) == G(54, *(u32a*)rhs); })

G(46, [[nodiscard]] S(0) A(6, i8, u8, i16, u16, i32, u32, i64, u64)
  piece_on(H(55, 1, const Position* const restrict pos), H(55, 1, const A(4, i8, u8, i16, u16, i32, u32, i64, u64) sq)) {
  assert(sq >= 0);
  assert(sq < 64);
  for (A(5, i8, u8, i16, u16, i32, u32, i64, u64) i = Pawn; i <= King; ++i) {
...
G(57, [[nodiscard]] S(1) A(6, bool, i8, u8, i16, u16, i32, u32, i64, u64) is_attacked(H(58, 1, const Position* const restrict pos), H(58, 1, const u64 bb)) {
  assert(count(bb) == 1);
...
G(57, [[nodiscard]] S(1) u64 get_mobility(H(69, 1, const Position* pos), H(69, 1, const A(6, i8, u8, i16, u16, i32, u32, i64, u64) piece),
  H(69, 1, const A(6, i8, u8, i16, u16, i32, u32, i64, u64) sq)) {
  u64 moves = 0;
  ...
  G(70, if (piece == King) { moves = king(bb); })
    ...
    G(72, if (piece != Bishop) { moves |= rook(H(41, 3, blockers), H(41, 3, bb)); })
      G(72, if (piece != Rook) { moves |= bishop(H(43, 3, blockers), H(43, 3, bb)); })
  }
  return moves;
})

G(57, S(0) void flip_pos(Position* const restrict pos) {
  G(67, // Hack to flip the first 10 bitboards in Position.
    u64a * pos_ptr = (u64a*)pos;
  for (A(4, i8, u8, i16, u16, i32, u32, i64, u64) i = 0; i < 10; i++) { pos_ptr[i] = flip_bb(pos_ptr[i]); })
    G(67, pos->colour[0] ^= pos->colour[1]; pos->colour[1] ^= pos->colour[0]; pos->colour[0] ^= pos->colour[1];)

    G(67, pos->castling32 = G(68, (pos->castling32 >> 16)) | G(68, (pos->castling32 << 16));)
    G(67, pos->flipped ^= 1;)
})

S(0) A(5, bool, i8, u8, i16, u16, i32, u32, i64, u64) find_in_check(const Position* restrict pos) {
  return is_attacked(H(58, 2, pos), H(58, 2, G(73, pos->colour[0]) & G(73, pos->pieces[King])));
}

G(74, S(1) Move* generate_piece_moves(H(75, 1, const u64 to_mask), H(75, 1, Move* restrict movelist), H(75, 1, const Position* restrict pos)) {
  for (A(5, i8, u8, i16, u16, i32, u32, i64, u64) piece = Knight; piece <= King; piece++) {
    assert(piece == Knight || piece == Bishop || piece == Rook || piece == Queen || piece == King);
    u64 copy = G(76, pos->colour[0]) & G(76, pos->pieces[piece]);
    while (copy) {
      const A(0, i8, u8, i16, u16, i32, u32, i64, u64) from = lsb(copy);
      assert(from >= 0);
      assert(from < 64);
      G(77, u64 moves = G(78, to_mask) & G(78, get_mobility(H(69, 2, pos), H(69, 2, piece), H(69, 2, from)));)

        G(77, copy &= copy - 1;)

        while (moves) {
          const A(1, i8, u8, i16, u16, i32, u32, i64, u64) to = lsb(moves);
          assert(to >= 0);
          assert(to < 64);

          G(79, moves &= moves - 1;)
            G(79, *movelist++ = ((Move) { .from = from, .to = to, .promo = None, .takes_piece = piece_on(H(55, 2, pos), H(55, 2, to)) });)
        }
    }
  }
...
G(74, S(0) Move* generate_pawn_moves(H(93, 1, u64 to_mask), H(93, 1, const Position* const pos), H(93, 1, Move* restrict movelist),
  H(93, 1, const A(3, i8, i16, i32, i64) offset)) {
  while (to_mask) {
    const A(1, i8, u8, i16, u16, i32, u32, i64, u64) to = lsb(to_mask);
    to_mask &= to_mask - 1;
    const A(1, i8, u8, i16, u16, i32, u32, i64, u64) from = G(94, to) + G(94, offset);
    assert(from >= 0);
    assert(from < 64);
    assert(to >= 0);
    assert(to < 64);
    assert(piece_on(H(55, 5, pos), H(55, 5, from)) == Pawn);
    const A(1, i8, u8, i16, u16, i32, u32, i64, u64) takes = piece_on(H(55, 6, pos), H(55, 6, to));
    if (to > 55) {
      for (A(6, i8, u8, i16, u16, i32, u32, i64, u64) piece = Queen; piece >= Knight; piece--) {
...
G(74, S(0) A(6, bool, i8, u8, i16, u16, i32, u32, i64, u64) makemove(H(80, 1, Position* const restrict pos), H(80, 1, const Move* const restrict move)) {
  assert(move->from >= 0);
  assert(move->from < 64);
  assert(move->to >= 0);
  assert(move->to < 64);
  ...
  G(81, const u64 from = 1ull << move->from;)
    ...
    G(82, const A(4, i8, u8, i16, u16, i32, u32, i64, u64) piece = piece_on(H(55, 4, pos), H(55, 4, move->from)); assert(piece != None);)
  ...
  G(89, // Pawn double move
    if (G(90, move->to - move->from == 16) && G(90, piece == Pawn)) { pos->ep = south_to; })
...
movegen(H(95, 1, const Position* const restrict pos), H(95, 1, const A(7, bool, i8, u8, i16, u16, i32, u32, i64, u64) only_captures),
  ...
  G(96, const u64 all = G(97, pos->colour[1]) | G(97, pos->colour[0]);)
    ...
    G(98, // PAWN PROMOTIONS
      if (!only_captures) {
        movelist = generate_pawn_moves(
          H(93, 2, G(99, north(G(100, north(G(101, pos->colour[0]) & G(101, pos->pieces[Pawn]) & G(101, 0xFF00))) & G(100, ~all))) & G(99, ~all)),
          H(93, 2, pos), H(93, 2, movelist), H(93, 2, -16));
      })
    G(98, // PAWN EAST CAPTURES
      movelist = generate_pawn_moves(
        H(93, 5, G(107, northeast(G(108, pos->colour[0]) & G(108, pos->pieces[Pawn]))) & G(107, (G(109, pos->colour[1]) | G(109, pos->ep)))), H(93, 5, pos),
    ...
    G(98, // LONG CASTLE
      if (G(110, !only_captures) && G(110, !(G(111, all) & G(111, 0xEull))) && G(110, pos->castling[1]) &&
        G(112, !is_attacked(H(58, 3, pos), H(58, 3, 1ULL << 3))) &&
        G(112, !is_attacked(H(58, 4, pos), H(58, 4, 1ULL << 4)))) {
        *movelist++ = (Move){ .from = 4, .to = 2, .promo = None, .takes_piece = None };
      })
    G(98, // SHORT CASTLE
      if (G(113, !only_captures) && G(113, !(G(114, all) & G(114, 0x60ull))) && G(113, pos->castling[0]) &&
        G(115, !is_attacked(H(58, 5, pos), H(58, 5, 1ULL << 5))) &&
        G(115, !is_attacked(H(58, 6, pos), H(58, 6, 1ULL << 4)))) {
        *movelist++ = (Move){ .from = 4, .to = 6, .promo = None, .takes_piece = None };
      })
    G(98, // PAWN WEST CAPTURES
      movelist = generate_pawn_moves(
        H(93, 4, G(104, northwest(G(105, pos->colour[0]) & G(105, pos->pieces[Pawn]))) & G(104, (G(106, pos->colour[1]) | G(106, pos->ep)))), H(93, 4, pos),
        H(93, 4, movelist), H(93, 4, -7));)
    movelist = generate_piece_moves(H(75, 2, to_mask), H(75, 2, movelist), H(75, 2, pos));

  const A(3, u8, i16, u16, i32, u32, i64, u64) num_moves = movelist - start;
...
[[nodiscard]] S(1) u64 perft(const Position* const restrict pos, const i32 depth) {
  if (depth == 0) {
    return 1;
  }
  ...
  const i32 num_moves = movegen(H(95, 2, pos), H(95, 2, false), H(95, 2, moves));
...
typedef struct [[nodiscard]] __attribute__((packed)) {
  i16 material[6];
  H(116, 1, H(117, 1, i8 king_shield[2];) H(117, 1, i8 piece_threats[2];) H(117, 1, i8 passed_king_distance[2];) H(117, 1, i8 bishop_pawns[2];)
    H(117, 1, i8 pawn_threat[5];))
    H(116, 1, H(119, 1, i8 pawn_attacked_penalty[2];) H(119, 1, i8 passed_blocked_pawns[6];) H(119, 1, i8 tempo;) H(119, 1, i8 mobilities[5];) H(119, 1, i8 pst_file[48];)
      H(119, 1, i8 open_files[12];))
    H(116, 1, H(118, 1, i8 passed_pawns[6];) H(118, 1, i8 protected_pawn[6];) H(118, 1, i8 bishop_pair;) H(118, 1, i8 phalanx_pawn[6];) H(118, 1, i8 pst_rank[48];)
      H(118, 1, i8 king_attacks[5];))
} EvalParams;

typedef struct [[nodiscard]] __attribute__((packed)) {
  i32 material[6];
  H(116, 2, H(117, 2, i32 king_shield[2];) H(117, 2, i32 piece_threats[2];) H(117, 2, i32 passed_king_distance[2];) H(117, 2, i32 bishop_pawns[2];)
    H(117, 2, i32 pawn_threat[5];))
    H(116, 2, H(119, 2, i32 pawn_attacked_penalty[2];) H(119, 2, i32 passed_blocked_pawns[6];) H(119, 2, i32 tempo;) H(119, 2, i32 mobilities[5];)
      H(119, 2, i32 pst_file[48];) H(119, 2, i32 open_files[12];))
    H(116, 2, H(118, 2, i32 passed_pawns[6];) H(118, 2, i32 protected_pawn[6];) H(118, 2, i32 bishop_pair;) H(118, 2, i32 phalanx_pawn[6];) H(118, 2, i32 pst_rank[48];)
...
G(121, // EVAL PARAMETERS
  __attribute__((aligned(8))) S(1) C(1) EvalParamsInitial initial_params = { .phases = {0, 0, 1, 1, 2, 4},
                                                                            .mg =
                                                                                {
                                                                                    .material = {0, 68, 291, 330, 382, 844},
                                                                                    .pst_rank =
                                                                                        {
                                                                                            0,   -15, -18, -4,  6,  30, 126, 0,   // Pawn
                                                                                            -20, -5,  8,   23,  30, 35, 12,  -83, // Knight
                                                                                            -8,  10,  16,  18,  16, 16, -9,  -59, // Bishop
                                                                                            7,   -2,  -8,  -11, 3,  12, -2,  1,   // Rook
                                                                                            13,  15,  7,   1,   -4, -2, -20, -11, // Queen
                                                                                            -7,  1,   -10, -23, -6, 37, 44,  44,  // King
                                                                                        },
                                                                                    .pst_file =
                                                                                        {
                                                                                            -7,  -11, -8,  1,   6,   12,  12, -6,  // Pawn
                                                                                            -30, -11, -1,  12,  14,  14,  7,  -5,  // Knight
                                                                                            -15, 0,   3,   1,   4,   -1,  10, -4,  // Bishop
                                                                                    ...
                                                                                    .open_files = {8, -11, -11, 17, -2, -22, 8, -9, -11, 33, -11, -57},
                                                                                    .passed_pawns = {-9, -2, 9, 41, 76, 126},
                                                                                    .passed_blocked_pawns = {-1, -5, -3, 3, 3, -48},
                                                                                    .passed_king_distance = {-1, -2},
                                                                                    .protected_pawn = {0, 20, 12, 19, 32, 127},
                                                                                    .phalanx_pawn = {7, 12, 20, 37, 127, 127},
                                                                                    .bishop_pair = 27,
                                                                                    .bishop_pawns = {-5, -5},
                                                                                    .king_shield = {29, 18},
                                                                                    .pawn_attacked_penalty = {-57, -113},
                                                                                    .piece_threats = {25, 17},
                                                                                    .tempo = 30,
                                                                                },
                                                                            .eg = {
                                                                                .material = {0, 86, 406, 443, 738, 1373},
                                                                                .pst_rank =
                                                                                    {
                                                                                        0,   0,   -7,  -6, -1, 14, 93, 0,   // Pawn
                                                                                        -29, -16, -6,  16, 21, 6,  2,  6,   // Knight
                                                                                        -11, -10, 0,   3,  6,  2,  4,  7,   // Bishop
                                                                                        -17, -18, -10, 4,  10, 9,  17, 5,   // Rook
                                                                                        -56, -40, -12, 13, 29, 24, 29, 12,  // Queen
                                                                                        -36, -4,  4,   18, 31, 31, 19, -38, // King
                                                                                    },
                                                                                .pst_file =
                                                                                    {
                                                                                        2,   7,  -1, -6, -1, 1,  1,  -3,  // Pawn
                                                                                        -18, -5, 8,  17, 16, 4,  -3, -21, // Knight
                                                                                        -9,  -1, 4,  10, 10, 4,  -5, -14, // Bishop
                                                                                        1,   6,  5,  -3, -6, 0,  0,  -3,  // Rook
                                                                                        -22, -7, 4,  8,  15, 14, -1, -10, // Queen
                                                                                        -29, -1, 11, 17, 19, 14, 4,  -30, // King
                                                                                    },
                                                                                .mobilities = {4, 3, 4, 2, -4},
                                                                                .king_attacks = {0, -2, -7, 8, 0},
                                                                                .pawn_threat = {-2, -5, -17, -13, -6},
                                                                                .open_files = {7, 3, 18, 9, 25, 8, 23, -7, 3, 12, 43, 7},
                                                                                .passed_pawns = {13, 3, 20, 47, 100, 93},
                                                                                .passed_blocked_pawns = {-11, -3, -12, -29, -67, -70},
                                                                                .passed_king_distance = {-5, 9},
                                                                                .protected_pawn = {0, 16, 15, 19, 45, 22},
                                                                                .phalanx_pawn = {6, 15, 26, 81, 127, 127},
                                                                                .bishop_pair = 57,
                                                                                .bishop_pawns = {-11, -1},
                                                                                .king_shield = {-9, -7},
                                                                            ...
                                                                            G(121, [[nodiscard]] S(1) A(0, i32, i64) combine_eval_param(H(122, 1, const A(1, i16, i32, i64) mg_val), H(122, 1, const A(2, i16, i32, i64) eg_val)) {
  return G(123, mg_val) + G(123, (eg_val << 16));
})

S(0) A(1, i16, i32, i64) eval(Position* const restrict pos) {
  G(124, A(0, i32, i64) score = eval_params.tempo;)
    G(124, A(4, i8, u8, i16, u16, i32, i64) phase = 0;)

    for (A(4, i8, u8, i16, u16, i32, u32, i64, u64) c = 0; c < 2; c++) {

      G(125, const u64 opp_king_zone = king(G(127, pos->pieces[King]) & G(127, pos->colour[1]));)

        G(125, u64 pawns[2]; for (A(0, i8, u8, i16, u16, i32, u32, i64, u64) i = 0; i < 2; i++) {
      ...
      G(130, const u64 no_passers = G(131, pawns[1]) | G(131, attacked_by_pawns);))
        G(125, // BISHOP PAIR
          if (count(G(126, pos->pieces[Bishop]) & G(126, pos->colour[0])) > 1) { score += eval_params.bishop_pair; })
        for (A(4, i8, u8, i16, u16, i32, u32, i64, u64) p = Pawn; p <= King; p++) {
          ...
          while (copy) {
            ...
            G(137, const u64 piece_bb = 1ULL << sq;)
              ...
              G(93, G(998, // PHALANX PAWNS
                if (G(309, p == Pawn) && G(309, G(310, piece_bb) & G(310, west(pawns[0])))) { score += eval_params.phalanx_pawn[rank - 1]; })

                G(998, // PROTECTED PAWNS
                  if (G(300, p == Pawn) && G(300, G(307, piece_bb) & G(307, (G(308, northwest(pawns[0])) | G(308, northeast(pawns[0])))))) {
                    score += eval_params.protected_pawn[rank - 1];
                  }))

              G(93, // PASSED PAWNS
                if (G(143, p == Pawn) && G(143, !(G(144, in_front) & G(144, no_passers)))) {
                  G(145, if (G(146, north(piece_bb)) & G(146, pos->colour[1])) { score += eval_params.passed_blocked_pawns[rank - 1]; })

                    G(145, score += eval_params.passed_pawns[rank - 1];)

                    // PASSED PAWN KING DISTANCE
                    for (A(6, i8, u8, i16, u16, i32, u32, i64, u64) i = 0; i < 2; i++) {
                      const A(5, i8, u8, i16, u16, i32, i64) king_sq = lsb(G(148, pos->colour[i]) & G(148, pos->pieces[King]));
                      G(149, const A(4, i8, u8, i16, u16, i32, i64) rank_distance = __builtin_abs(king_sq / 8 - G(150, 1) - G(150, rank));)
                        G(149, const A(4, i8, u8, i16, u16, i32, i64) file_distance = __builtin_abs(king_sq % 8 - file);)
                        score +=
                        G(151, (rank_distance > file_distance ? rank_distance : file_distance)) * G(151, (rank - 1)) * G(151, eval_params.passed_king_distance[i]);
                    }
                })

              G(93, // OPEN FILES / DOUBLED PAWNS
                if ((G(139, north(in_front)) & G(139, pawns[0])) == 0) {
                  score += eval_params.open_files[G(140, G(141, !(G(142, in_front) & G(142, pawns[1]))) * G(141, 6)) + G(140, -1) + G(140, p)];
                })

              G(93, if (p > Pawn) {
              G(155, // PAWN PUSH THREATS
                if (G(169, in_front) & G(169, ~piece_bb) & G(169, attacked_by_pawns)) { score += eval_params.pawn_threat[p - 2]; })

                G(155, // KING SHIELD
                  if (G(156, G(157, p) == G(157, King)) && G(156, G(158, piece_bb) & G(158, 0xC3D7))) {
                    const u64 shield = file < 3 ? 0x700 : 0xE000;
                    G(159, score += G(160, count(G(161, shield) & G(161, pawns[0]))) * G(160, eval_params.king_shield[0]);)
                      G(159, score += G(162, count(G(163, north(shield)) & G(163, pawns[0]))) * G(162, eval_params.king_shield[1]);)
                  })

                G(155, // PIECES ATTACKED BY PAWNS
                  if (G(164, piece_bb) & G(164, no_passers)) { score += eval_params.pawn_attacked_penalty[c]; })

                G(155, // BISHOP COLOUR PAWNS
                  if (G(165, p) == G(165, Bishop)) {
                    u64 mask = 0xAA55AA55AA55AA55ULL;
                    if (!(G(166, piece_bb) & G(166, mask))) {
                      mask = ~mask;
                    }
                    for (A(1, i8, u8, i16, u16, i32, u32, i64, u64) i = 0; i < 2; i++) {
                      score += G(167, eval_params.bishop_pawns[i]) * G(167, count(G(168, pawns[i]) & G(168, mask)));
                    }
                  })

                G(155, const u64 mobility = get_mobility(H(69, 3, pos), H(69, 3, p), H(69, 3, sq));

              G(170, // PIECE THREATS
                if (p < Queen) {
                  score += G(289, count(G(290, mobility) & G(290, pos->colour[1] & ~(G(291, pos->pieces[Pawn]) | G(291, attacked_by_pawns))))) *
                    G(289, eval_params.piece_threats[G(292, p) == G(292, Rook)]);
                })

                G(170, // MOBILITY
                  score += G(171, count(G(172, ~pos->colour[0]) & G(172, mobility) & G(172, ~attacked_by_pawns))) * G(171, eval_params.mobilities[p - 2]);)

                G(170, // KING ATTACKS
                  score += G(173, count(G(174, mobility) & G(174, opp_king_zone))) * G(173, eval_params.king_attacks[p - 2]);))
            })
  ...
  const A(0, i8, u8, i16, u16, i32, i64) stronger_side_pawns_missing = 8 - count(G(175, pos->colour[score < 0]) & G(175, pos->pieces[Pawn]));
...
typedef struct [[nodiscard]] {
  G(119, Move best_move;)
    ...
    G(119, A(3, u8, i16, u16, i32, u32, i64, u64) num_moves;)
    G(119, Move killer;)
    G(119, A(1, i16, i32, i64) static_eval;)
  } SearchStack;
...
[[nodiscard]] __attribute__((target("aes"))) S(1) u64 get_hash(const Position* const pos) {
  i128 hash = { 0 };

  // USE 16 BYTE POSITION SEGMENTS AS KEYS FOR AES
  const u8* const data = (const u8*)pos;
  for (A(0, i8, u8, i16, u16, i32, u32, i64, u64) i = 0; i < 6; i++) {
    i128 key;
...
#error "Unsupported architecture: get_hash only for x86_64 and aarch64"
  ...
  u64 hash = 0;
  for (A(4, i8, u8, i16, u16, i32, u32, i64, u64) c = 0; c < 2; c++) {
    for (A(4, i8, u8, i16, u16, i32, u32, i64, u64) p = Pawn; p <= Queen; p++) {
      hash = G(182, G(183, hash) * G(183, 9)) + G(182, count(G(184, pos->pieces[p]) & G(184, pos->colour[c])));
    }
  }
  return hash;
}
...
search(
  ...
  u64* nodes,
#endif
  H(186, 1, H(187, 1, Position* const pos), H(187, 1, ThreadData* data), H(187, 1, const A(0, i32, i64) beta), H(187, 1, A(1, i16, i32, i64) depth)),
  H(186, 1, H(188, 1, const A(2, i16, u16, i32, i64) ply), H(188, 1, A(0, i32, i64) alpha), H(188, 1, const A(0, bool, i8, u8, i16, u16, i32) do_null))) {
  assert(alpha < beta);
  assert(ply >= 0);
  ...
  G(305, i32(* const move_history)[6][64][64] = data->move_history;)
    ...
    G(305, // IN-CHECK EXTENSION
      const A(0, bool, i8, u8, i16, u16, i32) in_check = find_in_check(pos);
  depth += in_check;)

    G(305, // FULL REPETITION DETECTION
      const u64 tt_hash = get_hash(pos);)
    A(0, bool, i8, u8, i16, u16, i32) in_qsearch = depth <= 0;
  for (A(1, i16, i32, i64) i = G(189, ply); G(190, i >= 0) && G(190, do_null); i -= 2) {
  ...
  G(192, ss->best_move = (Move){ 0 };)
    ...
    const A(0, bool, i8, u8, i16, u16, i32) tt_hit = G(200, tt_entry->partial_hash) == G(200, tt_hash_partial);
  if (tt_hit) {
    ss->best_move = tt_entry->move;

    // TT PRUNING
    if (G(194, tt_entry->depth >= depth) && G(194, G(195, tt_entry->flag) != G(195, tt_entry->score <= alpha)) && G(194, G(196, alpha) == G(196, beta - 1))) {
  ...
  const A(1, bool, i8, u8, i16, u16, i32) improving = ply > 1 && static_eval > ss[-2].static_eval;
  ...
  if (G(203, !in_check) && G(203, G(204, alpha) == G(204, beta - 1))) {
    ...
    if (G(210, depth > 2) && G(210, do_null) && G(210, static_eval >= beta) &&
      G(210, G(329, pos->colour[0]) & G(329, ~(G(330, pos->pieces[King]) | G(330, pos->pieces[Pawn]))))) {
      Position npos = *pos;
      G(211, flip_pos(&npos);)
        G(211, npos.ep = 0;)
  ...
  G(213, G(214, ss)[G(214, 2)].position_hash = tt_hash;)
    ...
    for (A(3, u8, i16, u16, i32, u32, i64, u64) move_index = 0; move_index < ss->num_moves; move_index++) {
      ...
      G(215, A(0, i32, i64) move_score = ~0x1010101LL;)
        G(215, A(6, u8, i16, u16, i32, u32, i64, u64) best_index = 0;)
      ...
      G(222, // FORWARD FUTILITY PRUNING / DELTA PRUNING
        if (G(225, depth < 5) &&
          G(225, G(226, static_eval) + G(226, G(227, 176) * G(227, depth)) + G(226, initial_params.eg.material[moves[move_index].promo]) +
            ...
            alpha) &&
          G(225, moves_evaluated) && G(225, !in_check)) {
          break;
        })
      ...
      G(274, G(275, ss)[G(275, 2)].prev_move = moves[move_index];)
        ...
        A(0, i32, i64) low = moves_evaluated == 0 ? -beta : -alpha - 1;
      moves_evaluated++;
      ...
      while (true) {
        score = -search(
          ...
          nodes,
#endif
          H(186, 3, H(187, 3, &npos), H(187, 3, data), H(187, 3, -alpha), H(187, 3, depth - G(231, reduction) - G(231, 1))),
      ...
      // LATE MOVE PRUNING
      if (G(237, quiets_evaluated > (G(239, 1) + G(239, depth * depth)) >> !improving) && G(237, G(238, alpha) == G(238, beta - 1)) && G(237, !in_check)) {
        break;
      }
    }
...
S(1) void init() {
  G(80, // INIT DIAGONAL MASKS
    for (A(4, i8, u8, i16, u16, i32, u32, i64, u64) sq = 0; sq < 64; sq++) {
      const u64 bb = 1ULL << sq;
      G(251, u64 sw_bb = southwest(bb);)
        G(251, u64 ne_bb = northeast(bb);)
        for (A(6, i8, u8, i16, u16, i32, u32, i64, u64) i = 6; i > 0; i--) {
          G(252, sw_bb |= southwest(sw_bb);)
            G(252, ne_bb |= northeast(ne_bb);)
        }
      diag_mask[sq] = G(253, sw_bb) | G(253, ne_bb);
    })
    G(80, // MERGE EVAL PARAMS
      for (A(0, u8, i16, u16, i32, u32, i64, u64) i = 0; i < sizeof(EvalParamsMerged) / sizeof(i32); i++) {
  ...
  if (score > alpha && score < beta) {
    ...
    if (makemove(H(80, 5, &cur_pos), H(80, 5, &pv_move))) {
      ...
      while (seen_count < max_ply && halfmoves < 100) {
        ...
        Move moves[max_moves];
        const i32 num_moves = movegen(H(95, 5, &cur_pos), H(95, 5, false), H(95, 5, moves));
        i32 move_index = 0;
        ...
        putl(" ");
        move_str(H(50, 5, cur_pos.flipped), H(50, 5, &move), H(50, 5, move_name));
        putl(move_name);
...
#endif
  ThreadData* data) {
  A(1, i16, i32, i64) score = -inf;
#ifdef FULL
  for (A(4, i8, u8, i16, u16, i32, u32, i64, u64) depth = 1; depth < maxdepth; depth++) {
#else
      ...
      while (true) {
        G(255, const A(0, i32, i64) alpha = score - window;)
          ...
          score = search(
            ...
            & data->nodes,
#endif
            H(186, 4, H(187, 4, &data->pos), H(187, 4, data), H(187, 4, beta), H(187, 4, depth)), H(186, 4, H(188, 4, 0), H(188, 4, alpha), H(188, 4, false)));
#ifdef FULL
        if (data->thread_id == 0) {
        ...
        G(257, if (G(258, elapsed > data->max_time) || G(258, (G(259, score < beta) && G(259, score > alpha)))) { break; })
          G(257, window *= 2;)
      }
...
void run_smp() {
  ...
  char move_name[8];
  move_str(H(50, 3, main_data->pos.flipped), H(50, 3, &main_data->stack[0].best_move), H(50, 3, move_name));
  putl("bestmove ");
  puts(move_name);
}
...
#endif
#else
      for (A(6, i8, u8, i16, u16, i32, u32, i64, u64) i = 2 << main_data->pos.flipped; i > 0; i--) {
        getl(line);
        main_data->max_time = (u64)atoi(line) << 19; // Roughly /2 time
      }
      run_smp();
