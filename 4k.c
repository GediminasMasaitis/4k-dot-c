...
G(121, // EVAL PARAMETERS
  __attribute__((aligned(8))) S(1)
      const EvalParamsInitial initial_params = {
          .phases = {0, 0, 1, 1, 2, 4},
          .mg = {.material = {0, 67, 289, 332, 384, 842},
                 .pst_rank =
                     {
                         0,   -15, -17, -5,  7,  29, 95,  0,   // Pawn
                         -15, -3,  10,  23,  26, 35, 16,  -93, // Knight
                         -8,  9,   15,  17,  18, 17, -4,  -64, // Bishop
                         5,   -5,  -10, -13, 2,  13, 1,   7,   // Rook
                         16,  17,  9,   0,   -4, -3, -20, -14, // Queen
                         -12, -7,  -14, -18, 12, 64, 71,  88,  // King
                     },
                 .pst_file =
                     {
                         -10, -11, -6,  3,   8,   13,  12, -7,  // Pawn
                         -29, -10, -1,  12,  13,  14,  5,  -5,  // Knight
                         -14, 0,   3,   1,   4,   -1,  11, -3,  // Bishop
                         -12, -8,  -2,  7,   12,  8,   6,  -10, // Rook
                         -14, -8,  -4,  0,   3,   4,   12, 6,   // Queen
                         -12, 12,  -13, -27, -28, -10, 11, 3,   // King
                     },
                 .mobilities = {6, 5, 2, 3, -2},
                 .king_attacks = {9, 14, 19, 14, 0},
                 .pawn_threat = {-19, -8, -7, -8, -1},
                 .open_files = {8, -10, -10, 17, -2, -24, 8, -11, -14, 33, -13,
                                -57},
                 .passed_pawns = {-7, -11, -9, 11, 33, 95},
                 .passed_blocked_pawns = {0, -2, 5, 14, 16, -39},
                 .protected_pawn = 16,
                 .phalanx_pawn = 9,
                 .bishop_pair = 26,
                 .bishop_pawns = {-6, -5},
                 ...
                 .tempo = 28},
          .eg = {.material = {0, 88, 393, 431, 721, 1343},
                 .pst_rank =
                     {
                         0,   -5,  -9,  -7, 1,  20, 104, 0,   // Pawn
                         -34, -23, -9,  16, 25, 11, 4,   11,  // Knight
                         -15, -14, -1,  5,  8,  4,  4,   9,   // Bishop
                         -17, -19, -12, 5,  11, 10, 18,  5,   // Rook
                         -59, -43, -14, 14, 30, 26, 31,  16,  // Queen
                         -41, -1,  7,   19, 30, 28, 13,  -56, // King
                     },
                 .pst_file =
                     {
                         11,  11, -1, -11, -5, -1, 0,  -4,  // Pawn
                         -20, -6, 7,  16,  17, 5,  0,  -19, // Knight
                         -11, 0,  5,  10,  11, 5,  -3, -15, // Bishop
                         1,   6,  6,  -3,  -5, 0,  0,  -6,  // Rook
                         -23, -7, 3,  7,   15, 15, 0,  -10, // Queen
                         -33, 4,  17, 24,  25, 15, 3,  -40, // King
                     },
                 .mobilities = {5, 3, 4, 2, -6},
                 .king_attacks = {-6, -3, -7, 7, 0},
                 .pawn_threat = {-1, -5, -18, -14, -9},
                 .open_files = {20, 1, 13, 6, 22, 13, 23, -8, 2, 12, 43, 9},
                 .passed_pawns = {9, 15, 40, 67, 115, 104},
