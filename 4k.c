...
G(
    1, S(1) ssize_t _sys(H(2, 1, ssize_t call), H(2, 1, ssize_t arg1),
...
G(
    ...
    S(1) void putl(const char *const restrict string) {
      i32 length = 0;
      while (string[length]) {
        _sys(H(2, 2, 1), H(2, 2, stdout), H(2, 2, (ssize_t)(&string[length])),
             H(2, 2, 1));
        length++;
      }
    }
...
G(
    ...
    S(1) bool getl(char *restrict string) {
      while (true) {
        const int result = _sys(H(2, 3, 0), H(2, 3, stdin),
...
S(1) void _printf(const char *format, const size_t *args) {
  ...
  while (true) {
    ...
    if (*format != '%') {
      _sys(H(2, 4, 1), H(2, 4, stdout), H(2, 4, (ssize_t)format), H(2, 4, 1));
      format++;
      continue;
    }
...
[[nodiscard]] S(1) size_t get_time() {
  timespec ts;
  _sys(H(2, 5, 228), H(2, 5, 1), H(2, 5, (ssize_t)&ts), H(2, 5, 0));
...
#define assert(condition)                                                      \
  if (!(condition)) {                                                          \
    ...
    puts(#condition);                                                          \
    _sys(H(2, 6, 60), H(2, 6, 1), H(2, 6, 0), H(2, 6, 0));                     \
  }
#else
#define assert(condition)
#endif
...
G(
    10, [[nodiscard]] S(1)
            u64 shift(H(11, 1, const u64 mask), H(11, 1, const u64 bb),
...
G(
    13, [[nodiscard]] S(1) u64 nw(const u64 bb) {
      return shift(H(11, 2, ~0x8080808080808080ull), H(11, 2, bb), H(11, 2, 7));
...
G(
    14, [[nodiscard]] S(1)
            u64 ray(H(15, 1, const u64 bb), H(15, 1, const i32 shift_by),
                    H(15, 1, const u64 mask), H(15, 1, const u64 blockers)) {
              u64 result =
                  shift(H(11, 3, mask), H(11, 3, bb), H(11, 3, shift_by));
              for (i32 i = 0; i < 6; i++) {
                result |= shift(H(11, 4, mask), H(11, 4, result & ~blockers),
                                H(11, 4, shift_by));
              }
              return result;
            })
...
G(
    14, [[nodiscard]] S(0) u64 xattack(H(16, 1, const u64 bb),
                                       H(16, 1, const u64 dir_mask),
...
G(
    17, [[nodiscard]] S(0) u64 bishop(H(18, 1, const u64 bb),
                                      H(18, 1, const u64 blockers)) {
      assert(count(bb) == 1);
      const i32 sq = lsb(bb);
      return xattack(H(16, 2, bb), H(16, 2, diag_mask[sq]),
                     H(16, 2, blockers)) |
             xattack(H(16, 3, bb), H(16, 3, flip_bb(diag_mask[sq ^ 56])),
                     H(16, 3, blockers));
    })
...
G(
    17, [[nodiscard]] S(1) u64 rook(H(21, 1, const u64 bb),
                                    H(21, 1, const u64 blockers)) {
      assert(count(bb) == 1);
      return xattack(H(16, 4, bb),
                     H(16, 4, bb ^ 0x101010101010101ULL << lsb(bb) % 8),
                     H(16, 4, blockers)) |
             ray(H(15, 2, bb), H(15, 2, 1), H(15, 2, ~0x101010101010101ull),
                 H(15, 2, blockers)) // East
             | ray(H(15, 3, bb), H(15, 3, -1), H(15, 3, ~0x8080808080808080ull),
...
G(
    ...
    S(1) void swapmoves(G(24, Move *const rhs), G(24, Move *const lhs)) {
      swapu32(G(25, (u32 *)rhs), G(25, (u32 *)lhs));
    })

G(
    22, [[nodiscard]] S(1) bool move_equal(G(26, Move *const lhs),
                                           G(26, Move *const rhs)) {
...
G(
    22, [[nodiscard]] S(0)
            i32 piece_on(H(31, 1, const i32 sq),
                         H(31, 1, const Position *const restrict pos)) {
              assert(sq >= 0);
              assert(sq < 64);
...
G(
    32, [[nodiscard]] S(1) u64 get_mobility(H(40, 1, const i32 sq),
                                            H(40, 1, const Position *pos),
      ...
      G(41, if (piece == Knight) { moves = knight(bb); })
        ...
        G(
            42, if (G(43, piece == Queen) || G(43, piece == Bishop)) {
              moves |= bishop(H(18, 3, bb), H(18, 3, blockers));
            })
        G(
            42, if (G(44, piece == Queen) || G(44, piece == Rook)) {
              moves |= rook(H(21, 3, bb), H(21, 3, blockers));
            })
      }
      return moves;
    })
...
G(
    32, [[nodiscard]] S(1)
            i32 is_attacked(H(33, 1, const u64 bb),
...
G(
    45, S(0) i32 makemove(H(46, 1, Position *const restrict pos),
      ...
      assert(move->takes_piece == piece_on(H(31, 2, move->to), H(31, 2, pos)));

      G(47, const u64 to = 1ull << move->to;)
      G(47, const u64 from = 1ull << move->from;)
      G(48, const i32 piece = piece_on(H(31, 3, move->from), H(31, 3, pos));
        assert(piece != None);)
...
G(
    45, S(0) Move *generate_pawn_moves(H(62, 1, const i32 offset),
                                       H(62, 1, const Position *const pos),
      ...
      while (to_mask) {
        ...
        assert(to >= 0);
        assert(to < 64);
        assert(piece_on(H(31, 5, from), H(31, 5, pos)) == Pawn);
        const u8 takes = piece_on(H(31, 6, to), H(31, 6, pos));
        if (to > 55) {
...
G(
    45, S(1) Move *generate_piece_moves(H(58, 1, const Position *restrict pos),
                                        H(58, 1, Move *restrict movelist),
                                        H(58, 1, const u64 to_mask)) {
      for (i32 piece = Knight; piece <= King; piece++) {
        ...
        while (copy) {
          ...
          G(59, u64 moves = G(60, to_mask) &
                            G(60, get_mobility(H(40, 2, from), H(40, 2, pos),
                                               H(40, 2, piece)));)
          ...
          while (moves) {
            ...
            G(61, *movelist++ = ((Move){
                      ...
                      .to = to,
                      .promo = None,
                      .takes_piece = piece_on(H(31, 4, to), H(31, 4, pos))});)
          }
        }
      }
...
typedef struct [[nodiscard]] __attribute__((packed)) {
  ...
  H(69, 1,
    H(70, 1, i8 passed_pawns[6];) H(70, 1, i8 king_attacks[5];)
        H(70, 1, i8 passed_blocked_pawns[6];) H(70, 1, i8 tempo;)
            H(70, 1, i8 mobilities[5];))
  H(69, 1,
    H(71, 1, u8 pawn_attacked_penalty[2];) H(71, 1, i8 open_files[6];)
        H(71, 1, i8 bishop_pair;) H(71, 1, i8 pst_file[64];)
...
typedef struct [[nodiscard]] __attribute__((packed)) {
  ...
  H(69, 2,
    H(70, 2, i32 passed_pawns[6];) H(70, 2, i32 king_attacks[5];)
        H(70, 2, i32 passed_blocked_pawns[6];) H(70, 2, i32 tempo;)
            H(70, 2, i32 mobilities[5];))
  H(69, 2,
    H(71, 2, i32 pawn_attacked_penalty[2];) H(71, 2, i32 open_files[6];)
        H(71, 2, i32 bishop_pair;) H(71, 2, i32 pst_file[64];)
...
G(
    72, [[nodiscard]] S(1) i32 combine_eval_param(H(73, 1, const i32 mg_val),
      ...
      return G(74, (eg_val << 16)) + G(74, mg_val);
    })
...
S(1) void init() {
  ...
  G(
      46, for (i32 sq = 0; sq < 64; sq++) {
        const u64 bb = 1ULL << sq;
        diag_mask[sq] = G(75, ray(H(15, 4, bb), H(15, 4, -9),
                                  H(15, 4, ~0x8080808080808080ull),
                                  H(15, 4, 0))) | // Northeast
                        G(75, ray(H(15, 5, bb), H(15, 5, 9),
                                  H(15, 5, ~0x101010101010101ull),
                                  H(15, 5, 0))); // Southwest
      })
...
S(1) i32 eval(Position *const restrict pos) {
  ...
  for (i32 c = 0; c < 2; c++) {
    ...
    G(78,
      ...
      const u64 no_passers = G(82, attacked_by_pawns) | G(82, opp_pawns);)
    ...
    for (i32 p = Pawn; p <= King; p++) {
      ...
      while (copy) {
        ...
        G(
            ...
            if ((G(86, own_pawns) & G(86, north(0x101010101010101ULL << sq))) ==
        ...
        G(
            ...
            if (G(94, p == Pawn) &&
                G(94,
                  !(G(95, no_passers) & G(95, (0x101010101010101ULL << sq))))) {
              G(
        ...
        G(
            62, if (p > Pawn) {
              ...
              G(87, const u64 mobility =
                        G(88, get_mobility(H(40, 3, sq), H(40, 3, pos),
                                           H(40, 3, p))) &
                        G(88, G(89, mobility));
                ...
                G(90, // KING ATTACKS
                  ...
                  G(92, eval_params.king_attacks[p - 2]);)
                    ...
                    G(90, // MOBILITY
                      score += G(91, count(G(89, ~pos->colour[0]) &
                                           G(89, ~attacked_by_pawns))) *
...
i16 search(H(99, 1, Position *const restrict pos), H(99, 1, i32 alpha),
  ...
  for (i32 i = G(101, pos_history_count) + G(101, ply);
       G(102, do_null) && G(102, i > 0); i -= 2) {
  ...
  // QUIESCENCE
  if (G(106, in_qsearch) && G(106, static_eval > alpha)) {
    if (static_eval >= beta) {
      return static_eval;
    }
    alpha = static_eval;
  ...
  if (G(107, !in_check) && G(107, alpha == beta - 1)) {
    ...
    if (G(110, depth > 2) && G(110, static_eval >= beta) && G(110, do_null)) {
      ...
      const i32 score = -search(
          ...
          H(99, 2, depth - 3 - depth / 4), H(100, 2, -alpha),
#ifdef FULL
          nodes,
#endif
          H(100, 2, false), H(100, 2, stack), H(100, 2, pos_history_count));
      if (score >= beta) {
        return score;
      }
    }
  ...
  for (i32 move_index = 0; move_index < stack[ply].num_moves; move_index++) {
    ...
    for (i32 order_index = move_index; order_index < stack[ply].num_moves;
      ...
      assert(
          ...
          piece_on(H(31, 7, stack[ply].moves[order_index].to), H(31, 7, pos)));
    ...
    swapmoves(G(116, &stack[ply].moves[move_index]),
    ...
    if (G(117, depth < 8) &&
        G(117,
          G(118, static_eval + 136 * depth) +
              ...
              alpha) &&
        G(117, !in_check) && G(117, moves_evaluated)) {
      break;
    }
    ...
    // LATE MOVE REDUCTION
    i32 reduction = G(119, moves_evaluated > 6) && G(119, depth > 1)
                        ? G(120, !improving) + G(120, (alpha == beta - 1)) +
                              G(120, moves_evaluated / 11)
                        : 0;
    ...
    while (true) {
      score = -search(
          ...
          H(99, 3, depth - G(121, 1) - G(121, reduction)), H(100, 3, -alpha),
#ifdef FULL
          nodes,
#endif
          H(100, 3, true), H(100, 3, stack), H(100, 3, pos_history_count));
      ...
      if (score > alpha) {
        ...
        if (score >= beta) {
          assert(stack[ply].best_move.takes_piece ==
                 piece_on(H(31, 8, stack[ply].best_move.to), H(31, 8, pos)));
          G(123, tt_flag = Lower;)
          G(
...
void iteratively_deepen(
  ...
  for (i32 depth = 1; depth < max_ply; depth++) {
    ...
    i32 score = search(H(99, 4, pos), H(99, 4, -inf), H(99, 4, 0),
                       ...
                       nodes,
#endif
                       H(100, 4, false), H(100, 4, stack),
                       H(100, 4, pos_history_count));
...
S(1) void display_pos(Position *const pos) {
  ...
  for (i32 rank = 7; rank >= 0; rank--) {
    for (i32 file = 0; file < 8; file++) {
      i32 sq = rank * 8 + file;
      u64 bb = 1ULL << sq;
      i32 piece = piece_on(H(31, 9, sq), H(31, 9, &npos));
      if (bb & npos.colour[0]) {
        if (piece == Pawn) {
          putl("P");
...
S(1) void bench() {
  ...
  iteratively_deepen(20, &nodes, H(126, 2, pos_history_count), H(126, 2, stack),
                     H(126, 2, &pos));
...
S(1) void run() {
  ...
  while (true) {
    ...
    if (!strcmp(line, "uci")) {
      ...
      max_time = 99999999999;
      iteratively_deepen(max_ply, &nodes, H(126, 3, pos_history_count),
                         H(126, 3, stack), H(126, 3, &pos));
    ...
    G(128, if (line[0] == 'i') { puts("readyok"); })
      ...
      iteratively_deepen(max_ply, &nodes, H(126, 4, pos_history_count),
                         H(126, 4, stack), H(126, 4, &pos));
#else
      for (i32 i = 0; i < (pos.flipped ? 4 : 2); i++) {
        getl(line);
        max_time = atoi(line) / 2;
      }
      iteratively_deepen(H(126, 5, pos_history_count), H(126, 5, stack),
                         H(126, 5, &pos));
#endif
    }
  }
