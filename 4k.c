...
G(66, static const EvalParams eg = ((EvalParams){
          .material = {71, 304, 297, 542, 993, 0},
          .pst_rank =
              {
                  0,   -4,  -6,  -5, 0,  15, 77, 0,   // Pawn
                  -34, -20, -5,  17, 25, 10, 2,  4,   // Knight
                  -11, -10, -1,  2,  6,  4,  3,  8,   // Bishop
                  -18, -19, -12, 5,  12, 11, 15, 7,   // Rook
                  -60, -45, -20, 9,  29, 30, 39, 18,  // Queen
                  -38, -1,  9,   18, 24, 21, 8,  -47, // King
              },
          .pst_file =
              {
                  9,   12, -1, -9, -4, -3, 2,  -6,  // Pawn
                  -19, -4, 8,  14, 15, 6,  0,  -19, // Knight
                  -6,  -1, 0,  3,  5,  4,  1,  -6,  // Bishop
                  1,   4,  4,  -1, -4, 0,  0,  -3,  // Rook
                  -19, -5, 3,  7,  12, 10, -1, -6,  // Queen
                  -25, 1,  13, 24, 18, 20, 1,  -32, // King
              },
          .mobilities = {2, 4, 3, 1, -4},
          .king_attacks = {-5, -3, -6, 7, 0},
...
G(66, static const EvalParams mg = ((EvalParams){
          .material = {68, 292, 299, 406, 899, 0},
          .pst_rank =
              {
                  0,   -10, -10, -8,  2,  26, 94,  0,   // Pawn
                  -20, -9,  3,   16,  22, 40, 24,  -75, // Knight
                  -9,  6,   13,  13,  16, 16, -3,  -53, // Bishop
                  -1,  -13, -19, -21, 1,  21, 15,  17,  // Rook
                  16,  17,  9,   -2,  -6, -2, -24, -9,  // Queen
                  -9,  -5,  -29, -33, 2,  61, 74,  81,  // King
              },
          .pst_file =
              {
                  -21, -10, -9, 0,   7,   22,  22, -11, // Pawn
                  -23, -9,  0,  14,  11,  11,  1,  -4,  // Knight
                  -10, 3,   5,  2,   5,   -3,  3,  -5,  // Bishop
                  -8,  -7,  2,  11,  12,  3,   -3, -10, // Rook
                  -10, -7,  -2, 2,   2,   1,   7,  7,   // Queen
                  -16, 25,  -2, -47, -17, -36, 20, -1,  // King
              },
          .mobilities = {6, 6, 2, 3, -9},
          .king_attacks = {7, 15, 20, 14, 0},
          .open_files = {23, -10, -10, 20, -3, -31},
          .passed_pawns = {-9, 12, 36, 94},
          .passed_blocked_pawns = {2, 10, 10, -31},
          .bishop_pair = 24,
          .tempo = 16});)
            ...
            40, if (p > Pawn) {
              ...
              G(84, // MOBILITY
                ...
                G(85, count(G(86, ~attacked_by_pawns) & G(86, mobility) &
                            G(86, ~pos->colour[0]))) *
                G(85, eval_params.mobilities[p - 2]);)

              G(84, // KING ATTACKS
                score += G(87, count(G(88, opp_king_zone) & G(88, mobility))) *
                         G(87, eval_params.king_attacks[p - 2]);)
            })
