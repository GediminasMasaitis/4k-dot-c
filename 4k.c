...
G(121, // EVAL PARAMETERS
  __attribute__((aligned(8))) S(1)
      const EvalParamsInitial initial_params = {
          .phases = {0, 0, 1, 1, 2, 4},
          .mg = {.material = {0, 67, 291, 330, 383, 838},
                 .pst_rank =
                     {
                         0,   -15, -17, -5,  7,  29, 93,  0,   // Pawn
                         -19, -7,  6,   20,  29, 40, 19,  -89, // Knight
                         -8,  9,   15,  17,  18, 17, -5,  -64, // Bishop
                         5,   -5,  -10, -13, 3,  13, 1,   6,   // Rook
                         16,  17,  9,   1,   -3, -3, -21, -15, // Queen
                         -12, -7,  -16, -20, 11, 63, 70,  87,  // King
                     },
                 .pst_file =
                     {
                         -10, -12, -7,  3,   8,   13,  12, -7,  // Pawn
                         -29, -11, -1,  12,  14,  13,  7,  -4,  // Knight
                         -14, 0,   3,   0,   4,   -1,  11, -3,  // Bishop
                         -12, -8,  -3,  7,   12,  8,   6,  -11, // Rook
                 ...
                 .open_files = {8, -10, -10, 17, -2, -24, 8, -12, -14, 33, -13,
                                -56},
                 .passed_pawns = {-7, -11, -9, 10, 32, 93},
                 .passed_blocked_pawns = {0, -1, 5, 14, 16, -36},
                 .protected_pawn = 16,
                 .phalanx_pawn = 9,
                 .bishop_pair = 27,
                 .bishop_pawns = {-5, -5},
                 .king_shield = {29, 20},
                 .pawn_attacked_penalty = {-18, -38},
                 .tempo = 28},
          .eg = {.material = {0, 88, 391, 431, 722, 1344},
                 .pst_rank =
                     {
                 ...
                 .pst_file =
                     {
                         ...
                         -23, -7, 4,  7,   15, 15, 0,  -10, // Queen
                         -33, 4,  18, 25,  26, 16, 3,  -40, // King
                     },
                 .mobilities = {4, 3, 4, 1, -6},
                 .king_attacks = {0, -3, -7, 7, 0},
                 .pawn_threat = {-2, -5, -18, -14, -9},
                 .open_files = {21, 1, 13, 6, 23, 14, 23, -8, 2, 12, 44, 9},
                 .passed_pawns = {9, 15, 40, 67, 116, 104},
                 .passed_blocked_pawns = {-9, -8, -32, -63, -112, -119},
                 .protected_pawn = 16,
                 .phalanx_pawn = 15,
                 .bishop_pair = 62,
                 .bishop_pawns = {-12, -1},
                 .king_shield = {-12, -7},
                 .pawn_attacked_penalty = {-6, -54},
                 .tempo = 15}};)
            ...
            93, if (p > Pawn) {
              ...
              G(
                  ...
                  if (G(161, piece_bb) & G(161, no_passers)) {
                    score += eval_params.pawn_attacked_penalty[c] * p;
                  })
