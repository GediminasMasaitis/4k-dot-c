...
__attribute__((aligned(8))) static const i16 material[] = {0,   98,  289, 303,
                                                           483, 934, 0};
__attribute__((aligned(8))) static const i8 pst_rank[] = {
    0,   -12, -14, -12, -2, 39, 123, 0,   // Pawn
    -31, -15, 0,   14,  26, 29, 8,   -32, // Knight
    -24, -7,  2,   7,   13, 16, 1,   -8,  // Bishop
    -18, -22, -19, -8,  8,  17, 23,  18,  // Rook
    -24, -14, -9,  -2,  8,  20, 9,   12,  // Queen
    -6,  -1,  3,   14,  27, 33, 23,  -5,  // King
};
__attribute__((aligned(8))) static const i8 pst_file[] = {
    -5,  3,  -5, -2, 1,  1,  13, -6,  // Pawn
    -25, -5, 5,  13, 13, 11, 1,  -13, // Knight
    -8,  0,  1,  4,  4,  1,  4,  -6,  // Bishop
    -8,  0,  6,  8,  8,  2,  1,  -17, // Rook
    -17, -6, 1,  4,  4,  5,  5,  4,   // Queen
    -12, 3,  1,  -4, -6, -6, 6,  -7,  // King
};
