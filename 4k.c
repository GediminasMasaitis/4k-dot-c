...
G(
    ...
    __attribute__((aligned(8))) S(1) const EvalParamsInitial initial_params =
        {.phases = {0, 0, 1, 1, 2, 4},
         .mg = {.material = {0, 68, 287, 326, 378, 829},
                .pst_rank =
                    {
                        0,   -16, -17, -5,  8,  30, 99,  0,   // Pawn
         ...
         .eg = {.material = {0, 88, 392, 432, 723, 1347},
                .pst_rank =
                    {
                        0,   -5,  -8,  -7, 0,  20, 103, 0,   // Pawn
