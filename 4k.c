...
G(
    1, [[nodiscard]] S(1) A(1, i32, u32, i64, u64) atoi(const char *restrict string) {
...
G(
    7, [[nodiscard]] S(1) bool move_string_equal(G(8, const char *restrict rhs), G(8, const char *restrict lhs)) {
...
G(
    7, [[nodiscard]] S(1) u64 shift(H(10, 1, const A(2, i8, i16, i32, i64) shift), H(10, 1, const u64 mask), H(10, 1, const u64 bb)) {
...
G(
    25, [[nodiscard]] S(0) u64 xattack(H(27, 1, const u64 blockers), H(27, 1, const u64 bb), H(27, 1, const u64 dir_mask)) {
...
G(
    32, [[nodiscard]] S(0) u64 rook(H(41, 1, const u64 blockers), H(41, 1, const u64 bb)) {
      assert(count(bb) == 1);
      return G(42, // West
...
G(
    46, S(1) void move_str(H(50, 1, const Move *restrict move), H(50, 1, const A(1, bool, i8, u8, i16, u16, i32, u32, i64, u64) flip),
...
G(
    46, [[nodiscard]] S(0) A(6, i8, u8, i16, u16, i32, u32, i64, u64)
...
G(
    57, [[nodiscard]] S(1) A(6, bool, i8, u8, i16, u16, i32, u32, i64, u64) is_attacked(H(58, 1, const Position *const restrict pos), H(58, 1, const u64 bb)) {
      assert(count(bb) == 1);
...
G(
    57, [[nodiscard]] S(1) u64 get_mobility(H(69, 1, const Position *pos), H(69, 1, const A(6, i8, u8, i16, u16, i32, u32, i64, u64) piece),
...
G(
    74, S(0) A(6, bool, i8, u8, i16, u16, i32, u32, i64, u64) makemove(H(80, 1, Position *const restrict pos), H(80, 1, const Move *const restrict move)) {
      assert(move->from >= 0);
      assert(move->from < 64);
      assert(move->to >= 0);
      assert(move->to < 64);
...
[[nodiscard]] S(0) A(3, u8, i16, u16, i32, u32, i64, u64)
  ...
  G(
      ...
      if (G(110, !only_captures) && G(110, !(G(111, all) & G(111, 0xEull))) && G(110, pos->castling[1]) &&
          ...
          G(112, !is_attacked(H(58, 4, pos), H(58, 4, 1ULL << 4)))) { *movelist++ = (Move){.from = 4, .to = 2, .promo = None, .takes_piece = None}; })
  G(
      98, // SHORT CASTLE
      if (G(113, !only_captures) && G(113, !(G(114, all) & G(114, 0x60ull))) && G(113, pos->castling[0]) &&
          G(115, !is_attacked(H(58, 5, pos), H(58, 5, 1ULL << 5))) &&
          G(115, !is_attacked(H(58, 6, pos), H(58, 6, 1ULL << 4)))) { *movelist++ = (Move){.from = 4, .to = 6, .promo = None, .takes_piece = None}; })
...
typedef struct [[nodiscard]] __attribute__((packed)) {
  i16 material[6];
  H(116, 1,
    H(117, 1, i8 king_shield[2];) H(117, 1, i8 piece_threats[2];) H(117, 1, i8 passed_king_distance[2];) H(117, 1, i8 bishop_pawns[2];)
        H(117, 1, i8 pawn_threat[5];))
  H(116, 1,
    H(119, 1, i8 pawn_attacked_penalty[2];) H(119, 1, i8 passed_blocked_pawns[6];) H(119, 1, i8 mobilities[5];) H(119, 1, i8 pst_file[48];) H(119, 1, i8 tempo;)
...
typedef struct [[nodiscard]] __attribute__((packed)) {
  i32 material[6];
  H(116, 2,
    H(117, 2, i32 king_shield[2];) H(117, 2, i32 piece_threats[2];) H(117, 2, i32 passed_king_distance[2];) H(117, 2, i32 bishop_pawns[2];)
        H(117, 2, i32 pawn_threat[5];))
  H(116, 2,
    H(119, 2, i32 pawn_attacked_penalty[2];) H(119, 2, i32 passed_blocked_pawns[6];) H(119, 2, i32 mobilities[5];) H(119, 2, i32 pst_file[48];)
...
G(
    121, [[nodiscard]] S(1) A(1, i32, i64) combine_eval_param(H(122, 1, const A(1, i16, i32, i64) mg_val), H(122, 1, const A(2, i16, i32, i64) eg_val)) {
...
S(0) A(1, i16, i32, i64) eval(Position *const restrict pos) {
  ...
  for (A(4, i8, u8, i16, u16, i32, u32, i64, u64) c = 0; c < 2; c++) {
    ...
    G(
        125, u64 pawns[2]; for (A(0, i8, u8, i16, u16, i32, u32, i64, u64) i = 0; i < 2; i++) {
...
search(
  ...
  if (G(203, !in_check) && G(203, G(204, alpha) == G(204, beta - 1))) {
    if (G(205, depth < 10) && G(205, !in_qsearch)) {
      ...
      G(206, {
        ...
        if (static_eval - G(207, 39) * G(207, (depth - improving)) >= beta) {
          return static_eval;
        }
      })

      G(206, // RAZORING
        in_qsearch = G(208, static_eval) + G(208, G(209, 64) * G(209, depth)) <= alpha;)
    }

    // NULL MOVE PRUNING
    if (G(210, G(329, pos->colour[0]) & G(329, ~(G(330, pos->pieces[Pawn]) | G(330, pos->pieces[King])))) && G(210, depth > 2) && G(210, do_null) &&
        G(210, static_eval >= beta)) {
      Position npos = *pos;
      G(211, flip_pos(&npos);)
      G(211, npos.ep = 0;)
      G(211, A(0, i16, u16, i32, i64) nmp_red = (static_eval - beta) / 98; if (nmp_red > 3) { nmp_red = 3; })
  ...
  for (A(3, u8, i16, u16, i32, u32, i64, u64) move_index = 0; move_index < ss->num_moves; move_index++) {
    ...
    for (A(5, u8, i16, u16, i32, u32, i64, u64) order_index = move_index; order_index < ss->num_moves; order_index++) {
      ...
      const A(1, i32, i64) order_move_score = G(187, // HISTORY HEURISTIC
                                              ...
                                              G(187, // MOST VALUABLE VICTIM
                                                G(219, moves[order_index].takes_piece) * G(219, 512)) +
                                              G(187, // KILLER MOVE
                                                G(216, move_equal(G(217, &moves[order_index]), G(217, &ss->killer))) * G(216, 722)) +
                                              G(187, // COUNTER MOVE
                                                G(327, move_equal(G(328, &moves[order_index]), G(328, &counter))) * G(327, 550)) +
    ...
    G(
        ...
        if (G(225, depth < 5) &&
            G(225, G(226, static_eval) + G(226, G(227, 189) * G(227, depth)) + G(226, initial_params.eg.material[moves[move_index].promo]) +
    ...
    G(
        ...
        if (G(223, moves_evaluated) && G(223, move_score < G(224, -182) * G(224, depth))) { break; })
    ...
    // LATE MOVE REDUCTION
    A(1, i32, i64)
    reduction = G(228, depth > 3) && G(228, move_score <= 0) ? G(229, depth / 10) + G(229, !improving) + G(229, (G(230, alpha) == G(230, beta - 1))) +
                                                                   G(229, moves_evaluated / 10) + G(229, (move_score / -370))
                                                             : 0;
    ...
    if (score > best_score) {
      ...
      if (score > alpha) {
        ...
        if (score >= beta) {
          ...
          G(
              233, if (!in_qsearch) {
                const A(3, i16, u16, i32, i64) bonus = 10 * depth;
  ...
  G(
      ...
      if (G(243, G(244, tt_flag) != G(244, (best_score < ss->static_eval))) && G(243, G(245, ss->best_move.takes_piece) == G(245, None))) {
        G(246, A(1, i32, i64) dd = depth * depth; if (dd > 65) { dd = 65; })
        G(246, A(0, i32, i64) target = best_score - ss->static_eval; G(247, if (target < -182) { target = -182; }) G(247, if (target > 182) { target = 182; }))

        for (A(6, i8, u8, i16, u16, i32, u32, i64, u64) i = 0; i < 6; i++) {
          *corr_entries[i] = (G(248, G(249, *corr_entries[i]) * G(249, (505 - dd))) + G(248, G(250, target) * G(250, 256) * G(250, dd))) / 505;
        }
      })
...
S(1) void init() {
  ...
  G(
      ...
      for (A(5, u8, i16, u16, i32, u32, i64, u64) i = 0; i < sizeof(EvalParamsMerged) / sizeof(i32); i++) {
  ...
  if (score > alpha && score < beta) {
    ...
    if (makemove(H(80, 5, &cur_pos), H(80, 5, &pv_move))) {
      ...
      while (seen_count < max_ply && halfmoves < 100) {
        ...
        putl(" ");
        move_str(H(50, 5, &move), H(50, 5, cur_pos.flipped), H(50, 5, move_name));
        putl(move_name);
...
void iteratively_deepen(
  ...
  for (A(4, i8, u8, i16, u16, i32, u32, i64, u64) depth = 1; depth < max_ply; depth++) {
    ...
    if (G(303, elapsed > data->max_time / 10) || G(303, stop)) {
      break;
    }
  }
}
...
void run_smp() {
  ...
  char move_name[8];
  move_str(H(50, 3, &main_data->stack[0].best_move), H(50, 3, main_data->pos.flipped), H(50, 3, move_name));
  putl("bestmove ");
  puts(move_name);
}
  ...
  while (true) {
    ...
    G(262, if (G(269, line[0]) == G(269, 'q')) { exit_now(); })
      ...
      while (true) {
        ...
        {
          Move moves[max_moves];
          const A(4, u8, i16, u16, i32, u32, i64, u64) num_moves =
            movegen(H(95, 4, &main_data->pos), H(95, 4, false),
              H(95, 4, moves));
          for (A(3, u8, i16, u16, i32, u32, i64, u64) i = 0; i < num_moves; i++) {
            char move_name[8];
            move_str(H(50, 4, &moves[i]),
              H(50, 4, main_data->pos.flipped),
              H(50, 4, move_name));
