...
G(1, [[nodiscard]] static bool strcmp(const char *restrict lhs,
...
G(7, [[nodiscard]] S(1) bool move_string_equal(G(8, const char *restrict rhs),
...
G(13, [[nodiscard]] S(1) u64 west(const u64 bb) {
...
G(13, [[nodiscard]] S(1) u64 east(const u64 bb) {
...
G(25, [[nodiscard]] S(0) u64 xattack(H(27, 1, const u64 blockers),
                                       H(27, 1, const u64 bb),
...
G(32, [[nodiscard]] S(0) u64 knight(const u64 bb) {
      ...
      G(34, const u64 horizontal2 = G(36, east(east_bb)) | G(36, west(west_bb));)
      return G(37, horizontal2 >> 8) | G(37, horizontal2 << 8) |
             G(37, horizontal1 >> 16) | G(37, horizontal1 << 16);
    })

G(32, [[nodiscard]] S(0) u64 rook(H(41, 1, const u64 blockers),
                                    H(41, 1, const u64 bb)) {
      assert(count(bb) == 1);
      return G(42, // West
...
G(32, [[nodiscard]] S(0) u64 bishop(H(43, 1, const u64 blockers),
                                      H(43, 1, const u64 bb)) {
      assert(count(bb) == 1);
      const i32 sq = lsb(bb);
      return G(44, xattack(H(27, 3, blockers), H(27, 3, bb),
                           H(27, 3, diag_mask[sq]))) |
             G(44, xattack(H(27, 4, blockers), H(27, 4, bb),
                       H(27, 4, flip_bb(diag_mask[G(45, sq) ^ G(45, 56)]))));
    })

G(46, S(1) void swapu32(G(47, u32 *const rhs), G(47, u32 *const lhs)) {
      const u32 temp = *lhs;
      *lhs = *rhs;
      *rhs = temp;
    }
...
G(46, S(1) void move_str(H(54, 1, char *restrict str),
      ...
      G(55, // Hack to save bytes, technically UB but works on GCC 14.2
          for (i32 i = 0; i < 2; i++) {
...
G(46, [[nodiscard]] S(1) bool move_equal(G(50, Move *const rhs),
                                           G(50, Move *const lhs)) {
...
G(57, [[nodiscard]] S(1) i32 is_attacked(H(58, 1, const Position *const restrict pos),
                                       H(58, 1, const u64 bb)) {
      assert(count(bb) == 1);
      ...
      return G(60, G(61, (G(62, southwest(pawns)) | G(62, southeast(pawns)))) &
             ...
             G(60, G(63, pos->pieces[King]) & G(63, theirs) & G(63, king(bb))) ||
             G(60, G(64, pos->pieces[Knight]) & G(64, knight(bb)) & G(64, theirs));
    })
...
G(57, [[nodiscard]] S(1) u64 get_mobility(H(69, 1, const Position *pos),
...
G(74, S(1) Move *generate_piece_moves(H(75, 1, const u64 to_mask),
        ...
        while (copy) {
          ...
          while (moves) {
            ...
            G(79, *movelist++ = ((Move){
                      ...
                      .to = to,
                      .promo = None,
                      .takes_piece = piece_on(H(52, 2, pos), H(52, 2, to))});)
          }
        }
      }
...
G(74, S(0) i32 makemove(H(80, 1, Position *const restrict pos),
      ...
      assert(move->takes_piece == piece_on(H(52, 3, pos), H(52, 3, move->to)));

      G(81, const u64 to = 1ull << move->to;)
      G(81, const u64 from = 1ull << move->from;)
      G(82, const i32 piece = piece_on(H(52, 4, pos), H(52, 4, move->from));
        assert(piece != None);)
...
G(74, S(0) Move *generate_pawn_moves(H(93, 1, const Position *const pos),
      ...
      while (to_mask) {
        ...
        assert(to >= 0);
        assert(to < 64);
        assert(piece_on(H(52, 5, pos), H(52, 5, from)) == Pawn);
        const u8 takes = piece_on(H(52, 6, pos), H(52, 6, to));
        if (to > 55) {
...
[[nodiscard]] S(1) i32 movegen(H(95, 1, const Position *const restrict pos),
  ...
  G(98, // PAWN PROMOTIONS
      if (!only_captures) {
        movelist = generate_pawn_moves(
            H(93, 2, pos), H(93, 2, -16), H(93, 2, movelist),
            H(93, 2, G(99, north(G(100, north(G(101, pos->colour[0]) &
  ...
  G(98, // PAWN DOUBLE MOVES
    movelist = generate_pawn_moves(
        H(93, 4, pos), H(93, 4, -8), H(93, 4, movelist),
        H(93, 4, north(G(105, G(106, pos->colour[0]) & G(106, pos->pieces[Pawn]))) &
              G(105, ~all) &
              G(105, (only_captures ? 0xFF00000000000000ull : ~0ull))));)
  G(98, // PAWN EAST CAPTURES
    movelist = generate_pawn_moves(
        H(93, 3, pos), H(93, 3, -9), H(93, 3, movelist),
        H(93, 3, G(102, northeast(G(103, pos->colour[0]) & G(103, pos->pieces[Pawn]))) &
              G(102, (G(104, pos->colour[1]) | G(104, pos->ep)))));)
  G(98, // PAWN WEST CAPTURES
    movelist = generate_pawn_moves(
        H(93, 5, pos), H(93, 5, -7), H(93, 5, movelist),
        H(93, 5, G(107, northwest(G(108, pos->colour[0]) & G(108, pos->pieces[Pawn]))) &
...
typedef struct [[nodiscard]] __attribute__((packed)) {
  i16 material[6];
  H(116, 1, H(117, 1, i8 pawn_threat[5];) H(117, 1, i8 king_shield[2];)
        H(117, 1, i8 bishop_pawns[2];))
  H(116, 1, H(118, 1, i8 passed_pawns[6];) H(118, 1, i8 pst_rank[48];)
        H(118, 1, i8 bishop_pair;) H(118, 1, i8 king_attacks[5];)
            H(118, 1, i8 phalanx_pawn;) H(118, 1, i8 protected_pawn;))
  H(116, 1, H(119, 1, i8 tempo;) H(119, 1, i8 pst_file[48];)
...
typedef struct [[nodiscard]] __attribute__((packed)) {
  i32 material[6];
  H(116, 2, H(117, 2, i32 pawn_threat[5];) H(117, 2, i32 king_shield[2];)
        H(117, 2, i32 bishop_pawns[2];))
  H(116, 2, H(118, 2, i32 passed_pawns[6];) H(118, 2, i32 pst_rank[48];)
        H(118, 2, i32 bishop_pair;) H(118, 2, i32 king_attacks[5];)
            H(118, 2, i32 phalanx_pawn;) H(118, 2, i32 protected_pawn;))
  H(116, 2, H(119, 2, i32 tempo;) H(119, 2, i32 pst_file[48];)
    ...
    __attribute__((aligned(8))) S(1) const EvalParamsInitial initial_params =
        {.phases = {0, 0, 1, 1, 2, 4},
         .mg = {.material = {0, 66, 282, 320, 371, 817},
                .pst_rank =
                    {
                        0,   -15, -17, -5,  8,  29, 97,  0,   // Pawn
                        -16, -5,  6,   18,  27, 38, 18,  -85, // Knight
                        -5,  10,  15,  15,  15, 13, -5,  -59, // Bishop
                        7,   -4,  -10, -14, 2,  11, 0,   7,   // Rook
                        18,  18,  9,   0,   -6, -4, -23, -12, // Queen
                        -11, -8,  -17, -22, 9,  60, 67,  83,  // King
                    },
                .pst_file =
                    {
                        -11, -11, -6,  3,   9,   13,  12, -8, // Pawn
                        -28, -11, -1,  12,  13,  13,  6,  -4, // Knight
                        -14, 0,   3,   1,   4,   -1,  10, -4, // Bishop
                        -12, -9,  -3,  7,   11,  8,   5,  -9, // Rook
                        -13, -8,  -4,  1,   3,   4,   11, 7,  // Queen
                        -12, 12,  -12, -28, -25, -11, 12, 3,  // King
                    },
                .mobilities = {6, 5, 2, 2, -2},
                .king_attacks = {0, 14, 19, 14, 0},
                .pawn_threat = {-15, -7, -7, -7, -2},
                .open_files = {7,
                               -9, -10, 16, -1, -24, 8, -12, -14, 32, -13, -57},
                .passed_pawns = {-6, -10, -8, 11, 35, 97},
                .passed_blocked_pawns = {0, -3, 3, 12, 14, -42},
                .protected_pawn = 15,
                .phalanx_pawn = 9,
                .bishop_pair = 26,
                .bishop_pawns = {-6, -5},
                ...
                .tempo = 17},
         .eg = {.material = {0, 88, 391, 430, 719, 1338},
                .pst_rank =
                    {
                        0,   -5,  -8,  -7, 0,  20, 101, 0,   // Pawn
                        -33, -20, -7,  17, 22, 9,  4,   9,   // Knight
                        -16, -14, -1,  4,  8,  5,  4,   9,   // Bishop
                        -17, -19, -12, 4,  11, 10, 17,  5,   // Rook
                        -59, -43, -15, 13, 31, 26, 32,  14,  // Queen
                        -42, -1,  7,   20, 30, 27, 13,  -56, // King
                    },
                .pst_file =
                    {
                        11,  11, -1, -11, -5, -1, 0,  -4,  // Pawn
                        -20, -5, 7,  16,  16, 5,  -1, -19, // Knight
                        -11, 0,  5,  10,  10, 4,  -3, -15, // Bishop
                        1,   6,  6,  -3,  -5, 0,  0,  -6,  // Rook
                        -23, -6, 4,  7,   14, 14, 0,  -10, // Queen
                        -33, 4,  18, 25,  25, 16, 4,  -40, // King
                    },
                .mobilities = {5, 3, 4, 2, -6},
                .king_attacks = {0, -3, -6, 8, 0},
                .pawn_threat = {-3, -5, -17, -14, -9},
                .open_files = {21, 1, 13, 5, 21, 13, 23, -8, 2, 12, 42, 9},
                .passed_pawns = {9, 15, 40, 67, 115, 101},
                .passed_blocked_pawns = {-10, -8, -31, -62, -111, -114},
                .protected_pawn = 16,
                .phalanx_pawn = 15,
                .bishop_pair = 62,
                .bishop_pawns = {-11, -1},
...
G(121, [[nodiscard]] S(1) i32 combine_eval_param(H(122, 1, const i32 mg_val),
...
S(0) i32 eval(Position *const restrict pos) {
  ...
  for (i32 c = 0; c < 2; c++) {
    ...
    G(125, u64 pawns[2]; for (i32 i = 0; i < 2; i++) {
        ...
        G(129, const u64 no_passers = G(130, pawns[1]) | G(130, attacked_by_pawns);)
            G(129, // PHALANX PAWNS
              score -=
              G(131, eval_params.phalanx_pawn) *
              G(131, count(G(132, pawns[1]) & G(132, west(pawns[1]))));)
      ...
      while (copy) {
        ...
        G(93, // PASSED PAWNS
            if (G(139, p == Pawn) &&
              ...
              G(141, if (G(142, north(piece_bb)) & G(142, pos->colour[1])) {
        ...
        G(93, if (p > Pawn) {
              ...
              G(151, // PIECES ATTACKED BY PAWNS
...
i32 search(
  ...
  // QUIESCENCE
  if (G(194, static_eval > alpha) && G(194, in_qsearch)) {
    if (static_eval >= beta) {
      return static_eval;
    }
    alpha = static_eval;
  ...
  if (G(195, !in_check) && G(195, G(196, alpha) == G(196, beta - 1))) {
    ...
    // NULL MOVE PRUNING
    if (G(202, depth > 2) && G(202, static_eval >= beta) && G(202, do_null)) {
      Position npos = *pos;
      G(203, flip_pos(&npos);)
      G(203, npos.ep = 0;)
  ...
  for (i32 move_index = 0; move_index < stack[ply].num_moves; move_index++) {
    ...
    for (i32 order_index = move_index; order_index < stack[ply].num_moves;
      ...
      const i32 order_move_score =
          ...
          G(179, // PREVIOUS BEST MOVE FIRST
            (move_equal(G(211, &stack[ply].best_move),
                        G(211, &moves[order_index]))
             << 30));
      if (order_move_score > move_score) {
        G(212, best_index = order_index;)
        G(212, move_score = order_move_score;)
      }
    }

    swapmoves(G(213, &moves[best_index]), G(213, &moves[move_index]));

    G(214, // FORWARD FUTILITY PRUNING / DELTA PRUNING
        if (G(217, depth < 8) &&
            G(217, G(218, static_eval) + G(218, G(219, 146) * G(219, depth)) +
                      G(218, initial_params.eg.material[moves[move_index].promo]) +
                      G(218, initial_params.eg
                                 .material[moves[move_index].takes_piece]) <
                  alpha) &&
            G(217, moves_evaluated) && G(217, !in_check)) { break; })

    G(214, // MOVE SCORE PRUNING
    ...
    if (score > best_score) {
      ...
      if (score > alpha) {
        G(224, tt_flag = Exact;)
        G(224, stack[ply].best_move = moves[move_index];)
        G(224, alpha = score;)
        if (score >= beta) {
          assert(stack[ply].best_move.takes_piece ==
                 piece_on(H(52, 8, pos), H(52, 8, stack[ply].best_move.to)));
          G(225, tt_flag = Lower;)
          G(225, if (stack[ply].best_move.takes_piece == None) {
                stack[ply].killer = stack[ply].best_move;
              })
          G(225, if (!in_qsearch) {
                const i32 bonus = depth * depth;
                G(226, i32 *const this_hist =
                  ...
                  *this_hist +=
                  bonus - G(227, bonus) * G(227, *this_hist) / 1024;)
                G(226, for (i32 prev_index = 0; prev_index < move_index;
                              prev_index++) {
                      ...
                      i32 *const prev_hist =
                          &move_history[pos->flipped][prev.takes_piece]
                                       [prev.from][prev.to];
                      *prev_hist -=
                          bonus + G(228, bonus) * G(228, *prev_hist) / 1024;
                    })
              })
          break;
        }
...
S(1) void init() {
  G(80, // MERGE EVAL PARAMS
      for (i32 i = 0; i < sizeof(EvalParamsMerged) / sizeof(i32); i++) {
        ((i32 *)&eval_params)[i] =
            combine_eval_param(H(122, 2, i < 6 ? initial_params.mg.material[i]
                                       : ((i8 *)&initial_params.mg)[6 + i]),
                               H(122, 2, i < 6 ? initial_params.eg.material[i]
  ...
  G(80, // INIT DIAGONAL MASKS
      for (i32 sq = 0; sq < 64; sq++) {
        ...
        diag_mask[sq] = G(242, sw_bb) | G(242, ne_bb);
      })
}
...
void iteratively_deepen(
  ...
  for (i32 depth = 1; depth < max_ply; depth++) {
    ...
    while (true) {
      ...
      G(244, const i32 alpha = score - window;)
      score = search(
#ifdef FULL
          &data->nodes,
#endif
      ...
      G(246, window *= 2;)
      G(246, if (G(247, elapsed > data->max_time) ||
                   G(247, (G(248, score > alpha) && G(248, score < beta)))) {
            break;
          })
    }
...
S(1) void display_pos(Position *const pos) {
  ...
  for (i32 rank = 7; rank >= 0; rank--) {
    for (i32 file = 0; file < 8; file++) {
      i32 sq = rank * 8 + file;
      u64 bb = 1ULL << sq;
      i32 piece = piece_on(H(52, 9, &npos), H(52, 9, sq));
      if (bb & npos.colour[0]) {
        if (piece == Pawn) {
          putl("P");
