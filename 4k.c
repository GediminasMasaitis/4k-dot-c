...
G(70, S(1) const EvalParams mg = ((EvalParams){
          .material = {71, 294, 299, 407, 900, 0},
          .pst_rank =
              {
                  0,   -9,  -10, -8,  3,  24, 92,  0,   // Pawn
                  -24, -11, 0,   14,  25, 44, 25,  -71, // Knight
                  -11, 6,   13,  13,  16, 16, -3,  -51, // Bishop
                  -6,  -13, -20, -21, 1,  22, 15,  22,  // Rook
                  14,  17,  8,   -2,  -6, -2, -24, -6,  // Queen
                  -7,  -11, -29, -29, 8,  59, 64,  85,  // King
              },
          .pst_file =
              {
                  -19, -10, -10, -1,  5,   21,  21, -9, // Pawn
                  -24, -9,  -1,  13,  11,  11,  3,  -3, // Knight
                  -10, 3,   5,   2,   4,   -3,  3,  -4, // Bishop
                  -6,  -5,  3,   10,  9,   2,   -3, -9, // Rook
                  -10, -6,  -2,  2,   1,   1,   7,  7,  // Queen
                  -10, 23,  2,   -45, -16, -34, 19, 5,  // King
              },
          .mobilities = {6, 6, 2, 3, -4},
          .king_attacks = {0, 15, 20, 14, 0},
          .open_files = {24, -11, -10, 21, -3, -26},
          .passed_pawns = {-17, -20, -12, 10, 35, 92},
          .passed_blocked_pawns = {6, -1, 2, 10, 12, -30},
          .bishop_pair = 25,
          .pawn_attacked_penalty = {-16, -128},
          .tempo = 16});)

G(70, S(1) const EvalParams eg = ((EvalParams){
          .material = {71, 301, 297, 541, 988, 0},
          .pst_rank =
              {
                  0,   -4,  -6,  -5, 0,  15, 77, 0,   // Pawn
                  -35, -19, -4,  18, 24, 9,  2,  5,   // Knight
                  -12, -11, -1,  2,  5,  4,  4,  9,   // Bishop
                  -19, -19, -11, 5,  12, 11, 16, 6,   // Rook
                  -67, -45, -19, 10, 30, 31, 41, 19,  // Queen
                  -31, -5,  10,  22, 27, 20, 4,  -41, // King
              },
          .pst_file =
              {
                  9,   12, 0,  -9, -4, -3, 2,  -6,  // Pawn
                  -18, -4, 8,  14, 14, 5,  -1, -19, // Knight
                  -6,  -1, 0,  3,  4,  3,  1,  -6,  // Bishop
                  1,   3,  4,  -1, -4, 0,  1,  -3,  // Rook
                  -17, -4, 3,  7,  11, 9,  -2, -6,  // Queen
                  -24, -4, 10, 23, 18, 19, -5, -32, // King
              },
          .mobilities = {1, 4, 4, 2, -1},
          .king_attacks = {0, -3, -6, 6, 0},
          .open_files = {28, -4, 7, 8, 27, 10},
          .passed_pawns = {0, 4, 24, 46, 84, 77},
          .passed_blocked_pawns = {-14, -13, -32, -56, -96, -103},
          .bishop_pair = 53,
        ...
        G(
            44, if (p > Pawn) {
              ...
              G(88, const u64 mobility =
                        get_mobility(H(33, 3, pos), H(33, 3, sq),
                                     H(33, 3, p == King ? Queen : p));
