...
G(121, // EVAL PARAMETERS
  __attribute__((aligned(8))) S(1)
      const EvalParamsInitial initial_params = {
          .phases = {0, 0, 1, 1, 2, 4},
          .mg = {.material = {0, 65, 292, 332, 384, 842},
                 .pst_rank =
                     {
                         0,   -15, -18, -5,  7,  30, 97,  0,   // Pawn
                         -19, -7,  6,   21,  30, 40, 19,  -90, // Knight
                         -8,  9,   15,  17,  18, 17, -4,  -64, // Bishop
                         5,   -5,  -10, -13, 2,  12, 2,   7,   // Rook
                         16,  16,  9,   0,   -4, -3, -20, -14, // Queen
                         -12, -8,  -15, -20, 11, 64, 71,  88,  // King
                     },
                 .pst_file =
                     {
                         ...
                         -11, 12,  -13, -27, -28, -10, 11, 4,   // King
                     },
                 .mobilities = {7, 5, 2, 3, -2},
                 .king_attacks = {0, 13, 19, 14, 0},
                 .pawn_threat = {-18, -8, -7, -7, 0},
                 .open_files = {8, -10, -10, 16, -2, -24, 7, -12, -14, 33, -13,
                                -57},
                 .passed_pawns = {0, 0, 0, 13, 35, 97},
                 .passed_blocked_pawns = {-5, -9, -2, 13, 15, -39},
                 .protected_pawn = 17,
                 .phalanx_pawn = 10,
                 .bishop_pair = 27,
                 .bishop_pawns = {-5, -5},
                 ...
                 .pst_file =
                     {
                         ...
                         -33, 4,  18, 25,  26, 16, 4,  -40, // King
                     },
                 .mobilities = {5, 3, 4, 2, -6},
                 .king_attacks = {0, -3, -7, 7, 0},
                 .pawn_threat = {-2, -5, -18, -14, -9},
                 .open_files = {20, 1, 13, 6, 23, 14, 23, -8, 2, 12, 44, 10},
                 .passed_pawns = {5, 10, 36, 65, 114, 103},
                 .passed_blocked_pawns = {-7, -4, -29, -62, -112, -118},
                 .protected_pawn = 15,
                 .phalanx_pawn = 14,
                 .bishop_pair = 62,
                 .bishop_pawns = {-12, -1},
