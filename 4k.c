...
typedef struct [[nodiscard]] __attribute__((packed)) {
  ...
  H(118, 1, i8 king_shield[2]; i8 pawn_threat[6];)
} EvalParams;
...
typedef struct [[nodiscard]] __attribute__((packed)) {
  ...
  H(118, 2, i32 king_shield[2]; i32 pawn_threat[6];)
} EvalParamsMerged;
