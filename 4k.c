          ...
          .pst_rank =
              {
                  ...
                  -32, -18, -3,  19, 23, 8,  0,  3,   // Knight
                  -10, -11, -1,  2,  5,  3,  3,  9,   // Bishop
                  -19, -19, -12, 5,  12, 10, 15, 6,   // Rook
                  -62, -47, -19, 10, 29, 30, 39, 19,  // Queen
                  -40, -1,  9,   19, 25, 21, 8,  -47, // King
              },
          .pst_file =
              {
                  9,   12, 0,  -9, -4, -3, 2,  -5,  // Pawn
                  -18, -3, 9,  14, 14, 5,  -1, -20, // Knight
                  -7,  -1, 0,  4,  5,  4,  1,  -6,  // Bishop
                  1,   4,  4,  -2, -5, 0,  0,  -2,  // Rook
                  -20, -5, 3,  8,  13, 11, -2, -7,  // Queen
                  -25, 1,  14, 25, 20, 21, 1,  -33, // King
              },
          .mobilities = {1, 4, 3, 1, -4},
          .king_attacks = {0, -3, -7, 6, 0},
          .open_files = {28, -4, 7, 9, 29, 9},
          .passed_pawns = {0, 5, 25, 47, 84, 77},
          .passed_blocked_pawns = {-12, -14, -33, -57, -97, -104},
          .bishop_pair = 54,
