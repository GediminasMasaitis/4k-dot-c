...
G(46, S(1) void move_str(H(50, 1, const i32 flip),
...
G(46, [[nodiscard]] S(1) bool move_equal(G(53, Move* const rhs),
  G(53, Move* const lhs)) {
...
G(57, [[nodiscard]] S(0) i32 is_attacked(H(58, 1, const Position* const restrict pos),
  H(58, 1, const u64 bb)) {
  assert(count(bb) == 1);
  ...
  G(59, const u64 pawns = theirs & pos->pieces[Pawn];)
    ...
    G(60, G(63, rook(H(41, 2, blockers), H(41, 2, bb))) &
      ...
      G(63, theirs)) ||
    G(60, G(64, pos->pieces[King]) & G(64, theirs) & G(64, king(bb))) ||
    G(60, G(65, bishop(H(43, 2, blockers), H(43, 2, bb))) &
      G(65, theirs) &
      G(65, (pos->pieces[Bishop] | pos->pieces[Queen]))) ||
    G(60, G(66, pos->pieces[Knight]) & G(66, knight(bb)) & G(66, theirs));
})
...
G(74, S(0) Move* generate_pawn_moves(H(93, 1, u64 to_mask),
  ...
  G(96, const u64 all = G(97, pos->colour[0]) | G(97, pos->colour[1]);)
    ...
    G(98, // PAWN DOUBLE MOVES
      movelist = generate_pawn_moves(
        H(93, 3, north(G(102, G(103, pos->colour[0]) & G(103, pos->pieces[Pawn]))) &
          G(102, ~all) &
          G(102, (only_captures ? 0xFF00000000000000ull : ~0ull))),
        H(93, 3, pos),
        H(93, 3, -8), H(93, 3, movelist));)
      ...
      if (!only_captures) {
        movelist = generate_pawn_moves(
          H(93, 2, G(99, north(G(100, north(G(101, pos->colour[0]) &
            ...
            G(99, ~all)),
          H(93, 2, pos),
          H(93, 2, -16), H(93, 2, movelist));
      })
    G(98, // PAWN EAST CAPTURES
      movelist = generate_pawn_moves(
        H(93, 4, G(104, northeast(G(105, pos->colour[0]) & G(105, pos->pieces[Pawn]))) &
          G(104, (G(106, pos->colour[1]) | G(106, pos->ep)))),
        H(93, 4, pos),
        H(93, 4, -9), H(93, 4, movelist));)
    G(98, // SHORT CASTLE
...
typedef struct [[nodiscard]] __attribute__((packed)) {
  i16 material[6];
  H(116, 1, H(117, 1, i8 pawn_threat[5];) H(117, 1, i8 bishop_pawns[2];)
    H(117, 1, i8 king_shield[2];))
    H(116, 1, H(118, 1, i8 bishop_pair;) H(118, 1, i8 king_attacks[5];)
      H(118, 1, i8 pst_rank[48];) H(118, 1, i8 phalanx_pawn;)
...
typedef struct [[nodiscard]] __attribute__((packed)) {
  i32 material[6];
  H(116, 2, H(117, 2, i32 pawn_threat[5];) H(117, 2, i32 bishop_pawns[2];)
    H(117, 2, i32 king_shield[2];))
    H(116, 2, H(118, 2, i32 bishop_pair;) H(118, 2, i32 king_attacks[5];)
      H(118, 2, i32 pst_rank[48];) H(118, 2, i32 phalanx_pawn;)
...
S(0) i32 eval(Position* const restrict pos) {
  G(124, i32 score = eval_params.tempo;)
    ...
    for (i32 c = 0; c < 2; c++) {
      ...
      G(129, const u64 no_passers = G(132, pawns[1]) | G(132, attacked_by_pawns);)
        G(129, // PHALANX PAWNS
          score -=
...
i32 search(
      ...
      G(207, flip_pos(&npos);)
        ...
        const i32 score = -search(
          ...
          H(182, 2, H(183, 2, &npos), H(183, 2, -alpha),
            H(183, 2, depth - G(208, 4) - G(208, depth / 4)), H(183, 2, data)),
  ...
  stack[ply].num_moves =
    ...
    for (i32 move_index = 0; move_index < stack[ply].num_moves; move_index++) {
      ...
      G(218, // MOVE SCORE PRUNING
        if (G(222, moves_evaluated) &&
          G(222, move_score < G(223, -125) * G(223, depth))) {
          break;
        })

        G(218, // FORWARD FUTILITY PRUNING / DELTA PRUNING
          if (G(219, moves_evaluated) &&
            G(219, !in_check) &&
            G(219, G(220, static_eval) + G(220, G(221, 154) * G(221, depth)) +
              G(220, initial_params.eg.material[moves[move_index].promo]) +
      ...
      while (true) {
        score = -search(
          ...
          H(182, 3, H(183, 3, &npos), H(183, 3, -alpha),
            H(183, 3, depth - G(227, reduction) - G(227, 1)), H(183, 3, data)),
        ...
        if (score > alpha) {
          G(228, tt_flag = Exact;)
            ...
            if (score >= beta) {
              ...
              G(229, tt_flag = Lower;)
                G(229, if (stack[ply].best_move.takes_piece == None) {
                ...
                *this_hist +=
                  ...
                  G(230, for (i32 prev_index = 0; prev_index < move_index;
                    prev_index++) {
  ...
  G(238, // UPDATE CORRECTION HISTORY
    if (G(239, G(240, tt_flag) != G(240, (best_score < stack[ply].static_eval))) &&
      G(239, G(241, stack[ply].best_move.takes_piece) == G(241, None))) {
      G(242, i32 dd = depth * depth; if (dd > 64) { dd = 64; })
        G(242, i32 target = best_score - stack[ply].static_eval; G(243, if (target < -96) { target = -96; })
  ...
  for (i32 depth = 1; depth < max_ply; depth++) {
    ...
    G(250, i32 window = 16;)
      ...
      while (true) {
        ...
        G(253, window *= 2;)
          G(253, if (G(254, elapsed > data->max_time) ||
...
S(1) void run() {
  ...
  while (true) {
...
#endif
    G(258, if (G(259, line[0]) == G(259, 'q')) { exit_now(); })
    ...
    else G(258, if (G(260, line[0]) == G(260, 'g')) {
      stop = false;
#ifdef FULL
      while (true) {
        getl(line);
