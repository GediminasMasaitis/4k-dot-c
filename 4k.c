  ...
  __attribute__((aligned(8))) S(1)
      const EvalParamsInitial initial_params =
          {.phases = {0, 0, 1, 1, 2, 4},
           .mg =
               {
                   .material = {0, 62, 248, 278, 302, 477},
                   .pst_rank =
                       {
                           0,   -15, -17, -5,  7,  31, 127, 0,   // Pawn
                           -20, -8,  5,   19,  29, 39, 18,  -82, // Knight
                           -8,  8,   15,  18,  19, 20, -3,  -67, // Bishop
                           7,   -4,  -8,  -12, 4,  13, 1,   -1,  // Rook
                           15,  16,  9,   1,   -3, -1, -18, -19, // Queen
                           -4,  2,   -11, -28, -6, 39, 50,  51,  // King
                       },
                   .pst_file =
                       {
                           -5,  -10, -7,  1,   6,   11,  11, -7, // Pawn
                           -29, -11, -1,  11,  14,  13,  7,  -4, // Knight
                           -14, 0,   3,   0,   4,   -1,  11, -3, // Bishop
                           -12, -9,  -3,  6,   12,  8,   7,  -9, // Rook
                           -13, -7,  -4,  0,   2,   4,   13, 6,  // Queen
                           -10, 14,  -11, -27, -27, -11, 11, 2,  // King
                       },
                   .mobilities = {6, 5, 2, 2, -2},
                   .king_attacks = {0, 12, 18, 14, 0},
                   .pawn_threat = {-16, -8, -6, -8, 0},
                   .open_files = {8, -10, -12, 16, -3, -21, 5, -12, -14, 33,
                                  -12, -57},
                   .passed_pawns = {-8, 1, 14, 47, 84, 127},
                   .passed_blocked_pawns = {0, 0, 0, 8, 9, -39},
           ...
           .eg =
               {
                   .material = {0, 89, 394, 444, 737, 1473},
                   .pst_rank =
                       {
                           0,   -4,  -9,  -8, 0,  20, 88, 0,   // Pawn
                           -30, -18, -6,  17, 22, 7,  2,  6,   // Knight
                           -13, -11, 0,   4,  6,  2,  2,  9,   // Bishop
                           -18, -18, -11, 5,  10, 9,  18, 6,   // Rook
                           -57, -41, -13, 14, 30, 24, 28, 16,  // Queen
                           -35, -2,  7,   22, 32, 29, 18, -39, // King
                       },
                   .pst_file =
                       {
                           1,   6,  0,  -6, 0,  2,  1,  -3,  // Pawn
                           -18, -5, 7,  16, 16, 4,  -1, -19, // Knight
                           -9,  0,  4,  10, 10, 4,  -4, -15, // Bishop
                           1,   6,  5,  -3, -6, 0,  0,  -4,  // Rook
                           -23, -9, 2,  7,  15, 15, 1,  -7,  // Queen
                           -27, 0,  11, 16, 19, 15, 6,  -27, // King
                       },
                   .mobilities = {5, 3, 4, 2, -3},
                   .king_attacks = {0, -1, -7, 9, 0},
                   .pawn_threat = {-3, -5, -19, -13, -8},
                   .open_files = {6, 3, 18, 8, 23, 7, 24, -8, 2, 13, 40, 6},
                   .passed_pawns = {14, 1, 19, 45, 95, 88},
                   .passed_blocked_pawns = {-10, -3, -14, -35, -74, -75},
