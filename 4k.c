...
typedef struct [[nodiscard]] __attribute__((packed)) {
  i16 material[7];
  H(124, 1,
    H(125, 1, i8 tempo;) H(125, 1, i8 passed_blocked_pawns[6];)
        H(125, 1, i8 open_files[6];) H(125, 1, i8 mobilities[5];)
            H(125, 1, u8 pawn_attacked_penalty[2];))
  H(124, 1,
    H(126, 1, i8 pst_rank[48];) H(126, 1, i8 bishop_pair;)
        H(126, 1, i8 pst_file[48];) H(126, 1, i8 passed_pawns[6];)
...
typedef struct [[nodiscard]] __attribute__((packed)) {
  i32 material[7];
  H(124, 2,
    H(125, 2, i32 tempo;) H(125, 2, i32 passed_blocked_pawns[6];)
        H(125, 2, i32 open_files[6];) H(125, 2, i32 mobilities[5];)
            H(125, 2, i32 pawn_attacked_penalty[2];))
  H(124, 2,
    H(126, 2, i32 pst_rank[48];) H(126, 2, i32 bishop_pair;)
        H(126, 2, i32 pst_file[48];) H(126, 2, i32 passed_pawns[6];)
...
i32 search(H(165, 1, i32 depth), H(165, 1, i32 alpha),
  ...
  for (i32 move_index = 0; move_index < stack[ply].num_moves; move_index++) {
    ...
    i32 reduction = G(201, depth > 3) && G(201, move_score <= 0)
                        ? G(202, moves_evaluated / 10) + G(202, !improving) +
