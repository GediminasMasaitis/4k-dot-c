      ...
      for (i32 piece = Knight; piece <= King; piece++) {
        ...
        while (copy) {
          ...
          G(46, u64 moves = G(47, to_mask) &
                            G(47, get_mobility(H(33, 2, pos), H(33, 2, from),
                                               H(33, 2, piece)));)
...
S(1) void init() {
  ...
  G(
      49, for (i32 sq = 0; sq < 64; sq++) {
        const u64 bb = 1ULL << sq;
        diag_mask[sq] = G(73, ray(H(15, 4, 0), H(15, 4, ~0x101010101010101ull),
                                  H(15, 4, bb), H(15, 4, 9))) | // Northeast
                        G(73, ray(H(15, 5, 0), H(15, 5, ~0x8080808080808080ull),
...
S(1)
i16 search(H(96, 1, const i32 ply), H(96, 1, i32 alpha), H(96, 1, i32 depth),
           H(96, 1, Position *const restrict pos), H(97, 1, const bool do_null),
#ifdef FULL
           u64 *nodes,
#endif
  ...
  if (tt_entry->partial_hash == tt_hash_partial) {
    ...
    // TT PRUNING
    if (G(101, alpha == beta - 1) && G(101, tt_entry->depth >= depth) &&
  ...
  if (G(104, !in_check) && G(104, alpha == beta - 1)) {
    ...
    if (G(107, depth > 2) && G(107, static_eval >= beta) && G(107, do_null)) {
      ...
      const i32 score = -search(
          H(96, 2, ply + 1), H(96, 2, -beta), H(96, 2, depth - 3 - depth / 4),
          H(96, 2, &npos), H(97, 2, false),
#ifdef FULL
          nodes,
#endif
  ...
  for (i32 move_index = 0; move_index < stack[ply].num_moves; move_index++) {
    ...
    if (G(113, depth < 8) &&
        G(113,
          G(114, static_eval + 136 * depth) +
              ...
              alpha) &&
        G(113, !in_check) && G(113, moves_evaluated)) {
      break;
    }
    ...
    while (true) {
      score = -search(
          H(96, 3, ply + 1), H(96, 3, low), H(96, 3, depth - reduction),
          H(96, 3, &npos), H(97, 3, true),
#ifdef FULL
          nodes,
#endif
...
#endif
    i32 score =
        search(H(96, 4, 0), H(96, 4, -inf), H(96, 4, depth), H(96, 4, pos),
               H(97, 4, false),
#ifdef FULL
               nodes,
#endif
