...
G(
    ...
    __attribute__((aligned(8))) S(1) C(1) EvalParamsInitial initial_params = {.phases = {0, 0, 1, 1, 2, 4},
                                                                              .mg =
                                                                                  {
                                                                                      .material = {0, 68, 292, 330, 382, 845},
                                                                                      .pst_rank =
                                                                                          {
                                                                                              0,   -15, -18, -4,  6,  30, 126, 0,   // Pawn
                                                                                              -20, -5,  8,   23,  30, 35, 12,  -83, // Knight
                                                                                              -8,  10,  16,  19,  16, 16, -9,  -59, // Bishop
                                                                                      ...
                                                                                      .pawn_threat = {-16, -9, -8, -8, -1},
                                                                                      .open_files = {8, -11, -11, 17, -2, -22, 7, -10, -11, 33, -11, -57},
                                                                                      .passed_pawns = {-9, -2, 9, 41, 76, 126},
                                                                                      .passed_blocked_pawns = {-1, -5, -3, 3, 3, -49},
                                                                                      ...
                                                                                      .bishop_pawns = {-5, -5},
                                                                                      .king_shield = {29, 18},
                                                                                      .pawn_attacked_penalty = {-52, -105},
                                                                                      .piece_threats = {25, 17},
                                                                                      .tempo = 30,
                                                                                  },
                                                                              .eg = {
                                                                                  .material = {0, 86, 406, 444, 738, 1373},
                                                                                  .pst_rank =
                                                                                      {
                                                                                          0,   0,   -7,  -6, -1, 14, 93, 0,   // Pawn
                                                                                          -28, -16, -6,  16, 21, 6,  2,  6,   // Knight
                                                                                          -11, -10, 0,   3,  6,  2,  4,  7,   // Bishop
                                                                                          -17, -18, -10, 4,  10, 9,  17, 5,   // Rook
                                                                                          -56, -41, -12, 13, 29, 25, 30, 13,  // Queen
                                                                                  ...
                                                                                  .pawn_threat = {-3, -6, -17, -12, -6},
                                                                                  .open_files = {7, 3, 18, 9, 25, 8, 23, -7, 3, 12, 43, 7},
                                                                                  .passed_pawns = {14, 3, 20, 47, 100, 93},
