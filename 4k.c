...
typedef struct [[nodiscard]] __attribute__((packed)) {
  i16 material[6];
  H(116, 1,
    H(117, 1, i8 king_shield[2];) H(117, 1, i8 piece_threats[5];) H(117, 1, i8 passed_king_distance[2];) H(117, 1, i8 bishop_pawns[2];)
...
typedef struct [[nodiscard]] __attribute__((packed)) {
  i32 material[6];
  H(116, 2,
    H(117, 2, i32 king_shield[2];) H(117, 2, i32 piece_threats[5];) H(117, 2, i32 passed_king_distance[2];) H(117, 2, i32 bishop_pawns[2];)
...
G(
    ...
    __attribute__((aligned(8))) S(1) C(1) EvalParamsInitial initial_params = {.phases = {0, 0, 1, 1, 2, 4},
                                                                              ...
                                                                              .eg = {
                                                                                  .material = {0, 86, 407, 444, 740, 1370},
                                                                                  .pst_rank =
                                                                                      {
                                                                                          0,   0,   -7,  -6, -1, 14, 94, 0,   // Pawn
              ...
              G(155, const u64 mobility = get_mobility(H(69, 3, pos), H(69, 3, p), H(69, 3, sq));
                ...
                G(170, // PIECE THREATS
                  score += G(289, count(G(290, mobility) & G(290, pos->colour[1] & ~(G(291, pos->pieces[Pawn]) | G(291, attacked_by_pawns))))) *
                           G(289, eval_params.piece_threats[p - 2]);)
