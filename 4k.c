...
G(46, S(1) void move_str(H(50, 1, const Move* restrict move),
...
G(57, [[nodiscard]] S(0) i32 is_attacked(H(58, 1, const Position* const restrict pos),
  ...
  G(59, const u64 pawns = theirs & pos->pieces[Pawn];)
    ...
    G(60, G(65, rook(H(41, 2, blockers), H(41, 2, bb))) &
      ...
      G(65, theirs)) ||
    G(60, G(64, pos->pieces[King]) & G(64, king(bb)) & G(64, theirs)) ||
...
G(57, [[nodiscard]] S(0) u64 get_mobility(H(69, 1, const Position* pos),
...
G(74, S(0) Move* generate_pawn_moves(H(93, 1, const i32 offset),
  H(93, 1, u64 to_mask),
...
[[nodiscard]] S(1) i32 movegen(H(95, 1, const Position* const restrict pos),
  ...
  G(96, const u64 all = G(97, pos->colour[0]) | G(97, pos->colour[1]);)
    ...
    G(98, // PAWN WEST CAPTURES
      movelist = generate_pawn_moves(
        H(93, 4, -7),
        H(93, 4, G(104, northwest(G(105, pos->colour[0]) & G(105, pos->pieces[Pawn]))) &
          G(104, (G(106, pos->colour[1]) | G(106, pos->ep)))),
        H(93, 4, movelist), H(93, 4, pos));)
    G(98, // PAWN EAST CAPTURES
      movelist = generate_pawn_moves(
        H(93, 5, -9),
        H(93, 5, G(107, northeast(G(108, pos->colour[0]) & G(108, pos->pieces[Pawn]))) &
...
typedef struct [[nodiscard]] __attribute__((packed)) {
  i16 material[6];
  H(116, 1, H(118, 1, i8 king_attacks[5];) H(118, 1, i8 protected_pawn;)
    H(118, 1, i8 bishop_pair;) H(118, 1, i8 phalanx_pawn;)
    H(118, 1, i8 passed_pawns[6];) H(118, 1, i8 pst_rank[48];))
    H(116, 1, H(117, 1, i8 passed_king_distance[2];) H(117, 1, i8 pawn_threat[5];)
...
typedef struct [[nodiscard]] __attribute__((packed)) {
  i32 material[6];
  H(116, 2, H(118, 2, i32 king_attacks[5];) H(118, 2, i32 protected_pawn;)
    H(118, 2, i32 bishop_pair;) H(118, 2, i32 phalanx_pawn;)
    H(118, 2, i32 passed_pawns[6];) H(118, 2, i32 pst_rank[48];))
    H(116, 2, H(117, 2, i32 passed_king_distance[2];) H(117, 2, i32 pawn_threat[5];)
              ...
              G(93, // PASSED PAWNS
                if (G(143, p == Pawn) &&
                  ...
                  G(145, score += eval_params.passed_pawns[rank - 1];)
                    ...
                    G(145, if (G(146, north(piece_bb)) & G(146, pos->colour[1])) {
...
i32 search(
  ...
  stack[ply].num_moves =
    ...
    for (i32 move_index = 0; move_index < stack[ply].num_moves; move_index++) {
      ...
      G(222, // FORWARD FUTILITY PRUNING / DELTA PRUNING
        if (G(225, depth < 6) &&
          G(225, G(226, initial_params.eg.material[moves[move_index].takes_piece]) +
        ...
        G(222, // MOVE SCORE PRUNING
          if (G(223, moves_evaluated) &&
            G(223, move_score < G(224, -175) * G(224, depth))) {
            break;
          })
        ...
        if (score > alpha) {
          G(232, tt_flag = Exact;)
            ...
            if (score >= beta) {
              ...
              G(233, tt_flag = Lower;)
                G(233, if (stack[ply].best_move.takes_piece == None) {
                ...
                *this_hist +=
                  ...
                  G(234, for (i32 prev_index = 0; prev_index < move_index;
                    prev_index++) {
      ...
      // LATE MOVE PRUNING
      if (G(237, !in_check) && G(237, G(238, alpha) == G(238, beta - 1)) &&
  ...
  G(242, // UPDATE CORRECTION HISTORY
    if (G(243, G(244, tt_flag) != G(244, (best_score < stack[ply].static_eval))) &&
      G(243, G(245, stack[ply].best_move.takes_piece) == G(245, None))) {
      G(246, i32 dd = depth * depth; if (dd > 70) { dd = 70; })
        G(246, i32 target = best_score - stack[ply].static_eval; G(247, if (target < -126) { target = -126; })
  ...
  for (i32 depth = 1; depth < max_ply; depth++) {
    ...
    G(254, i32 window = 16;)
      ...
      while (true) {
        ...
        G(257, window *= 2;)
          G(257, if (G(258, elapsed > data->max_time) ||
...
S(1) void run() {
  ...
  while (true) {
...
#endif
    G(262, if (G(268, line[0]) == G(268, 'i')) { puts("readyok"); })
    ...
    }) else G(262, if (G(269, line[0]) == G(269, 'q')) { exit_now(); })
  }
}
