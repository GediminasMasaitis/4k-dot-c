...
G(23, [[nodiscard]] S(0) u64 xattack(H(25, 1, const u64 dir_mask),
  H(25, 1, const u64 bb),
...
G(30, [[nodiscard]] S(1) u64 bishop(H(31, 1, const u64 blockers),
  H(31, 1, const u64 bb)) {
  assert(count(bb) == 1);
  const i32 sq = lsb(bb);
  return G(32, xattack(H(25, 3, flip_bb(diag_mask[G(33, sq) ^ G(33, 56)])),
    H(25, 3, bb), H(25, 3, blockers))) |
    G(32, xattack(H(25, 2, diag_mask[sq]), H(25, 2, bb),
      H(25, 2, blockers)));
})

G(30, [[nodiscard]] S(1) u64 rook(H(34, 1, const u64 blockers),
  H(34, 1, const u64 bb)) {
  assert(count(bb) == 1);
  return G(35, // East
    ...
    G(35, // West
      ray(H(24, 3, blockers), H(24, 3, ~0x8080808080808080ull),
        H(24, 3, bb), H(24, 3, -1))) |
    G(35, xattack(H(25, 4, bb ^ 0x101010101010101ULL << lsb(bb) % 8),
...
G(50, [[nodiscard]] S(1) bool move_equal(G(54, Move* const rhs),
  G(54, Move* const lhs)) {
  return G(55, *(u32*)lhs) == G(55, *(u32*)rhs);
})

G(50, S(1) void swapu64(G(56, u64* const rhs), G(56, u64* const lhs)) {
  const u64 temp = *lhs;
  *lhs = *rhs;
  *rhs = temp;
})

G(50, S(1) void move_str(H(57, 1, char* restrict str),
...
G(50, S(1) void swapu16(G(57, u16* const restrict lhs),
...
G(62, [[nodiscard]] S(1) i32 is_attacked(H(63, 1, const Position* const restrict pos),
  H(63, 1, const u64 bb)) {
  assert(count(bb) == 1);
  ...
  G(64, const u64 pawns = theirs & pos->pieces[Pawn];)
    ...
    G(65, G(69, king(bb)) & G(69, theirs) & G(69, pos->pieces[King])) ||
...
G(62, S(0) void flip_pos(Position* const restrict pos) {
...
G(62, [[nodiscard]] S(1) u64 get_mobility(H(75, 1, const Position* pos),
  H(75, 1, const i32 sq),
  ...
  G(76, if (piece == King) { moves = king(bb); })
    ...
    G(78, if (G(80, piece == Queen) || G(80, piece == Rook)) {
      ...
      G(78, if (G(79, piece == Queen) || G(79, piece == Bishop)) {
...
G(82, S(0) Move* generate_pawn_moves(H(101, 1, const Position* const pos),
...
G(82, S(0) i32 makemove(H(83, 1, Position* const restrict pos),
...
G(82, S(1) Move* generate_piece_moves(H(96, 1, const u64 to_mask),
...
[[nodiscard]] S(0) i32 movegen(H(103, 1, const Position* const restrict pos),
  ...
  G(104, const u64 all = G(105, pos->colour[0]) | G(105, pos->colour[1]);)
    ...
    G(106, // PAWN PROMOTIONS
      if (!only_captures) {
        movelist = generate_pawn_moves(
          ...
          H(101, 2, G(107, north(G(108, north(G(109, pos->colour[0]) &
    ...
    G(106, // PAWN DOUBLE MOVES
      movelist = generate_pawn_moves(
        ...
        H(101, 3, north(G(110, G(111, pos->colour[0]) & G(111, pos->pieces[Pawn]))) &
          G(110, ~all) &
    ...
    G(106, // PAWN WEST CAPTURES
      movelist = generate_pawn_moves(
        ...
        H(101, 4, G(112, nw(G(113, pos->colour[0]) & G(113, pos->pieces[Pawn]))) &
          G(112, (G(114, pos->colour[1]) | G(114, pos->ep)))),
        H(101, 4, -7));)
    G(106, // SHORT CASTLE
      if (G(121, !(G(122, all) & G(122, 0xEull))) && G(121, pos->castling[1]) &&
        G(121, !only_captures) &&
    ...
    G(106, // PAWN EAST CAPTURES
      movelist = generate_pawn_moves(
        ...
        H(101, 5, G(115, ne(G(116, pos->colour[0]) & G(116, pos->pieces[Pawn]))) &
...
typedef struct [[nodiscard]] __attribute__((packed)) {
  i16 material[6];
  H(124, 1, H(125, 1, i8 tempo;) H(125, 1, i8 pawn_attacked_penalty[2];)
    H(125, 1, i8 mobilities[5];) H(125, 1, i8 passed_blocked_pawns[6];)
    H(125, 1, i8 open_files[6];) H(125, 1, i8 pst_file[48];))
    H(124, 1, H(126, 1, i8 protected_pawn;) H(126, 1, i8 phalanx_pawn;)
      H(126, 1, i8 bishop_pair;) H(126, 1, i8 passed_pawns[6];)
      H(126, 1, i8 king_attacks[5];) H(126, 1, i8 pst_rank[48];))
} EvalParams;

typedef struct [[nodiscard]] __attribute__((packed)) {
  i32 material[6];
  H(124, 2, H(125, 2, i32 tempo;) H(125, 2, i32 pawn_attacked_penalty[2];)
    H(125, 2, i32 mobilities[5];) H(125, 2, i32 passed_blocked_pawns[6];)
    H(125, 2, i32 open_files[6];) H(125, 2, i32 pst_file[48];))
    H(124, 2, H(126, 2, i32 protected_pawn;) H(126, 2, i32 phalanx_pawn;)
      H(126, 2, i32 bishop_pair;) H(126, 2, i32 passed_pawns[6];)
...
S(1) i32 eval(Position* const restrict pos) {
  G(131, i32 score = eval_params.tempo;)
    ...
    for (i32 c = 0; c < 2; c++) {
      ...
      G(132, const u64 opp_king_zone =
        ...
        G(132, const u64 own_pawns = G(137, pos->pieces[Pawn]) & G(137, pos->colour[0]);)
        G(132, // BISHOP PAIR
          if (count(G(139, pos->pieces[Bishop]) & G(139, pos->colour[0])) > 1) {
            score += eval_params.bishop_pair;
          })
        G(132, const u64 opp_pawns = G(133, pos->pieces[Pawn]) & G(133, pos->colour[1]);
      const u64 attacked_by_pawns =
        G(134, se(opp_pawns)) | G(134, sw(opp_pawns));
      G(135, // PHALANX PAWNS
        score -=
        eval_params.phalanx_pawn * count(opp_pawns & east(opp_pawns));)
        G(135, // PROTECTED PAWNS
          score -=
          eval_params.protected_pawn * count(opp_pawns & attacked_by_pawns);)
        G(135, const u64 no_passers = G(136, opp_pawns) | G(136, attacked_by_pawns);))
        ...
        for (i32 p = Pawn; p <= King; p++) {
          ...
          while (copy) {
            ...
            G(141, copy &= copy - 1;)
              ...
              G(101, // PASSED PAWNS
                if (G(155, p == Pawn) &&
                  ...
                  G(157, score += eval_params.passed_pawns[rank - 1];)
                    ...
                    G(157, if (G(158, north(1ULL << sq)) & G(158, pos->colour[1])) {
              ...
              G(101, if (p > Pawn) {
              G(147, // PIECES ATTACKED BY PAWNS
              ...
              G(151, // MOBILITY
                score +=
                G(152, count(G(150, ~pos->colour[0]) & G(150, mobility))) *
                G(152, eval_params.mobilities[p - 2]);)
  ...
  const i32 stronger_side_pawns_missing =
    8 - count(G(159, pos->colour[score < 0]) & G(159, pos->pieces[Pawn]));
  return (G(160, (i16)score) * G(160, phase) +
    G(161, (128 - stronger_side_pawns_missing * stronger_side_pawns_missing)) *
    G(161, ((score + 0x8000) >> 16)) / 128 * (24 - phase)) /
    24;
}
...
#error "Unsupported architecture: get_hash only for x86_64 and aarch64"
  ...
  S(1)
  i32 search(H(165, 1, SearchStack* restrict stack), H(165, 1, const bool do_null),
    H(165, 1, const i32 beta), H(165, 1, i32 depth),
    H(165, 1, i32 alpha),
#ifdef FULL
    u64* nodes,
#endif
    ...
    if (G(186, depth > 2) && G(186, static_eval >= beta) && G(186, do_null)) {
      ...
      G(187, npos.ep = 0;)
        ...
        const i32 score = -search(
          H(165, 2, stack), H(165, 2, false),
          H(165, 2, -alpha), H(165, 2, depth - G(188, 4) - G(188, depth / 4)),
          H(165, 2, -beta),
#ifdef FULL
          nodes,
#endif
  ...
  G(189, i32 moves_evaluated = 0;)
    ...
    G(189, stack[ply].num_moves = movegen(H(103, 3, pos), H(103, 3, stack[ply].moves),
      H(103, 3, in_qsearch));)
    G(189, u8 tt_flag = Upper;)
    G(189, i32 best_score = in_qsearch ? static_eval : -inf;)
    G(189, stack[G(190, pos_history_count) + G(190, ply) + G(190, 2)].position_hash =
      tt_hash;)
    ...
    for (i32 move_index = 0; move_index < stack[ply].num_moves; move_index++) {
      ...
      if (G(198, depth < 8) &&
        G(198, G(199, static_eval) + G(199, G(200, 142) * G(200, depth)) +
      ...
      // LATE MOVE REDUCTION
      i32 reduction;
      if (G(201, depth > 3) && G(201, move_score <= 0)) {
        reduction = G(202, moves_evaluated / 10) + G(202, (move_score < -256)) +
      ...
      i32 score;
      while (true) {
        score = -search(H(165, 3, stack), H(165, 3, true),
          H(165, 3, -alpha),
          H(165, 3, depth - G(204, 1) - G(204, reduction)), H(165, 3, low),
#ifdef FULL
          nodes,
#endif
        ...
        if (score > alpha) {
          G(205, tt_flag = Exact;)
            ...
            if (score >= beta) {
              ...
              G(206, tt_flag = Lower;)
                G(206, if (stack[ply].best_move.takes_piece == None) {
                ...
                *this_hist +=
                  ...
                  G(207, for (i32 prev_index = 0; prev_index < move_index;
                    prev_index++) {
...
S(1) void init() {
  G(83, // CLEAR HISTORY
    ...
    G(83, // MERGE NON-MATERIAL VALUES
      for (i32 i = 0;
    ...
    ((i32*)&eval_params)[G(216, offset / sizeof(*initial_params.mg.material)) +
      G(216, i)] =
      combine_eval_param(
        H(129, 3, ((i8*)&initial_params.mg)[G(217, offset) + G(217, i)]),
        H(129, 3, ((i8*)&initial_params.eg)[G(218, offset) + G(218, i)]));
  })
}
      ...
      G(221, i32 window = 15;)
        ...
        while (true) {
          G(222, const i32 beta = G(223, score) + G(223, window);)
            ...
            score =
            search(H(165, 4, stack), H(165, 4, false), H(165, 4, beta),
              H(165, 4, depth), H(165, 4, alpha),
#ifdef FULL
              nodes,
#endif
          ...
          G(224, window *= 2;)
            G(224, if (G(225, elapsed > max_time) ||
              G(225, (G(226, score < beta) && G(226, score > alpha)))) {
            break;
          })
        }
      ...
      G(231, pos_history_count = 0;)
        ...
        while (true) {
          ...
          for (i32 i = 0; i < num_moves; i++) {
            ...
            if (move_string_equal(G(232, move_name), G(232, line))) {
