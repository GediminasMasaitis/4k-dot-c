    ...
    H(119, 1, i8 mobilities[5];) H(119, 1, i8 pst_file[48];)
        H(119, 1, i8 passed_blocked_pawns[6];) H(119, 1, i8 open_files[12];)
            H(119, 1, i8 tempo;) H(119, 1, i8 pawn_attacked_penalty[2];)
                H(119, 1, i8 king_virtual_mobility;))
} EvalParams;
    ...
    H(119, 2, i32 mobilities[5];) H(119, 2, i32 pst_file[48];)
        H(119, 2, i32 passed_blocked_pawns[6];) H(119, 2, i32 open_files[12];)
            H(119, 2, i32 tempo;) H(119, 2, i32 pawn_attacked_penalty[2];)
                H(119, 2, i32 king_virtual_mobility;))
} EvalParamsMerged;
...
G(121, // EVAL PARAMETERS
  __attribute__((aligned(8))) S(1)
      const EvalParamsInitial initial_params = {
          .phases = {0, 0, 1, 1, 2, 4},
          .mg = {.material = {0, 67, 292, 332, 385, 843},
                 .pst_rank =
                     {
                         0,   -14, -17, -4,  8,  28, 95,  0,   // Pawn
                         -20, -7,  6,   21,  30, 40, 19,  -89, // Knight
                         -10, 8,   14,  17,  18, 18, -3,  -62, // Bishop
                         1,   -5,  -10, -13, 3,  13, 2,   11,  // Rook
                         14,  16,  8,   0,   -4, -3, -20, -11, // Queen
                         -13, -12, -13, -13, 18, 63, 62,  89,  // King
                     },
                 .pst_file =
                     {
                         -10, -11, -6, 3,   8,   12, 11, -6,  // Pawn
                         -29, -11, -1, 12,  14,  13, 7,  -4,  // Knight
                         -14, 0,   3,  0,   3,   -1, 11, -3,  // Bishop
                         -10, -6,  -2, 7,   9,   7,  6,  -10, // Rook
                         -14, -7,  -4, 0,   2,   4,  13, 7,   // Queen
                         -8,  12,  -9, -23, -25, -7, 11, 7,   // King
                     },
                 .mobilities = {7, 5, 2, 2, 5},
                 .king_attacks = {0, 14, 20, 15, 0},
                 .pawn_threat = {-18, -8, -8, -7, 0},
                 .open_files = {8, -10, -11, 17, -2, -18, 8, -12, -15, 34, -13,
                                -49},
                 .passed_pawns = {-7, -11, -10, 10, 34, 95},
                 .passed_blocked_pawns = {0, 0, 5, 13, 16, -39},
                 .protected_pawn = 16,
                 .phalanx_pawn = 9,
                 .bishop_pair = 27,
                 .bishop_pawns = {-6, -5},
                 ...
                 .tempo = 28,
                 .king_virtual_mobility = 4},
          .eg = {.material = {0, 87, 391, 431, 721, 1341},
                 .pst_rank =
                     {
                         0,   -5,  -9,  -7, 1,  21, 104, 0,   // Pawn
                         -34, -21, -7,  17, 23, 9,  3,   10,  // Knight
                         -16, -14, -1,  4,  8,  5,  4,   10,  // Bishop
                         -18, -19, -12, 5,  12, 11, 19,  4,   // Rook
                         -64, -43, -13, 14, 30, 27, 33,  17,  // Queen
                         -40, -4,  6,   20, 30, 27, 12,  -57, // King
                     },
                 .pst_file =
                     {
                         12,  11, -1, -11, -6, -2, 0,  -3,  // Pawn
                         -19, -4, 8,  16,  16, 4,  -1, -20, // Knight
                         -11, 0,  5,  9,   10, 4,  -4, -15, // Bishop
                         1,   6,  6,  -3,  -5, 0,  0,  -5,  // Rook
                         -22, -6, 4,  7,   14, 14, -1, -10, // Queen
                         -33, 3,  19, 27,  28, 17, 2,  -41, // King
                     },
                 .mobilities = {4, 3, 4, 2, -5},
                 .king_attacks = {0, -3, -8, 7, 0},
                 .pawn_threat = {-2, -5, -18, -15, -8},
                 .open_files = {21, 1, 13, 5, 23, 15, 23, -8, 2, 12, 43, 11},
                 .passed_pawns = {9, 15, 40, 67, 116, 104},
                 .passed_blocked_pawns = {-9, -8, -32, -62, -112, -118},
                 .protected_pawn = 16,
                 .phalanx_pawn = 15,
                 .bishop_pair = 62,
                 .bishop_pawns = {-11, -1},
...
S(0) i32 eval(Position *const restrict pos) {
  ...
  for (i32 c = 0; c < 2; c++) {
    ...
    G(125, // KING VIRTUAL MOBILITY
      score +=
      eval_params.king_virtual_mobility *
      count(get_mobility(pos, Queen, lsb(pos->colour[1] & pos->pieces[King])) &
            ~pos->colour[1]);)
