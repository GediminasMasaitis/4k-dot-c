...
G(66, static const EvalParams eg = ((EvalParams){
          .material = {71, 309, 296, 538, 984, 0},
          .pst_rank =
              {
                  0,   -4,  -6,  -5, 0,  15, 76, 0,   // Pawn
                  -39, -19, -2,  20, 26, 11, 2,  1,   // Knight
                  -12, -10, -1,  2,  6,  3,  3,  9,   // Bishop
                  -18, -19, -12, 5,  12, 10, 15, 7,   // Rook
                  -60, -45, -20, 10, 29, 29, 40, 18,  // Queen
                  -39, -1,  9,   18, 24, 20, 8,  -47, // King
              },
          .pst_file =
              {
                  9,   12, -1, -9, -4, -3, 2,  -6,  // Pawn
                  -23, -4, 11, 17, 18, 8,  -2, -23, // Knight
                  -6,  -1, 0,  3,  5,  4,  1,  -5,  // Bishop
                  1,   4,  4,  -1, -4, 0,  0,  -4,  // Rook
                  -19, -4, 2,  8,  12, 10, -1, -7,  // Queen
                  -27, 1,  12, 24, 17, 20, 1,  -33, // King
              },
          .mobilities = {4, 3, 1, -4},
          .king_attacks = {-3, -5, 8, 0},
          .open_files = {28, -4, 6, 9, 26, 8},
          .passed_pawns = {25, 47, 84, 76},
          .passed_blocked_pawns = {32, 56, 94, 99},
          .bishop_pair = 53,
          .tempo = 8});)
...
G(66, static const EvalParams mg = ((EvalParams){
          .material = {65, 310, 290, 395, 880, 0},
          .pst_rank =
              {
                  0,   -10, -9,  -8,  2,  25, 91,  0,   // Pawn
                  -29, -16, 4,   15,  31, 54, 22,  -80, // Knight
                  -7,  6,   15,  13,  15, 17, -5,  -54, // Bishop
                  1,   -12, -18, -21, 1,  20, 13,  16,  // Rook
                  18,  18,  10,  -2,  -7, -3, -27, -7,  // Queen
                  -6,  -4,  -30, -34, 3,  60, 74,  79,  // King
              },
          .pst_file =
              {
                  -21, -11, -9, 0,   6,   23,  22, -10, // Pawn
                  -30, -9,  6,  16,  13,  15,  3,  -13, // Knight
                  -11, 3,   6,  2,   5,   -3,  3,  -6,  // Bishop
                  -7,  -8,  1,  10,  11,  4,   -3, -8,  // Rook
                  -10, -7,  -1, 1,   1,   1,   7,  8,   // Queen
                  -15, 24,  0,  -49, -15, -37, 20, 1,   // King
              },
          .mobilities = {6, 2, 3, -8},
          .king_attacks = {14, 19, 13, 0},
          .open_files = {24, -12, -10, 20, -3, -31},
          .passed_pawns = {-9, 12, 36, 91},
          .passed_blocked_pawns = {0, -10, -11, 24},
          .bishop_pair = 25,
          .tempo = 16});)
