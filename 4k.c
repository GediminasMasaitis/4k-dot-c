...
G(64, static const EvalParams mg = ((EvalParams){
          ...
          .attacked_by_pawns = {0, -39, -50, -44, -41, 0},
          .bishop_pair = 25,
          .tempo = 16});)
...
G(64, static const EvalParams eg = ((EvalParams){
          ...
          .attacked_by_pawns = {0, -26, -42, -19, 11, 0},
          .bishop_pair = 52,
          .tempo = 8});)
    ...
    for (i32 p = Pawn; p <= King; p++) {
      ...
      while (copy) {
        ...
        if (1ULL << sq & no_passers) {
          score += eval_params.attacked_by_pawns[p - 1];
        }
