  ...
  G(64, const u64 all = pos->colour[0] | pos->colour[1];)
    ...
    G(65, // PAWN EAST CAPTURES
      movelist = generate_pawn_moves(
        ...
        H(62, 4, ne(pos->colour[0] & pos->pieces[Pawn]) & (pos->colour[1] | pos->ep)),
        H(62, 4, -9));)
    G(65, // SHORT CASTLE
    ...
    G(65, // PAWN WEST CAPTURES
      movelist = generate_pawn_moves(
        ...
        H(62, 5, nw(pos->colour[0] & pos->pieces[Pawn]) & (pos->colour[1] | pos->ep)),
        H(62, 5, -7));)
...
typedef struct [[nodiscard]] __attribute__((packed)) {
  i16 material[7];
  H(70, 1, H(71, 1, i8 king_attacks[5];) H(71, 1, i8 passed_pawns[6];)
    H(71, 1, i8 tempo;) H(71, 1, i8 passed_blocked_pawns[6];)
    H(71, 1, i8 mobilities[5];))
    H(70, 1, H(72, 1, i8 bishop_pair;) H(72, 1, i8 open_files[6];)
...
typedef struct [[nodiscard]] __attribute__((packed)) {
  i32 material[7];
  H(70, 2, H(71, 2, i32 king_attacks[5];) H(71, 2, i32 passed_pawns[6];)
    H(71, 2, i32 tempo;) H(71, 2, i32 passed_blocked_pawns[6];)
    H(71, 2, i32 mobilities[5];))
    H(70, 2, H(72, 2, i32 bishop_pair;) H(72, 2, i32 open_files[6];)
      H(72, 2, i32 pawn_attacked_penalty[2];) H(72, 2, i32 pst_rank[64];)
      H(72, 2, i32 pst_file[64];))

} EvalParamsMerged;

G(73, __attribute__((aligned(8))) S(1) const i8 phases[] = { 0, 0, 1, 1, 2, 4, 0 };)
...
G(73, [[nodiscard]] S(1) i32 combine_eval_param(H(74, 1, const i32 mg_val),
  ...
  G(76, i32 score = eval_params.tempo;)
    ...
    for (i32 c = 0; c < 2; c++) {
      ...
      G(77, // BISHOP PAIR
        ...
        G(77, const u64 opp_pawns = G(79, pos->pieces[Pawn]) & G(79, pos->colour[1]);
      ...
      const u64 no_passers = G(81, opp_pawns) | G(81, attacked_by_pawns);)
        G(77, const u64 own_pawns = G(82, pos->pieces[Pawn]) & G(82, pos->colour[0]);)
        ...
        for (i32 p = Pawn; p <= King; p++) {
          ...
          while (copy) {
            ...
            G(84, const int file = sq & 7;)
              ...
              G(62, // PASSED PAWNS
                if (G(93, !(G(94, (0x101010101010101ULL << sq)) & G(94, no_passers))) &&
                  G(93, p == Pawn)) {
                  G(95, if (north(1ULL << sq) & pos->colour[1]) {
...
#error "Unsupported architecture: get_hash only for x86_64 and aarch64"
    ...
    if (G(109, depth > 2) && G(109, static_eval >= beta) && G(109, do_null)) {
      ...
      G(110, npos.ep = 0;)
        ...
        const i32 score = -search(
          ...
          H(99, 2, depth - 3 - depth / 4), H(99, 2, stack),
#ifdef FULL
          nodes,
#endif
  ...
  G(98, i32 quiets_evaluated = 0;)
    ...
    for (i32 move_index = 0; move_index < stack[ply].num_moves; move_index++) {
      ...
      if (G(116, depth < 8) &&
        G(116, G(117, static_eval + 136 * depth) +
          G(117, eg.material[stack[ply].moves[move_index].promo]) +
          G(117, eg.material[stack[ply].moves[move_index].takes_piece]) <
          alpha) &&
      ...
      while (true) {
        score = -search(
          ...
          H(99, 3, depth - G(120, 1) - G(120, reduction)), H(99, 3, stack),
#ifdef FULL
          nodes,
#endif
        ...
        if (score > alpha) {
          G(121, tt_flag = Exact;)
            ...
            if (score >= beta) {
              ...
              G(122, tt_flag = Lower;)
                G(122, if (stack[ply].best_move.takes_piece == None) {
                ...
                *this_hist += bonus - bonus * *this_hist / 1024;)
                  G(123, for (i32 prev_index = 0; prev_index < move_index;
                    prev_index++) {
...
#endif
      G(996, i32 window = 24;)
        G(996, size_t elapsed;)
        while (true) {
          G(997, const i32 alpha = score - window;)
            G(997, const i32 beta = score + window;)
            score =
            search(H(99, 4, pos), H(99, 4, alpha), H(99, 4, 0), H(99, 4, depth),
              H(99, 4, stack),
#ifdef FULL
              nodes,
#endif
          ...
          G(998, if (G(999, (score > alpha && score < beta)) ||
            G(999, elapsed > max_time)) {
            break;
          })
            G(998, window *= 2;)
        }
