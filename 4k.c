...
typedef struct [[nodiscard]] __attribute__((packed)) {
  ...
  H(116, 1,
    H(118, 1, i8 passed_pawns[6];) H(118, 1, i8 pst_rank[48];)
        H(118, 1, i8 king_attacks[5];) H(118, 1, i8 protected_pawn[6];)
            H(118, 1, i8 bishop_pair;) H(118, 1, i8 phalanx_pawn[6];))
} EvalParams;
...
typedef struct [[nodiscard]] __attribute__((packed)) {
  ...
  H(116, 2,
    H(118, 2, i32 passed_pawns[6];) H(118, 2, i32 pst_rank[48];)
        H(118, 2, i32 king_attacks[5];) H(118, 2, i32 protected_pawn[6];)
            H(118, 2, i32 bishop_pair;) H(118, 2, i32 phalanx_pawn[6];))
} EvalParamsMerged;
  ...
  __attribute__((aligned(8))) S(1)
      const EvalParamsInitial initial_params =
          {.phases = {0, 0, 1, 1, 2, 4},
                   ...
                   .pst_file =
                       {
                           ...
                           -9,  16,  -10, -28, -27, -11, 12, 2,   // King
                       },
                   .mobilities = {6, 5, 2, 3, -2},
                   .king_attacks = {0, 14, 20, 14, 0},
                   .pawn_threat = {-16, -8, -7, -8, -1},
                   .open_files = {8, -11, -11, 17, -2, -22, 7, -10, -11, 33,
                                  -11, -57},
                   .passed_pawns = {-9, -2, 9, 41, 75, 124},
                   .passed_blocked_pawns = {-1, -5, -3, 3, 3, -47},
                   .passed_king_distance = {-1, -2},
                   .protected_pawn = {0, 10, 6, 10, 16, 127},
                   .phalanx_pawn = {3, 6, 10, 19, 48, 127},
                   .bishop_pair = 27,
                   .bishop_pawns = {-5, -5},
                   .king_shield = {29, 18},
           ...
           .eg =
               {
                   .material = {0, 86, 406, 444, 739, 1374},
                   .pst_rank =
                       {
                   ...
                   .passed_pawns = {13, 3, 20, 47, 100, 94},
                   .passed_blocked_pawns = {-11, -3, -12, -29, -66, -70},
                   .passed_king_distance = {-5, 9},
                   .protected_pawn = {0, 8, 8, 9, 23, -5},
                   .phalanx_pawn = {3, 7, 13, 41, 93, 127},
                   .bishop_pair = 58,
                   .bishop_pawns = {-11, -1},
                   .king_shield = {-10, -7},
      ...
      while (copy) {
        ...
        G(93, G(
                  ...
                  if (G(300, p == Pawn) &&
                    ...
                    score += G(997, eval_params.protected_pawn[rank - 1]) *
                             G(997, 2);
                  })
                  ...
                  G(
                      ...
                      if (G(309, p == Pawn) &&
                        ...
                        score += G(996, eval_params.phalanx_pawn[rank - 1]) *
                                 G(996, 2);
                      }))
