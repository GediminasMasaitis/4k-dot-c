...
typedef struct [[nodiscard]] __attribute__((packed)) {
  i16 material[6];
  H(116, 1,
    H(117, 1, i8 king_shield[2];) H(117, 1, i8 piece_threats[5];) H(117, 1, i8 pawn_threat[5];) H(117, 1, i8 passed_king_distance[2];)
...
typedef struct [[nodiscard]] __attribute__((packed)) {
  i32 material[6];
  H(116, 2,
    H(117, 2, i32 king_shield[2];) H(117, 2, i32 piece_threats[5];) H(117, 2, i32 pawn_threat[5];) H(117, 2, i32 passed_king_distance[2];)
...
G(
    121, // EVAL PARAMETERS
    __attribute__((aligned(8))) S(1) EvalParamsInitial initial_params = {.phases = {0, 0, 1, 1, 2, 4},
                                                                         .mg =
                                                                             {
