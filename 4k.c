...
[[nodiscard]] S(1) i32 min(i32 a, i32 b) {
  return (a < b) ? a : b;
}
...
G(22, S(1) void swapu32(G(23, u32* const lhs), G(23, u32* const rhs)) {
  const u32 temp = *lhs;
  *lhs = *rhs;
  *rhs = temp;
}
...
G(22, S(1) void swapu64(G(27, u64* const lhs), G(27, u64* const rhs)) {
  const u64 temp = *lhs;
  *lhs = *rhs;
  *rhs = temp;
})
...
G(32, [[nodiscard]] S(1)
  ...
  G(39, if (piece == King) { moves = king(bb); })
    ...
    const u64 blockers = pos->colour[0] | pos->colour[1];
    G(40, if (G(41, piece == Queen) || G(41, piece == Bishop)) {
      moves |= bishop(H(18, 3, blockers), H(18, 3, bb));
    })
      G(40, if (G(42, piece == Queen) || G(42, piece == Rook)) {
...
G(43, S(0) i32 makemove(H(44, 1, Position* const restrict pos),
...
G(43, S(1) Move* generate_piece_moves(H(56, 1, const u64 to_mask),
...
G(43, S(0) Move* generate_pawn_moves(H(60, 1, const Position* const pos),
  ...
  G(62, const u64 all = pos->colour[0] | pos->colour[1];)
    ...
    if (!only_captures) {
      movelist = generate_pawn_moves(
        ...
        H(60, 2, north(north(pos->colour[0] & pos->pieces[Pawn] & 0xFF00) & ~all) &
          ~all),
        H(60, 2, -16));
    }
  movelist = generate_pawn_moves(
    H(60, 3, pos), H(60, 3, movelist),
    H(60, 3, north(pos->colour[0] & pos->pieces[Pawn]) & ~all &
      (only_captures ? 0xFF00000000000000ull : ~0ull)),
    H(60, 3, -8));
  movelist = generate_pawn_moves(
    H(60, 4, pos), H(60, 4, movelist),
    H(60, 4, nw(pos->colour[0] & pos->pieces[Pawn]) & (pos->colour[1] | pos->ep)),
    H(60, 4, -7));
  movelist = generate_pawn_moves(
    H(60, 5, pos), H(60, 5, movelist),
    H(60, 5, ne(pos->colour[0] & pos->pieces[Pawn]) & (pos->colour[1] | pos->ep)),
    H(60, 5, -9));
...
typedef struct [[nodiscard]] __attribute__((packed)) {
  i16 material[6];
  H(67, 1, H(68, 1, i8 king_attacks[5];) H(68, 1, i8 passed_blocked_pawns[6];)
    H(68, 1, i8 mobilities[5];) H(68, 1, i8 tempo;)
    H(68, 1, i8 passed_pawns[6];))
    H(67, 1, H(69, 1, i8 bishop_pair;) H(69, 1, u8 pawn_attacked_penalty[2];)
      H(69, 1, i8 open_files[6];) H(69, 1, i8 pst_file[64];)
      H(69, 1, i8 pst_rank[64];))
} EvalParams;

typedef struct [[nodiscard]] __attribute__((packed)) {
  i32 material[6];
  H(67, 2, H(68, 2, i32 king_attacks[5];) H(68, 2, i32 passed_blocked_pawns[6];)
    H(68, 2, i32 mobilities[5];) H(68, 2, i32 tempo;)
    H(68, 2, i32 passed_pawns[6];))
    H(67, 2, H(69, 2, i32 bishop_pair;) H(69, 2, i32 pawn_attacked_penalty[2];)
      H(69, 2, i32 open_files[6];) H(69, 2, i32 pst_file[64];)
...
G(70, [[nodiscard]] S(1) i32 combine_eval_param(H(71, 1, const i32 mg_val),
...
S(1) void init() {
  ...
  G(44, for (i32 sq = 0; sq < 64; sq++) {
    ...
    G(44, // MERGE NON-MATERIAL VALUES
...
G(74, __attribute__((aligned(8))) S(1)
  ...
  G(74, __attribute__((aligned(8))) S(1) const i8 phases[] = { 0, 0, 1, 1, 2, 4, 0 };)
  ...
  G(75, i32 score = eval_params.tempo;)
    ...
    for (i32 c = 0; c < 2; c++) {
      ...
      G(76, const u64 opp_king_zone = king(pos->colour[1] & pos->pieces[King]);)
        ...
        G(76, const u64 own_pawns = G(77, pos->pieces[Pawn]) & G(77, pos->colour[0]);)
        G(76, // BISHOP PAIR
          if (count(G(78, pos->pieces[Bishop]) & G(78, pos->colour[0])) > 1) {
            score += eval_params.bishop_pair;
          })
        G(76, const u64 opp_pawns = G(79, pos->colour[1]) & G(79, pos->pieces[Pawn]);
        ...
        for (i32 p = Pawn; p <= King; p++) {
          ...
          while (copy) {
            ...
            G(83, const int file = sq & 7;)
              ...
              G(60, // PASSED PAWNS
                if (G(91, !(G(92, (0x101010101010101ULL << sq)) & G(92, no_passers))) &&
                  G(91, p == Pawn)) {
                  G(93, if (north(1ULL << sq) & pos->colour[1]) {
...
#error "Unsupported architecture: get_hash only for x86_64 and aarch64"
  ...
  i16 search(H(96, 1, Position* const restrict pos), H(96, 1, const i32 ply),
    H(96, 1, i32 depth), H(96, 1, i32 alpha),
    ...
    if (G(107, depth > 2) && G(107, static_eval >= beta) && G(107, do_null)) {
      ...
      G(108, npos.ep = 0;)
        ...
        const i32 score = -search(
          H(96, 2, &npos), H(96, 2, ply + 1), H(96, 2, depth - G(109, 3) - G(109, depth / 4) - G(109, min((static_eval - beta) / 128, 3))),
          H(96, 2, -beta), H(97, 2, false),
#ifdef FULL
          nodes,
#endif
          H(97, 2, pos_history_count), H(97, 2, -alpha), H(97, 2, stack));
      if (score >= beta) {
        return score;
      }
    }
  ...
  G(96, i32 moves_evaluated = 0;)
    ...
    for (i32 move_index = 0; move_index < stack[ply].num_moves; move_index++) {
      ...
      while (true) {
        score = -search(
          H(96, 3, &npos), H(96, 3, ply + 1), H(96, 3, depth - G(119, 1) - G(119, reduction)),
          H(96, 3, low), H(97, 3, true),
#ifdef FULL
          nodes,
#endif
          H(97, 3, pos_history_count), H(97, 3, -alpha), H(97, 3, stack));
          ...
          G(120, tt_flag = Exact;)
            ...
            if (score >= beta) {
              ...
              G(121, tt_flag = Lower;)
                ...
                G(121, const i32 bonus = depth * depth;
...
#endif
    i32 score =
      search(H(96, 4, pos), H(96, 4, 0), H(96, 4, depth), H(96, 4, -inf),
        H(97, 4, false),
#ifdef FULL
        nodes,
#endif
        H(97, 4, pos_history_count), H(97, 4, inf), H(97, 4, stack));
