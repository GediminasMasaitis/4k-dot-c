...
S(1)
void get_piece_hashes(H(300, 1, const Position *const pos), H(300, 1, u64 hashes[5])) {
  for (A(7, i8, u8, i16, u16, i32, u32, i64, u64) p = Pawn; p <= King; p++) {
...
search(
  ...
  G(197, corr_hashes[6] = G(271, (G(272, ss->prev_move.from) | G(272, ss->prev_move.to << 8))) + G(271, 16384);)
  G(197, corr_hashes[5] = G(270, ss[1].prev_move.from) | G(270, ss[1].prev_move.to << 8);)
  for (A(6, i8, u8, i16, u16, i32, u32, i64, u64) i = 0; i < 7; i++) {
