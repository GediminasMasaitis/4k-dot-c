...
typedef struct [[nodiscard]] __attribute__((packed)) {
  i16 material[6];
  H(69, 1, H(70, 1, i8 mobilities[5];) H(70, 1, i8 passed_blocked_pawns[6];)
...
typedef struct [[nodiscard]] __attribute__((packed)) {
  i32 material[6];
  H(69, 2, H(70, 2, i32 mobilities[5];) H(70, 2, i32 passed_blocked_pawns[6];)
...
G(72, S(1) const EvalParams mg = ((EvalParams) {
  .material = { 67, 266, 270, 357, 768, 0 },
    .pst_rank = { 0, -10, -9, -8, 3, 24, 90, 0, // Pawn
    ...
    .pst_file = { -19, -10, -10, 0, 6, 21, 21, -9, // Pawn
...
G(72, S(1) const EvalParams eg = ((EvalParams) {
  .material = { 86, 398, 392, 706, 1340, 0 },
    .pst_rank = { 0, -5, -7, -6, 0, 18, 96, 0, // Pawn
    ...
    .pst_file = { 10, 14, -1, -11, -5, -3, 3, -7, // Pawn
  ...
  G(77, i32 score = eval_params.tempo;)
    ...
    for (i32 c = 0; c < 2; c++) {
      ...
      G(78, // BISHOP PAIR
        ...
        G(78, const u64 opp_pawns = G(80, pos->pieces[Pawn]) & G(80, pos->colour[1]);
      ...
      const u64 no_passers = G(82, opp_pawns) | G(82, attacked_by_pawns);)
        ...
        G(78, const u64 own_pawns = G(83, pos->pieces[Pawn]) & G(83, pos->colour[0]);)
