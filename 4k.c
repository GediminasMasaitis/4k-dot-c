...
G(
    46,
    S(1) void swapu32(G(47, u32a *const rhs), G(47, u32a *const lhs)) {
      const u32 temp = *lhs;
      *lhs = *rhs;
      *rhs = temp;
    }

    S(1) void swapmoves(G(48, Move *const rhs), G(48, Move *const lhs)) { swapu32(G(49, (u32a *)rhs), G(49, (u32a *)lhs)); })
...
G(
    46, [[nodiscard]] S(0) A(4, i8, u8, i16, u16, i32, u32, i64, u64)
...
G(
    57, [[nodiscard]] S(1) A(5, bool, i8, u8, i16, u16, i32, u32, i64, u64) is_attacked(H(58, 1, const Position *const restrict pos), H(58, 1, const u64 bb)) {
      assert(count(bb) == 1);
...
typedef struct [[nodiscard]] __attribute__((packed)) {
  i16 material[6];
  H(116, 1,
    H(117, 1, i8 king_shield[2];) H(117, 1, i8 piece_threats[2];) H(117, 1, i8 check_threats[5];) H(117, 1, i8 pawn_threat[5];)
        H(117, 1, i8 passed_king_distance[2];) H(117, 1, i8 bishop_pawns[2];))
  H(116, 1,
    H(119, 1, i8 open_files[12];) H(119, 1, i8 mobilities[5];) H(119, 1, i8 passed_blocked_pawns[6];) H(119, 1, i8 pst_file[48];)
...
typedef struct [[nodiscard]] __attribute__((packed)) {
  i32 material[6];
  H(116, 2,
    H(117, 2, i32 king_shield[2];) H(117, 2, i32 piece_threats[2];) H(117, 2, i32 check_threats[5];) H(117, 2, i32 pawn_threat[5];)
        H(117, 2, i32 passed_king_distance[2];) H(117, 2, i32 bishop_pawns[2];))
  H(116, 2,
    H(119, 2, i32 open_files[12];) H(119, 2, i32 mobilities[5];) H(119, 2, i32 passed_blocked_pawns[6];) H(119, 2, i32 pst_file[48];)
...
G(
    ...
    __attribute__((aligned(8))) S(1) C(1) EvalParamsInitial initial_params = {.phases = {0, 0, 1, 1, 2, 4},
                                                                              .mg =
                                                                                  {
                                                                                      .material = {0, 67, 292, 336, 385, 849},
                                                                                      .pst_rank =
                                                                                          {
                                                                                              0,   -15, -19, -4,  7,  30, 126, 0,   // Pawn
                                                                                              -19, -3,  10,  24,  27, 33, 14,  -86, // Knight
                                                                                              -9,  9,   13,  17,  16, 18, -5,  -58, // Bishop
                                                                                              6,   -3,  -8,  -11, 3,  13, 0,   2,   // Rook
                                                                                              16,  17,  9,   1,   -4, -5, -23, -11, // Queen
                                                                                              -7,  -1,  -8,  -19, -2, 36, 37,  47,  // King
                                                                                          },
                                                                                      .pst_file =
                                                                                          {
                                                                                              -6,  -11, -7, 1,   6,   10, 11, -5,  // Pawn
                                                                                              -28, -9,  -1, 10,  13,  13, 7,  -6,  // Knight
                                                                                              -14, 0,   2,  1,   4,   0,  11, -3,  // Bishop
                                                                                              -11, -6,  -1, 7,   11,  8,  4,  -12, // Rook
                                                                                              -14, -8,  -4, 0,   3,   4,  14, 6,   // Queen
                                                                                              -8,  14,  -9, -25, -27, -8, 9,  1,   // King
                                                                                          },
                                                                                      .mobilities = {6, 5, 2, 2, 0},
                                                                                      .king_attacks = {0, 10, 12, -3, 0},
                                                                                      .pawn_threat = {-16, -9, -8, -8, 0},
                                                                                      .open_files = {9, -12, -12, 17, -3, -18, 7, -10, -12, 32, -12, -45},
                                                                                      .passed_pawns = {-10, -4, 7, 39, 74, 126},
                                                                                      .passed_blocked_pawns = {-1, -5, -4, 3, 2, -51},
                                                                                      .passed_king_distance = {-1, -2},
                                                                                      .protected_pawn = {0, 21, 12, 20, 33, 127},
                                                                                      .phalanx_pawn = {7, 12, 21, 39, 127, 127},
                                                                                      .bishop_pair = 27,
                                                                                      .bishop_pawns = {-6, -5},
                                                                                      .king_shield = {28, 17},
                                                                                      .pawn_attacked_penalty = {-57, -115},
                                                                                      .piece_threats = {24, 17},
                                                                                      .check_threats = {20, 11, 23, 19, 29},
                                                                                      .tempo = 30,
                                                                                  },
                                                                              .eg = {
                                                                                  .material = {0, 85, 404, 437, 735, 1369},
                                                                                  .pst_rank =
                                                                                      {
                                                                                          0,   0,   -7,  -6, -1, 15, 93, 0,   // Pawn
                                                                                          -28, -16, -5,  16, 21, 6,  1,  6,   // Knight
                                                                                          -11, -10, 0,   3,  6,  1,  3,  8,   // Bishop
                                                                                          -15, -17, -10, 4,  10, 9,  15, 4,   // Rook
                                                                                          -55, -36, -8,  14, 24, 22, 27, 14,  // Queen
                                                                                          -33, -5,  3,   17, 30, 30, 19, -38, // King
                                                                                      },
                                                                                  .pst_file =
                                                                                      {
                                                                                          2,   7,  -1, -7, -1, 1,  1,  -3,  // Pawn
                                                                                          -17, -4, 8,  18, 16, 3,  -4, -20, // Knight
                                                                                          -8,  0,  5,  10, 10, 3,  -5, -14, // Bishop
                                                                                          3,   6,  5,  -3, -6, -2, 0,  -3,  // Rook
                                                                                          -16, -4, 6,  9,  11, 9,  -6, -10, // Queen
                                                                                          -29, -1, 11, 17, 20, 13, 3,  -30, // King
                                                                                      },
                                                                                  .mobilities = {4, 3, 3, 0, -3},
                                                                                  .king_attacks = {0, -1, -7, -4, 0},
                                                                                  .pawn_threat = {-2, -6, -16, -8, -6},
                                                                                  .open_files = {8, 3, 17, 9, 24, 8, 23, -8, 2, 10, 34, 5},
                                                                                  .passed_pawns = {14, 3, 20, 46, 100, 93},
                                                                                  .passed_blocked_pawns = {-11, -2, -12, -29, -67, -70},
                                                                                  .passed_king_distance = {-5, 9},
                                                                                  .protected_pawn = {0, 16, 15, 19, 46, 23},
                                                                                  .phalanx_pawn = {6, 15, 26, 82, 127, 127},
                                                                                  .bishop_pair = 53,
                                                                                  .bishop_pawns = {-11, 0},
                                                                                  .king_shield = {-11, -7},
                                                                                  .pawn_attacked_penalty = {-25, -128},
                                                                                  .piece_threats = {35, 23},
                                                                                  .check_threats = {6, 11, 5, 12, 0},
                                                                                  .tempo = 17,
                                                                              }};)
...
S(0) A(1, i16, i32, i64) eval(Position *const restrict pos) {
  ...
  for (A(4, i8, u8, i16, u16, i32, u32, i64, u64) c = 0; c < 2; c++) {
    ...
    const i32 opp_king_sq = lsb(pos->colour[1] & pos->pieces[King]);
        ...
        G(
            93, if (p > Pawn) {
              ...
              G(155, const u64 mobility = get_mobility(H(69, 3, pos), H(69, 3, p), H(69, 3, sq));
                ...
                // CHECK THREATS
                score +=
                count(mobility & ~attacked_by_pawns & get_mobility(H(69, 4, pos), H(69, 4, p), H(69, 4, opp_king_sq))) * eval_params.check_threats[p - 2];)
            })
  ...
  const A(2, i8, u8, i16, u16, i32, i64) stronger_side_pawns_missing = 8 - count(G(175, pos->colour[score < 0]) & G(175, pos->pieces[Pawn]));
...
[[nodiscard]] __attribute__((target("aes"))) S(1) u64 get_hash(const Position *const pos) {
  ...
  for (A(1, i8, u8, i16, u16, i32, u32, i64, u64) i = 0; i < 6; i++) {
    i128 key;
...
search(
    ...
    u64 *nodes,
#endif
    H(186, 1, H(187, 1, ThreadData *data), H(187, 1, const A(0, i32, i64) beta), H(187, 1, Position *const pos), H(187, 1, A(1, i16, i32, i64) depth)),
  ...
  if (G(203, !in_check) && G(203, G(204, alpha) == G(204, beta - 1))) {
    ...
    if (G(210, depth > 2) && G(210, do_null) && G(210, static_eval >= beta)) {
      ...
      const A(2, i16, i32, i64) score = -search(
          ...
          nodes,
#endif
          H(186, 2, H(187, 2, data), H(187, 2, -alpha), H(187, 2, &npos), H(187, 2, depth - G(212, depth / 4) - G(212, 4))),
  ...
  for (A(3, u8, i16, u16, i32, u32, i64, u64) move_index = 0; move_index < ss->num_moves; move_index++) {
    ...
    G(
        ...
        if (G(225, depth < 5) &&
            G(225, G(226, G(227, 176) * G(227, depth)) + G(226, static_eval) + G(226, initial_params.eg.material[moves[move_index].promo]) +
    ...
    while (true) {
      score = -search(
          ...
          nodes,
#endif
          H(186, 3, H(187, 3, data), H(187, 3, -alpha), H(187, 3, &npos), H(187, 3, depth - G(231, reduction) - G(231, 1))),
  ...
  for (A(4, i8, u8, i16, u16, i32, u32, i64, u64) depth = 1; depth < max_ply; depth++) {
    ...
    while (true) {
      ...
      score = search(
          ...
          &data->nodes,
#endif
          H(186, 4, H(187, 4, data), H(187, 4, beta), H(187, 4, &data->pos), H(187, 4, depth)), H(186, 4, H(188, 4, 0), H(188, 4, alpha), H(188, 4, false)));
#ifdef FULL
      if (data->thread_id == 0) {
      ...
      G(257, window *= 2;)
      G(257, if (G(258, elapsed > data->max_time) || G(258, (G(259, score > alpha) && G(259, score < beta)))) { break; })
    }
