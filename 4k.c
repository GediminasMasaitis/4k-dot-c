...
typedef struct [[nodiscard]] __attribute__((packed)) {
  i16 material[6];
  H(116, 1,
    H(118, 1, i8 phalanx_pawn[6];) H(118, 1, i8 passed_pawns[6];)
...
typedef struct [[nodiscard]] __attribute__((packed)) {
  i32 material[6];
  H(116, 2,
    H(118, 2, i32 phalanx_pawn[6];) H(118, 2, i32 passed_pawns[6];)
  ...
  __attribute__((aligned(8))) S(1)
      const EvalParamsInitial initial_params =
          {.phases = {0, 0, 1, 1, 2, 4},
           .mg =
               {
                   ...
                   .open_files = {10, -10, -11, 16, -2, -22, 9, -11, -13, 33,
                                  -13, -57},
           ...
           .eg =
               {
                   .material = {0, 88, 401, 443, 738, 1368},
                   .pst_rank =
                       {
  ...
  for (i32 c = 0; c < 2; c++) {
    ...
    G(
        ...
        G(130, // PROTECTED PAWNS
          score -= G(134, eval_params.protected_pawn) *
    ...
    for (i32 p = Pawn; p <= King; p++) {
      ...
      while (copy) {
        ...
        G(
            93, // PHALANX PAWNS
            if (G(132, p == Pawn) &&
                G(132, G(133, piece_bb) & G(133, west(pawns[0])))) {
