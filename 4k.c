...
G(30, [[nodiscard]] S(0) u64 bishop(H(31, 1, const u64 blockers),
  H(31, 1, const u64 bb)) {
  assert(count(bb) == 1);
  const i32 sq = lsb(bb);
...
G(50, S(1) void swapbool(G(57, bool* const restrict rhs),
...
typedef struct [[nodiscard]] __attribute__((packed)) {
  i16 material[7];
  H(124, 1, H(125, 1, i8 passed_blocked_pawns[6];) H(125, 1, i8 open_files[6];)
    H(125, 1, i8 tempo;) H(125, 1, i8 mobilities[5];)
    H(125, 1, u8 pawn_attacked_penalty[2];))
    H(124, 1, H(126, 1, i8 king_attacks[5];) H(126, 1, i8 pst_file[48];)
...
typedef struct [[nodiscard]] __attribute__((packed)) {
  i32 material[7];
  H(124, 2, H(125, 2, i32 passed_blocked_pawns[6];) H(125, 2, i32 open_files[6];)
    H(125, 2, i32 tempo;) H(125, 2, i32 mobilities[5];)
    H(125, 2, i32 pawn_attacked_penalty[2];))
    H(124, 2, H(126, 2, i32 king_attacks[5];) H(126, 2, i32 pst_file[48];)
...
S(1) i32 eval(Position* const restrict pos) {
  G(131, i32 score = eval_params.tempo;)
    ...
    for (i32 c = 0; c < 2; c++) {
      ...
      G(132, const u64 opp_pawns = G(134, pos->pieces[Pawn]) & G(134, pos->colour[1]);
        ...
        for (i32 p = Pawn; p <= King; p++) {
          ...
          while (copy) {
            ...
            G(140, const int file = G(141, sq) & G(141, 7);)
              ...
              G(101, // PASSED PAWNS
                if (G(154, p == Pawn) &&
                  G(154, !(G(155, (0x101010101010101ULL << sq)) &
                    G(155, no_passers)))) {
                  G(156, score += eval_params.passed_pawns[rank - 1];)

                    G(156, if (G(157, north(1ULL << sq)) & G(157, pos->colour[1])) {
              ...
              G(101, if (p > Pawn) {
              G(146, // PIECES ATTACKED BY PAWNS
...
#error "Unsupported architecture: get_hash only for x86_64 and aarch64"
  ...
  S(1)
  i32 search(H(165, 1, i32 depth), H(165, 1, i32 alpha),
    H(165, 1, const bool do_null), H(165, 1, const i32 beta),
    ...
    if (G(186, depth > 2) && G(186, static_eval >= beta) && G(186, do_null)) {
      ...
      G(187, npos.ep = 0;)
        ...
        const i32 score = -search(
          H(165, 2, depth - G(188, 4) - G(188, depth / 4)), H(165, 2, -beta),
          H(165, 2, false), H(165, 2, -alpha),
          H(165, 2, stack),
#ifdef FULL
          nodes,
#endif
  ...
  G(189, i32 quiets_evaluated = 0;)
    ...
    for (i32 move_index = 0; move_index < stack[ply].num_moves; move_index++) {
      ...
      i32 score;
      while (true) {
        score = -search(H(165, 3, depth - G(204, 1) - G(204, reduction)), H(165, 3, low),
          H(165, 3, true),
          H(165, 3, -alpha), H(165, 3, stack),
#ifdef FULL
          nodes,
#endif
      ...
      G(221, i32 window = 15;)
        ...
        while (true) {
          G(222, const i32 alpha = score - window;)
            ...
            score =
            search(H(165, 4, depth), H(165, 4, alpha), H(165, 4, false),
              H(165, 4, beta), H(165, 4, stack),
#ifdef FULL
              nodes,
#endif
          ...
          G(224, if (G(225, (G(226, score > alpha) && G(226, score < beta))) ||
            G(225, elapsed > max_time)) {
            break;
          })
            G(224, window *= 2;)
        }
