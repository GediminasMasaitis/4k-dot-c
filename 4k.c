  ...
  __attribute__((aligned(8))) S(1)
      const EvalParamsInitial initial_params =
          {.phases = {0, 0, 1, 1, 2, 4},
           .mg =
               {
                   .material = {0, 62, 252, 281, 308, 563},
                   .pst_rank =
                       {
                           0,   -15, -17, -5,  7,  31, 127, 0,   // Pawn
                           -20, -8,  5,   19,  29, 39, 18,  -82, // Knight
                           -9,  8,   15,  18,  19, 20, -3,  -67, // Bishop
                           7,   -4,  -8,  -12, 4,  13, 2,   -1,  // Rook
                           12,  14,  7,   1,   0,  1,  -14, -22, // Queen
                           -4,  2,   -10, -27, -6, 40, 52,  53,  // King
                       },
                   .pst_file =
                       {
                           -5,  -10, -7,  0,   7,   11,  11, -7,  // Pawn
                           -29, -11, -1,  11,  13,  13,  7,  -4,  // Knight
                           -14, 0,   3,   0,   4,   -1,  11, -3,  // Bishop
                           -12, -8,  -3,  6,   12,  8,   7,  -10, // Rook
                           -15, -7,  -3,  1,   4,   6,   12, 3,   // Queen
                           -11, 13,  -11, -27, -27, -11, 11, 2,   // King
                       },
                   .mobilities = {6, 5, 2, 2, -2},
                   .king_attacks = {0, 12, 18, 13, 0},
                   .pawn_threat = {-16, -8, -7, -10, 0},
                   .open_files = {8, -11, -12, 16, -4, -21, 5, -12, -14, 33,
                                  -15, -57},
                   .passed_pawns = {-8, 0, 14, 46, 83, 127},
                   .passed_blocked_pawns = {1, 0, 0, 8, 8, -40},
                   ...
                   .bishop_pawns = {-4, -4},
                   .king_shield = {29, 20},
                   .pawn_attacked_penalty = {-54, -113},
                   .tempo = 28,
               },
           .eg =
               {
                   .material = {0, 88, 385, 435, 720, 1334},
                   .pst_rank =
                       {
                           0,   -3,  -8,  -8, 0,  19, 88, 0,   // Pawn
                           -30, -18, -6,  17, 22, 7,  2,  7,   // Knight
                           -12, -10, 0,   4,  6,  2,  2,  9,   // Bishop
                           -18, -18, -11, 5,  10, 9,  17, 6,   // Rook
                           -48, -34, -9,  13, 20, 20, 20, 19,  // Queen
                           -35, -2,  7,   22, 32, 29, 18, -38, // King
                       },
                   .pst_file =
                       {
                           1,   6,  0,  -6, -1, 2,  1,  -3,  // Pawn
                           -18, -5, 7,  16, 16, 4,  -2, -18, // Knight
                           -9,  0,  4,  10, 10, 4,  -4, -14, // Bishop
                           1,   5,  5,  -3, -6, 0,  0,  -4,  // Rook
                           -17, -9, -1, 4,  9,  9,  4,  2,   // Queen
                           -26, 0,  11, 16, 19, 15, 6,  -27, // King
                       },
                   .mobilities = {5, 3, 4, 5, -3},
                   .king_attacks = {0, -1, -7, 11, 0},
                   .pawn_threat = {-4, -5, -18, -9, -7},
                   .open_files = {6, 3, 18, 9, 31, 7, 24, -7, 2, 13, 47, 6},
                   .passed_pawns = {14, 1, 18, 44, 95, 88},
                   .passed_blocked_pawns = {-11, -4, -14, -35, -74, -74},
