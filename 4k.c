...
G(
    ...
    // Assume stdin never closes on mini build
        ...
        const A(2, char, i8, u8, i32) ch = *string;
        if (ch <= ' ') {
          *string = 0;
          return ch != '\n';
        }
...
G(
    46, S(1) void move_str(H(50, 1, const A(5, bool, i8, u8, i16, u16, i32, u32, i64, u64) flip), H(50, 1, const Move *restrict move),
...
G(
    57, [[nodiscard]] S(1) u64 get_mobility(H(69, 1, const Position *pos), H(69, 1, const A(6, i8, u8, i16, u16, i32, u32, i64, u64) piece),
                                            H(69, 1, const A(7, i8, u8, i16, u16, i32, u32, i64, u64) sq)) {
      u64 moves = 0;
...
G(
    74, S(0) A(6, bool, i8, u8, i16, u16, i32, u32, i64, u64) makemove(H(80, 1, Position *const restrict pos), H(80, 1, const Move *const restrict move)) {
      ...
      G(89, // Update castling permissions
        ...
        G(92, pos->castling[1] &= !(mask & 0x11);) G(92, pos->castling[3] &= !(oppMask & 0x11);) G(92, pos->castling[0] &= !(mask & 0x90);)
...
[[nodiscard]] S(0) A(3, u8, i16, u16, i32, u32, i64, u64)
  ...
  const A(1, u8, i16, u16, i32, u32, i64, u64) num_moves = movelist - start;
...
typedef struct [[nodiscard]] __attribute__((packed)) {
  ...
  H(116, 1,
    H(119, 1, i8 mobilities[5];) H(119, 1, i8 passed_blocked_pawns[6];) H(119, 1, i8 pawn_attacked_penalty[2];) H(119, 1, i8 open_files[18];)
        H(119, 1, i8 tempo;) H(119, 1, i8 pst_file[48];))
  H(116, 1,
    H(118, 1, i8 king_attacks[5];) H(118, 1, i8 pst_rank[48];) H(118, 1, i8 passed_pawns[6];) H(118, 1, i8 bishop_pair;) H(118, 1, i8 phalanx_pawn[6];)
        H(118, 1, i8 protected_pawn[6];))
} EvalParams;
...
typedef struct [[nodiscard]] __attribute__((packed)) {
  ...
  H(116, 2,
    H(119, 2, i32 mobilities[5];) H(119, 2, i32 passed_blocked_pawns[6];) H(119, 2, i32 pawn_attacked_penalty[2];) H(119, 2, i32 open_files[18];)
        H(119, 2, i32 tempo;) H(119, 2, i32 pst_file[48];))
  H(116, 2,
    H(118, 2, i32 king_attacks[5];) H(118, 2, i32 pst_rank[48];) H(118, 2, i32 passed_pawns[6];) H(118, 2, i32 bishop_pair;) H(118, 2, i32 phalanx_pawn[6];)
        H(118, 2, i32 protected_pawn[6];))
} EvalParamsMerged;
...
G(
    ...
    __attribute__((aligned(8))) S(1)
        C(1) const EvalParamsInitial initial_params = {.phases = {0, 0, 1, 1, 2, 4},
                                                       .mg =
                                                           {
                                                               .material = {0, 67, 291, 331, 380, 845},
                                                               .pst_rank =
                                                                   {
                                                                       0,   -15, -18, -4,  6,  30, 125, 0,   // Pawn
                                                                       -20, -5,  9,   23,  30, 35, 11,  -83, // Knight
                                                                       -8,  10,  16,  19,  16, 16, -10, -59, // Bishop
                                                                       6,   -3,  -8,  -11, 3,  12, -1,  2,   // Rook
                                                                       13,  15,  8,   1,   -3, -2, -20, -11, // Queen
                                                                       -8,  1,   -10, -22, -5, 39, 45,  45,  // King
                                                                   },
                                                               .pst_file =
                                                                   {
                                                                       -9,  -12, -8, 0,   7,   11,  16, -5,  // Pawn
                                                                       -30, -11, -1, 12,  14,  14,  8,  -5,  // Knight
                                                                       -15, 0,   3,  1,   4,   -1,  10, -4,  // Bishop
                                                                       -11, -8,  -3, 6,   12,  9,   5,  -10, // Rook
                                                                       -15, -8,  -4, 0,   3,   4,   13, 6,   // Queen
                                                                       -9,  16,  -8, -26, -25, -11, 11, 1,   // King
                                                                   },
                                                               .mobilities = {6, 5, 2, 3, -2},
                                                               .king_attacks = {0, 14, 19, 14, 0},
                                                               .pawn_threat = {-17, -8, -7, -8, 1},
                                                               .open_files = {2, 6, -2, 7, -1, -18, 7, -10, -12, 20, -3, -32, 9, -8, -11, 35, -12, -64},
                                                               .passed_pawns = {-8, -1, 9, 40, 74, 125},
                                                               .passed_blocked_pawns = {-1, -5, -3, 3, 2, -51},
                                                               .passed_king_distance = {-1, -2},
                                                               .protected_pawn = {0, 21, 12, 19, 33, 127},
                                                               .phalanx_pawn = {7, 12, 21, 37, 127, 127},
                                                               .bishop_pair = 27,
                                                               .bishop_pawns = {-5, -5},
                                                               .king_shield = {29, 17},
                                                       ...
                                                       .eg = {
                                                           .material = {0, 90, 403, 443, 732, 1369},
                                                           .pst_rank =
                                                               {
                                                                   0,   0,   -7,  -7, -1, 15, 94, 0,   // Pawn
                                                                   -29, -17, -6,  16, 21, 7,  2,  6,   // Knight
                                                                   -11, -10, 0,   3,  6,  2,  4,  7,   // Bishop
                                                                   -16, -18, -10, 4,  10, 9,  17, 5,   // Rook
                                                                   -55, -40, -12, 13, 29, 24, 30, 12,  // Queen
                                                                   -36, -3,  4,   18, 30, 30, 19, -39, // King
                                                               },
                                                           .pst_file =
                                                               {
                                                                   3,   7,  0, -7, -2, 2,  -1, -3,  // Pawn
                                                                   -18, -5, 8, 17, 16, 4,  -2, -21, // Knight
                                                                   -9,  -1, 5, 10, 10, 4,  -5, -15, // Bishop
                                                                   2,   6,  5, -3, -6, -1, 0,  -3,  // Rook
                                                                   -22, -7, 3, 8,  15, 14, -1, -10, // Queen
                                                                   -30, -2, 9, 16, 18, 14, 4,  -29, // King
                                                               },
                                                           .mobilities = {4, 3, 4, 1, -4},
                                                           .king_attacks = {0, -2, -7, 8, 0},
                                                           .pawn_threat = {-2, -5, -18, -14, -8},
                                                           .open_files = {-9, 7, 3, 17, 14, 18, 7, 6, 18, 16, 30, 16, 18, -5, 4, 19, 48, 15},
                                                           .passed_pawns = {14, 3, 20, 47, 100, 94},
                                                           .passed_blocked_pawns = {-11, -3, -13, -30, -68, -71},
                                                           .passed_king_distance = {-5, 9},
                                                           .protected_pawn = {0, 16, 15, 19, 45, 22},
                                                           .phalanx_pawn = {5, 15, 26, 81, 127, 127},
                                                           .bishop_pair = 58,
                                                           .bishop_pawns = {-11, -1},
                                                           .king_shield = {-9, -7},
...
G(
    121, [[nodiscard]] S(1) A(0, i32, i64) combine_eval_param(H(122, 1, const A(1, i16, i32, i64) mg_val), H(122, 1, const A(1, i16, i32, i64) eg_val)) {
...
S(0) A(1, i16, i32, i64) eval(Position *const restrict pos) {
  ...
  for (A(4, i8, u8, i16, u16, i32, u32, i64, u64) c = 0; c < 2; c++) {
    ...
    for (A(4, i8, u8, i16, u16, i32, u32, i64, u64) p = Pawn; p <= King; p++) {
      ...
      while (copy) {
        const A(7, i8, u8, i16, u16, i32, u32, i64, u64) sq = lsb(copy);
        ...
        G(
            ...
            const i32 file_state = !(G(139, north(in_front)) & G(139, pawns[0])) * 2 + !(G(142, in_front) & G(142, pawns[1]));
            if (file_state) { score += eval_params.open_files[file_state * 6 - 7 + p]; })
...
[[nodiscard]] S(1) u64 get_material_hash(const Position *const pos) {
  ...
  for (A(4, i8, u8, i16, u16, i32, u32, i64, u64) c = 0; c < 2; c++) {
    for (A(4, i8, u8, i16, u16, i32, u32, i64, u64) p = Pawn; p <= Queen; p++) {
      hash = G(182, count(G(184, pos->pieces[p]) & G(184, pos->colour[c]))) + G(182, G(183, hash) * G(183, 9));
    }
  }
  return hash;
}
...
void get_piece_hashes(H(300, 1, const Position *const pos), H(300, 1, u64 hashes[4])) {
  for (A(6, i8, u8, i16, u16, i32, u32, i64, u64) p = Pawn; p <= Queen; p++) {
...
search(
    ...
    u64 *nodes,
#endif
    H(186, 1, H(187, 1, ThreadData *data), H(187, 1, const A(0, i32, i64) beta), H(187, 1, A(1, i16, i32, i64) depth), H(187, 1, Position *const pos)),
  ...
  if (G(203, !in_check) && G(203, G(204, alpha) == G(204, beta - 1))) {
    ...
    if (G(210, depth > 2) && G(210, do_null) && G(210, static_eval >= beta)) {
      ...
      const A(2, i16, i32, i64) score = -search(
          ...
          nodes,
#endif
          H(186, 2, H(187, 2, data), H(187, 2, -alpha), H(187, 2, depth - G(212, depth / 4) - G(212, 4) - G(212, nmp_red)), H(187, 2, &npos)),
  ...
  for (A(3, u8, i16, u16, i32, u32, i64, u64) move_index = 0; move_index < ss->num_moves; move_index++) {
    ...
    G(
        ...
        if (G(225, depth < 5) &&
            G(225, G(226, G(227, 176) * G(227, depth)) + G(226, static_eval) + G(226, initial_params.eg.material[moves[move_index].takes_piece]) +
    ...
    while (true) {
      score = -search(
          ...
          nodes,
#endif
          H(186, 3, H(187, 3, data), H(187, 3, -alpha), H(187, 3, depth - G(231, reduction) - G(231, 1)), H(187, 3, &npos)),
  ...
  G(
      ...
      if (G(243, G(245, ss->best_move.takes_piece) == G(245, None)) && G(243, G(244, tt_flag) != G(244, (best_score < ss->static_eval)))) {
  ...
  for (A(4, i8, u8, i16, u16, i32, u32, i64, u64) depth = 1; depth < max_ply; depth++) {
    ...
    while (true) {
      ...
      score = search(
          ...
          &data->nodes,
#endif
          H(186, 4, H(187, 4, data), H(187, 4, beta), H(187, 4, depth), H(187, 4, &data->pos)), H(186, 4, H(188, 4, 0), H(188, 4, alpha), H(188, 4, false)));
#ifdef FULL
      if (data->thread_id == 0) {
