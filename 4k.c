...
typedef struct [[nodiscard]] __attribute__((packed)) {
  ...
  H(116, 1,
    H(117, 1, i8 pawn_threat[5];) H(117, 1, i8 king_shield[2];)
        H(117, 1, i8 bishop_pawns[2];) H(117, 1, i8 isolated_pawn;))
  H(116, 1,
...
G(
    ...
    __attribute__((aligned(8))) S(1) const EvalParamsInitial initial_params =
        {.phases = {0, 0, 1, 1, 2, 4},
         .mg = {.material = {0, 66, 282, 320, 371, 818},
                .pst_rank =
                    {
                        0,   -15, -17, -5,  8,  29, 97,  0,   // Pawn
                        -17, -6,  6,   18,  27, 38, 18,  -85, // Knight
                        -5,  10,  15,  15,  15, 14, -5,  -59, // Bishop
                        6,   -4,  -10, -14, 2,  12, 1,   7,   // Rook
                        17,  18,  9,   -1,  -6, -4, -23, -11, // Queen
                        -12, -8,  -18, -22, 10, 61, 68,  85,  // King
                    },
                .pst_file =
                    {
                        -10, -13, -6,  3,   9,   13,  11, -7, // Pawn
                        -27, -11, -1,  12,  13,  13,  6,  -4, // Knight
                        -13, 0,   3,   1,   4,   -1,  10, -4, // Bishop
                        -11, -9,  -3,  7,   11,  8,   5,  -9, // Rook
                        -13, -8,  -4,  1,   3,   3,   11, 7,  // Queen
                        -12, 12,  -12, -28, -26, -11, 12, 4,  // King
                    },
                .mobilities = {6, 5, 2, 3, -2},
                .king_attacks = {0, 14, 19, 14, 0},
                .pawn_threat = {-14, -5, -6, -5, 0},
                .open_files = {7,
                               -9, -10, 16, -1, -23, 7, -12, -14, 32, -13, -57},
                .passed_pawns = {-3, -8, -7, 12, 35, 97},
                .passed_blocked_pawns = {1, -3, 3, 11, 14, -42},
                .protected_pawn = 15,
                .phalanx_pawn = 9,
                .isolated_pawn = -3,
                .bishop_pair = 26,
                ...
                .tempo = 17},
         .eg = {.material = {0, 94, 392, 432, 721, 1342},
                .pst_rank =
                    {
                        0,   -5,  -8,  -7, 0,  19, 105, 0,   // Pawn
                        -33, -20, -7,  17, 23, 9,  4,   9,   // Knight
                        -16, -14, -2,  4,  9,  6,  4,   9,   // Bishop
                        -17, -19, -12, 5,  11, 10, 18,  5,   // Rook
                        -59, -43, -15, 13, 31, 26, 32,  15,  // Queen
                        -42, -1,  7,   20, 30, 28, 14,  -55, // King
                    },
                .pst_file =
                    {
                        13,  9,  0,  -10, -5, -1, -3, -3,  // Pawn
                        -20, -5, 7,  16,  16, 5,  -1, -19, // Knight
                        -11, 0,  5,  10,  11, 4,  -4, -15, // Bishop
                        1,   6,  6,  -3,  -5, 0,  0,  -6,  // Rook
                        -23, -6, 4,  7,   14, 14, 0,  -10, // Queen
                        -33, 4,  18, 25,  25, 16, 3,  -40, // King
                    },
                .mobilities = {5, 3, 4, 2, -6},
                .king_attacks = {0, -3, -6, 8, 0},
                .pawn_threat = {-2, -4, -17, -14, -7},
                .open_files = {19, 0, 12, 4, 20, 13, 17, -7, 2, 12, 42, 10},
                .passed_pawns = {13, 19, 44, 71, 120, 105},
                .passed_blocked_pawns = {-9, -7, -31, -63, -112, -116},
                .protected_pawn = 10,
                .phalanx_pawn = 9,
                .isolated_pawn = -8,
                .bishop_pair = 62,
    ...
    for (i32 p = Pawn; p <= King; p++) {
      ...
      while (copy) {
        ...
        G(
            93, // ISOLATED PAWNS
            if (p == Pawn) {
              const u64 own_file = 0x0101010101010101ULL << file;
              const u64 adjacent_files = east(own_file) | west(own_file);
              if (!(pawns[0] & adjacent_files)) {
