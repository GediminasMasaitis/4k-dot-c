...
G(1, S(1) ssize_t _sys(H(2, 1, ssize_t arg3), H(2, 1, ssize_t call),
...
G(3, // Non-standard, gets but a word instead of a line
  ...
  while (true) {
    const int result = _sys(H(2, 2, 1), H(2, 2, 0),
      H(2, 2, stdin), H(2, 2, (ssize_t)string));
...
G(3, S(1) void putl(const char* const restrict string) {
  i32 length = 0;
  while (string[length]) {
    _sys(H(2, 3, 1), H(2, 3, 1), H(2, 3, stdout),
      H(2, 3, (ssize_t)(&string[length])));
    length++;
  }
}
...
[[nodiscard]] S(1) u64 get_time() {
  ...
  asm volatile("syscall"
    ...
    : "0"(228), "D"(1), "S"(&ts)
    : "rcx", "r11", "memory");
  return G(5, ts.tv_nsec) + G(5, G(6, 1000 * 1000 * 1000ULL) * G(6, ts.tv_sec));
}
...
G(10, [[nodiscard]] S(1)
  u64 shift(H(13, 1, const u64 mask), H(13, 1, const i32 shift),
    H(13, 1, const u64 bb)) {
...
G(10, [[nodiscard]] S(0) i32 lsb(u64 bb) { return __builtin_ctzll(bb); })
...
G(16, [[nodiscard]] S(1) u64 east(const u64 bb) {
  return G(18, ~0x101010101010101ull) & G(18, bb << 1);
})
...
G(19, [[nodiscard]] S(1)
  ...
  G(19, [[nodiscard]] S(1) u64 nw(const u64 bb) {
  return shift(H(13, 2, ~0x8080808080808080ull), H(13, 2, 7), H(13, 2, bb));
...
G(19, [[nodiscard]] S(1)
  ...
  G(23, [[nodiscard]] S(1)
    u64 ray(H(24, 1, const u64 bb), H(24, 1, const u64 mask),
      H(24, 1, const u64 blockers), H(24, 1, const i32 shift_by)) {
  u64 result =
    shift(H(13, 3, mask), H(13, 3, shift_by), H(13, 3, bb));
  for (i32 i = 0; i < 6; i++) {
    result |= shift(H(13, 4, mask), H(13, 4, shift_by),
      H(13, 4, result & ~blockers));
  }
  return result;
})

G(23, [[nodiscard]] S(0) u64 xattack(H(25, 1, const u64 bb),
  H(25, 1, const u64 dir_mask),
  H(25, 1, const u64 blockers)) {
  return G(26, dir_mask) &
    G(26, (G(27, (G(28, dir_mask) & G(28, blockers)) - bb) ^
      G(27, flip_bb(flip_bb(G(29, blockers) & G(29, dir_mask)) -
        flip_bb(bb)))));
})

G(23, S(1) u64 diag_mask[64];)

G(30, [[nodiscard]] S(1) u64 knight(const u64 bb) {
  return G(36, G(37, ~0x101010101010101ull) &
    G(37, (G(38, bb >> 15) | G(38, bb << 17)))) |
    G(36, G(39, ~0x8080808080808080ull) &
      G(39, (G(40, bb >> 17)))) |
    G(36, G(43, 0xFCFCFCFCFCFCFCFCull) &
      G(43, (G(44, bb >> 6) | G(44, bb << 10)))) |
    G(36, G(41, (G(42, bb << 6) | G(42, bb >> 10))) &
      G(41, 0x3F3F3F3F3F3F3F3Full));
})

G(30, [[nodiscard]] S(1) u64 bishop(H(31, 1, const u64 bb),
  H(31, 1, const u64 blockers)) {
  assert(count(bb) == 1);
  const i32 sq = lsb(bb);
  return G(32, xattack(H(25, 2, bb), H(25, 2, diag_mask[sq]),
    H(25, 2, blockers))) |
    G(32, xattack(H(25, 3, bb),
      H(25, 3, flip_bb(diag_mask[G(33, 56) ^ G(33, sq)])), H(25, 3, blockers)));
})

G(30, [[nodiscard]] S(1) u64 king(const u64 bb) {
  return G(45, G(46, ~0x101010101010101ull) &
    G(46, (G(47, bb >> 7) | G(47, bb << 9) | G(47, bb << 1)))) | G(45, bb >> 8) |
    G(45, G(48, (G(49, bb >> 9) | G(49, bb >> 1) | G(49, bb << 7))) &
      G(48, ~0x8080808080808080ull)) |
    G(45, bb << 8);
})

G(30, [[nodiscard]] S(1) u64 rook(H(34, 1, const u64 bb),
  H(34, 1, const u64 blockers)) {
  assert(count(bb) == 1);
  return G(35, xattack(H(25, 4, bb),
    H(25, 4, bb ^ 0x101010101010101ULL << lsb(bb) % 8), H(25, 4, blockers))) |
    G(35, // West
      ray(H(24, 3, bb), H(24, 3, ~0x8080808080808080ull),
        H(24, 3, blockers), H(24, 3, -1))) |
    G(35, // East
      ray(H(24, 2, bb), H(24, 2, ~0x101010101010101ull),
        H(24, 2, blockers), H(24, 2, 1)));
})

G(50, [[nodiscard]] S(1) bool move_equal(G(54, Move* const lhs),
  G(54, Move* const rhs)) {
  return G(55, *(u32*)lhs) == G(55, *(u32*)rhs);
})

G(50, [[nodiscard]] S(0)
  i32 piece_on(H(60, 1, const i32 sq),
    H(60, 1, const Position* const restrict pos)) {
  assert(sq >= 0);
  assert(sq < 64);
...
G(50, S(1) void move_str(H(57, 1, const i32 flip),
  H(57, 1, char* restrict str),
...
G(50, S(1) void swapu32(G(51, u32* const lhs), G(51, u32* const rhs)) {
  const u32 temp = *lhs;
  *lhs = *rhs;
  *rhs = temp;
}

S(1) void swapmoves(G(52, Move* const rhs), G(52, Move* const lhs)) {
  swapu32(G(53, (u32*)lhs), G(53, (u32*)rhs));
})

G(50, S(1) void swapu16(G(57, u16* const restrict rhs),
...
G(50, S(1) void swapu64(G(56, u64* const lhs), G(56, u64* const rhs)) {
  const u64 temp = *lhs;
  *lhs = *rhs;
  *rhs = temp;
})

G(62, [[nodiscard]] S(1) u64 get_mobility(H(75, 1, const i32 sq),
  H(75, 1, const Position* pos),
  ...
  G(76, if (piece == King) { moves = king(bb); })
    ...
    G(78, if (G(79, piece == Bishop) || G(79, piece == Queen)) {
      moves |= bishop(H(31, 3, bb), H(31, 3, blockers));
    })
      G(78, if (G(80, piece == Queen) || G(80, piece == Rook)) {
      moves |= rook(H(34, 3, bb), H(34, 3, blockers));
    })
  }
  return moves;
})

G(62, S(1) void flip_pos(Position* const restrict pos) {
  G(72, swapu64(G(73, &pos->colour[0]), G(73, &pos->colour[1]));)

    G(72, // Hack to flip the first 10 bitboards in Position.
...
G(62, [[nodiscard]] S(1) i32 is_attacked(H(63, 1, const u64 bb),
  H(63, 1, const Position* const restrict pos)) {
  assert(count(bb) == 1);
  const u64 theirs = pos->colour[1];
  G(64, const u64 blockers = theirs | pos->colour[0];)
    G(64, const u64 pawns = theirs & pos->pieces[Pawn];)
    return G(65, G(66, bb) & G(66, (G(67, se(pawns)) | G(67, sw(pawns))))) ||
    G(65, G(71, rook(H(34, 2, bb), H(34, 2, blockers))) &
      G(71, (pos->pieces[Rook] | pos->pieces[Queen])) &
      G(71, theirs)) ||
    G(65, G(69, theirs) & G(69, king(bb)) & G(69, pos->pieces[King])) ||
    G(65, G(70, theirs) & G(70, knight(bb)) &
      G(70, pos->pieces[Knight])) ||
    G(65, G(68, (pos->pieces[Bishop] | pos->pieces[Queen])) &
      G(68, theirs) &
      G(68, bishop(H(31, 2, bb), H(31, 2, blockers))));
})
...
G(82, S(0) i32 makemove(H(88, 1, const Move* const restrict move),
  H(88, 1, Position* const restrict pos)) {
  assert(move->from >= 0);
  assert(move->from < 64);
  assert(move->to >= 0);
  assert(move->to < 64);
  ...
  assert(move->takes_piece == piece_on(H(60, 3, move->to), H(60, 3, pos)));

  G(89, const u64 from = 1ull << move->from;)
    G(89, const u64 to = 1ull << move->to;)
    G(90, const i32 piece = piece_on(H(60, 4, move->from), H(60, 4, pos));
  assert(piece != None);)
    G(90, const u64 mask = G(91, to) | G(91, from);)
    ...
    G(92, // Castling
      if (piece == King) {
        const u64 bb = move->to - move->from == 2 ? 0xa0
          ...
          : 0;
        G(93, pos->colour[0] ^= bb;)
          G(93, pos->pieces[Rook] ^= bb;)
      })

    G(92, pos->colour[0] ^= mask;)

    // Move the piece
    G(92, pos->pieces[piece] ^= mask;)
    G(92, // Captures
      if (move->takes_piece != None) {
        G(94, pos->pieces[move->takes_piece] ^= to;)
          G(94, pos->colour[1] ^= to;)
      })

    // En passant
    if (G(95, piece == Pawn) && G(95, to == pos->ep)) {
      G(96, pos->colour[1] ^= to >> 8;)
        G(96, pos->pieces[Pawn] ^= to >> 8;)
    }
  pos->ep = 0;

  G(97, // Pawn double move
    if (G(98, move->to - move->from == 16) && G(98, piece == Pawn)) {
      pos->ep = to >> 8;
    })

    G(97, // Promotions
      if (move->promo != None) {
        G(99, pos->pieces[move->promo] ^= to;)
          G(99, pos->pieces[Pawn] ^= to;)
      })

    G(97, // Update castling permissions
      G(100, pos->castling[1] &= !(mask & 0x11ull);)
      G(100, pos->castling[3] &= !(mask & 0x1100000000000000ull);)
      G(100, pos->castling[2] &= !(mask & 0x9000000000000000ull);)
      G(100, pos->castling[0] &= !(mask & 0x90ull);))
...
G(82, S(0) Move* generate_pawn_moves(H(101, 1, u64 to_mask),
  H(101, 1, const Position* const pos),
  H(101, 1, Move* restrict movelist),
  H(101, 1, const i32 offset)) {
  while (to_mask) {
    const u8 to = lsb(to_mask);
    to_mask &= to_mask - 1;
    const u8 from = G(102, offset) + G(102, to);
    assert(from >= 0);
    assert(from < 64);
    assert(to >= 0);
    assert(to < 64);
    assert(piece_on(H(60, 5, from), H(60, 5, pos)) == Pawn);
    const u8 takes = piece_on(H(60, 6, to), H(60, 6, pos));
    if (to > 55) {
...
G(82, S(1) Move* generate_piece_moves(H(83, 1, Move* restrict movelist),
  H(83, 1, const u64 to_mask),
  H(83, 1, const Position* restrict pos)) {
  for (i32 piece = Knight; piece <= King; piece++) {
    assert(piece == Knight || piece == Bishop || piece == Rook ||
      piece == Queen || piece == King);
    u64 copy = G(84, pos->pieces[piece]) & G(84, pos->colour[0]);
    while (copy) {
      ...
      G(85, copy &= copy - 1;)
        ...
        G(85, u64 moves = G(86, to_mask) &
          G(86, get_mobility(H(75, 2, from), H(75, 2, pos),
            H(75, 2, piece)));)
        ...
        while (moves) {
          ...
          G(87, moves &= moves - 1;)
            ...
            .from = from,
              .to = to,
              .promo = None,
              .takes_piece = piece_on(H(60, 2, to), H(60, 2, pos))
          });)
        }
    }
  }
...
[[nodiscard]] S(0) i32 movegen(H(103, 1, const i32 only_captures),
  H(103, 1, const Position* const restrict pos),
  H(103, 1, Move* restrict movelist)) {

  G(104, const u64 all = G(105, pos->colour[1]) | G(105, pos->colour[0]);)
    ...
    G(106, // PAWN WEST CAPTURES
      movelist = generate_pawn_moves(
        H(101, 4, G(112, nw(G(113, pos->pieces[Pawn]) & G(113, pos->colour[0]))) &
          G(112, (G(114, pos->colour[1]) | G(114, pos->ep)))), H(101, 4, pos),
        H(101, 4, movelist),
        H(101, 4, -7));)
    G(106, // LONG CASTLE
      if (G(118, !(G(119, all) & G(119, 0x60ull))) && G(118, pos->castling[0]) &&
        G(118, !only_captures) &&
        G(120, !is_attacked(H(63, 4, 1ULL << 4), H(63, 4, pos))) &&
        G(120, !is_attacked(H(63, 3, 1ULL << 5), H(63, 3, pos)))) {
        *movelist++ =
          (Move){ .from = 4, .to = 6, .promo = None, .takes_piece = None };
      })
    G(106, // PAWN EAST CAPTURES
      movelist = generate_pawn_moves(
        H(101, 5, G(115, (G(117, pos->colour[1]) | G(117, pos->ep))) &
          G(115, ne(G(116, pos->colour[0]) & G(116, pos->pieces[Pawn])))), H(101, 5, pos),
        H(101, 5, movelist),
        H(101, 5, -9));)
    G(106, // PAWN PROMOTIONS
      if (!only_captures) {
        movelist = generate_pawn_moves(
          H(101, 2, G(107, ~all) &
            G(107, north(G(108, ~all) &
              G(108, north(G(109, pos->colour[0]) &
                G(109, pos->pieces[Pawn]) &
                G(109, 0xFF00)))))), H(101, 2, pos),
          H(101, 2, movelist),
          H(101, 2, -16));
      })
    G(106, // PAWN DOUBLE MOVES
      movelist = generate_pawn_moves(
        H(101, 3, north(G(110, (only_captures ? 0xFF00000000000000ull : ~0ull))) &
          G(110, G(111, pos->colour[0]) & G(111, pos->pieces[Pawn])) &
          G(110, ~all)), H(101, 3, pos),
        H(101, 3, movelist),
        H(101, 3, -8));)
    G(106, // SHORT CASTLE
      if (G(121, !only_captures) && G(121, pos->castling[1]) &&
        G(121, !(G(122, all) & G(122, 0xEull))) &&
        G(123, !is_attacked(H(63, 5, 1ULL << 4), H(63, 5, pos))) &&
        G(123, !is_attacked(H(63, 6, 1ULL << 3), H(63, 6, pos)))) {
        *movelist++ =
          (Move){ .from = 4, .to = 2, .promo = None, .takes_piece = None };
      })
    movelist = generate_piece_moves(H(83, 2, movelist), H(83, 2, to_mask),
      H(83, 2, pos));
...
perft(const Position* const restrict pos, const i32 depth) {
  ...
  const i32 num_moves =
    movegen(H(103, 2, false), H(103, 2, pos), H(103, 2, moves));

  for (i32 i = 0; i < num_moves; ++i) {
    Position npos = *pos;

    // Check move legality
    if (!makemove(H(88, 2, &moves[i]), H(88, 2, &npos))) {
      continue;
    }
...
typedef struct [[nodiscard]] __attribute__((packed)) {
  i16 material[6];
  H(124, 1, H(125, 1, i8 pst_file[48];) H(125, 1, i8 mobilities[5];)
    H(125, 1, i8 passed_blocked_pawns[6];) H(125, 1, i8 open_files[6];)
    H(125, 1, i8 tempo;) H(125, 1, i8 pawn_attacked_penalty[2];))
    H(124, 1, H(126, 1, i8 king_attacks[5];) H(126, 1, i8 pst_rank[48];)
      H(126, 1, i8 protected_pawn;) H(126, 1, i8 passed_pawns[6];)
      H(126, 1, i8 phalanx_pawn;) H(126, 1, i8 bishop_pair;))
} EvalParams;

typedef struct [[nodiscard]] __attribute__((packed)) {
  i32 material[6];
  H(124, 2, H(125, 2, i32 pst_file[48];) H(125, 2, i32 mobilities[5];)
    H(125, 2, i32 passed_blocked_pawns[6];) H(125, 2, i32 open_files[6];)
    H(125, 2, i32 tempo;) H(125, 2, i32 pawn_attacked_penalty[2];))
    H(124, 2, H(126, 2, i32 king_attacks[5];) H(126, 2, i32 pst_rank[48];)
      H(126, 2, i32 protected_pawn;) H(126, 2, i32 passed_pawns[6];)
      H(126, 2, i32 phalanx_pawn;) H(126, 2, i32 bishop_pair;))
...
G(128, [[nodiscard]] S(1) i32 combine_eval_param(H(129, 1, const i32 mg_val),
  H(129, 1, const i32 eg_val)) {
  return G(130, mg_val) + G(130, (eg_val << 16));
})

G(128, __attribute__((aligned(8))) S(1)
  ...
  G(131, i32 phase = 0;)
    ...
    for (i32 c = 0; c < 2; c++) {
      ...
      G(132, const u64 opp_pawns = G(134, pos->colour[1]) & G(134, pos->pieces[Pawn]);
      const u64 attacked_by_pawns =
        G(135, se(opp_pawns)) | G(135, sw(opp_pawns));
      G(136, const u64 no_passers = G(137, attacked_by_pawns) | G(137, opp_pawns);)
        G(136, // PROTECTED PAWNS
          score -=
          G(138, count(G(139, attacked_by_pawns) & G(139, opp_pawns))) *
          G(138, eval_params.protected_pawn);)
        G(136, // PHALANX PAWNS
          score -=
          G(140, count(G(141, west(opp_pawns)) & G(141, opp_pawns))) *
          G(140, eval_params.phalanx_pawn);))

        G(132, // BISHOP PAIR
          if (count(G(142, pos->colour[0]) & G(142, pos->pieces[Bishop])) > 1) {
            score += eval_params.bishop_pair;
          })
        G(132, const u64 opp_king_zone =
          king(G(133, pos->colour[1]) & G(133, pos->pieces[King]));)
        G(132, const u64 own_pawns = G(143, pos->pieces[Pawn]) & G(143, pos->colour[0]);)

        for (i32 p = Pawn; p <= King; p++) {
          u64 copy = G(144, pos->colour[0]) & G(144, pos->pieces[p]);
          while (copy) {
            const i32 sq = lsb(copy);
            G(145, const i32 file = G(146, 7) & G(146, sq);)
              G(145, const i32 rank = sq >> 3;)
              G(145, phase += initial_params.phases[p];)
              G(145, copy &= copy - 1;)

              G(101, // OPEN FILES / DOUBLED PAWNS
              ...
              G(101, // SPLIT PIECE-SQUARE TABLES FOR RANK
                score +=
                eval_params
                .pst_rank[G(154, G(155, (p - 1)) * G(155, 8)) + G(154, rank)];)
              G(101, // MATERIAL
                score += eval_params.material[p];)

              G(101, // PASSED PAWNS
                if (G(148, p == Pawn) &&
                  G(148, !(G(149, (0x101010101010101ULL << sq)) &
                    G(149, no_passers)))) {
                  G(150, score += eval_params.passed_pawns[rank - 1];)

                    G(150, if (G(151, north(1ULL << sq)) & G(151, pos->colour[1])) {
              ...
              G(101, // SPLIT PIECE-SQUARE TABLES FOR FILE
                score +=
                eval_params
                .pst_file[G(152, file) + G(152, G(153, (p - 1)) * G(153, 8))];)

              G(101, if (p > Pawn) {
              G(156, // PIECES ATTACKED BY PAWNS
                if (G(157, 1ULL << sq) & G(157, no_passers)) {
                  score += eval_params.pawn_attacked_penalty[c];
                })

                G(156, const u64 mobility =
                  G(158, ~attacked_by_pawns) &
                  G(158, get_mobility(H(75, 3, sq), H(75, 3, pos),
                    H(75, 3, p)));

              G(159, // MOBILITY
                score +=
                G(160, eval_params.mobilities[p - 2]) *
                G(160, count(G(161, mobility) & G(161, ~pos->colour[0])));)

                G(159, // KING ATTACKS
                  score +=
                  G(162, count(G(163, mobility) & G(163, opp_king_zone))) *
                  G(162, eval_params.king_attacks[p - 2]);))
            })
          }
        }
  ...
  const i32 stronger_side_pawns_missing =
    8 - count(G(164, pos->pieces[Pawn]) & G(164, pos->colour[score < 0]));
  return (G(165, phase) * G(165, (i16)score) +
    G(166, ((score + 0x8000) >> 16)) *
    G(166, (128 - stronger_side_pawns_missing * stronger_side_pawns_missing)) / 128 * (24 - phase)) /
    24;
}
...
G(168, S(1) i32 move_history[2][6][64][64];)
G(168, S(0) u64 max_time;)
G(168, S(0) u64 start_time;)
G(168, S(1) TTEntry tt[tt_length];)
...
get_hash(const Position* const pos) {
  ...
  for (i32 i = 0; i < 6; i++) {
    i128 key;
    __builtin_memcpy(&key, data + G(169, i) * G(169, 16), 16);
...
#error "Unsupported architecture: get_hash only for x86_64 and aarch64"
  ...
  S(1)
  i32 search(H(170, 1, const i32 beta), H(170, 1, i32 alpha),
    H(170, 1, const bool do_null), H(170, 1, i32 depth),
    H(170, 1, SearchStack* restrict stack),
#ifdef FULL
    u64* nodes,
#endif
    H(171, 1, Position* const restrict pos),
    H(171, 1, const i32 pos_history_count), H(171, 1, const i32 ply)) {
  assert(alpha < beta);
  assert(ply >= 0);
  ...
  for (i32 i = G(172, ply) + G(172, pos_history_count);
    G(173, i > 0) && G(173, do_null); i -= 2) {
    if (G(174, tt_hash) == G(174, stack[i].position_hash)) {
      return 0;
    }
  }
  ...
  G(175, stack[ply].best_move = (Move){ 0 };)
    ...
    if (G(176, tt_entry->partial_hash) == G(176, tt_hash_partial)) {
      ...
      // TT PRUNING
      if (G(177, G(178, tt_entry->flag) != G(178, tt_entry->score <= alpha)) &&
        G(177, tt_entry->depth >= depth) &&
        G(177, G(179, beta - 1) == G(179, alpha))) {
  ...
  if (G(180, G(181, tt_hash_partial) == G(181, tt_entry->partial_hash)) &&
    G(180, G(182, tt_entry->flag) != G(182, static_eval) > tt_entry->score)) {
    static_eval = tt_entry->score;
  }

  // QUIESCENCE
  if (G(183, static_eval > alpha) && G(183, in_qsearch)) {
    if (static_eval >= beta) {
      return static_eval;
    }
    alpha = static_eval;
  ...
  if (G(184, !in_check) && G(184, G(185, alpha) == G(185, beta - 1))) {
    if (G(186, !in_qsearch) && G(186, depth < 8)) {
      ...
      G(187, {
        ...
        if (static_eval - G(188, (depth - improving)) * G(188, 56) >= beta) {
          return static_eval;
        }
        })
        ...
        G(187, // RAZORING
          in_qsearch =
          G(189, G(190, depth) * G(190, 122)) + G(189, static_eval) <= alpha;)
    }

    // NULL MOVE PRUNING
    if (G(191, static_eval >= beta) && G(191, depth > 2) && G(191, do_null)) {
      Position npos = *pos;
      G(192, flip_pos(&npos);)
        G(192, npos.ep = 0;)
        const i32 score = -search(
          H(170, 2, -alpha), H(170, 2, -beta),
          H(170, 2, false), H(170, 2, depth - G(193, 4) - G(193, depth / 4)),
          H(170, 2, stack),
#ifdef FULL
          nodes,
#endif
          H(171, 2, &npos), H(171, 2, pos_history_count), H(171, 2, ply + 1));
      if (score >= beta) {
        return score;
      }
    }
  ...
  G(194, stack[ply].num_moves = movegen(H(103, 3, in_qsearch), H(103, 3, pos),
    H(103, 3, stack[ply].moves));)
    G(194, i32 best_score = in_qsearch ? static_eval : -inf;)
    G(194, stack[G(195, ply) + G(195, pos_history_count) + G(195, 2)].position_hash =
      tt_hash;)
    G(194, u8 tt_flag = Upper;)
    G(194, i32 quiets_evaluated = 0;)
    G(194, i32 moves_evaluated = 0;)

    for (i32 move_index = 0; move_index < stack[ply].num_moves; move_index++) {
      // MOVE ORDERING
      G(196, i32 best_index = 0;)
        G(196, i32 move_score = ~0x1010101LL;)
        for (i32 order_index = move_index; order_index < stack[ply].num_moves;
          order_index++) {
        assert(
          stack[ply].moves[order_index].takes_piece ==
          piece_on(H(60, 7, stack[ply].moves[order_index].to), H(60, 7, pos)));
        const i32 order_move_score =
          G(170, // PREVIOUS BEST MOVE FIRST
            (move_equal(G(199, &stack[ply].moves[order_index]),
              G(199, &stack[ply].best_move))
              << 30)) +
          ...
          G(170, // KILLER MOVE
            G(197, 836) *
            G(197, move_equal(G(198, &stack[ply].moves[order_index]),
              G(198, &stack[ply].killer))));
        if (order_move_score > move_score) {
          G(201, move_score = order_move_score;)
            G(201, best_index = order_index;)
        }
      }
      ...
      G(997, // FORWARD FUTILITY PRUNING / DELTA PRUNING
        if (G(203, depth < 8) &&
          G(203, G(204, G(205, 142) * G(205, depth)) + G(204, static_eval) +
        ...
        G(997, // MOVE SCORE PRUNING
          if (G(998, move_score < G(999, depth) * G(999, -256)) &&
            G(998, moves_evaluated)) {
            break;
          })
      ...
      (*nodes)++;
#endif
      if (!makemove(H(88, 3, &stack[ply].moves[move_index]), H(88, 3, &npos))) {
        continue;
      }
      ...
      // LATE MOVE REDUCTION
      i32 reduction = G(206, move_score <= 0) && G(206, depth > 3)
        ? G(207, !improving) +
        G(207, (move_score < -256)) +
        G(207, moves_evaluated / 10) +
        G(207, (G(208, alpha) == G(208, beta - 1)))
        : 0;

      i32 score;
      while (true) {
        score = -search(H(170, 3, -alpha), H(170, 3, low),
          H(170, 3, true),
          H(170, 3, depth - G(209, 1) - G(209, reduction)), H(170, 3, stack),
#ifdef FULL
          nodes,
#endif
          H(171, 3, &npos), H(171, 3, pos_history_count),
          H(171, 3, ply + 1));
          ...
          G(210, stack[ply].best_move = stack[ply].moves[move_index];)
            ...
            if (score >= beta) {
              assert(stack[ply].best_move.takes_piece ==
                piece_on(H(60, 8, stack[ply].best_move.to), H(60, 8, pos)));
              G(211, if (stack[ply].best_move.takes_piece == None) {
                ...
                *this_hist +=
                  bonus - G(213, *this_hist) * G(213, bonus) / 1024;)
                  ...
                  i32* const prev_hist =
                    ...
                    [prev.from][prev.to];
                  *prev_hist -=
                    bonus + G(214, *prev_hist) * G(214, bonus) / 1024;
                })
              })
                break;
            }
  ...
  if (G(218, -inf) == G(218, best_score)) {
    return G(219, in_check) * G(219, (ply - mate));
  }
...
S(1) void init() {
  G(88, // CLEAR HISTORY
    ...
    G(88, // INIT DIAGONAL MASKS
      for (i32 sq = 0; sq < 64; sq++) {
        const u64 bb = 1ULL << sq;
        diag_mask[sq] =
          G(220, ray(H(24, 4, bb), H(24, 4, ~0x101010101010101ull),
            H(24, 4, 0), H(24, 4, 9))) | // Northeast
          G(220, ray(H(24, 5, bb), H(24, 5, ~0x8080808080808080ull),
            H(24, 5, 0), H(24, 5, -9))); // Southwest
      })

    G(88, // MERGE MATERIAL VALUES
    ...
    G(88, // MERGE NON-MATERIAL VALUES
      for (i32 i = 0;
    ...
    ((i32*)&eval_params)[G(221, offset / sizeof(*initial_params.mg.material)) +
      G(221, i)] =
      combine_eval_param(
        H(129, 3, ((i8*)&initial_params.mg)[G(222, offset) + G(222, i)]),
        H(129, 3, ((i8*)&initial_params.eg)[G(223, i) + G(223, offset)]));
  })
}
...
static void print_info(const Position* pos, const i32 depth, const i32 alpha,
  ...
  if (score > alpha && score < beta) {
    putl(" pv ");
    char move_name[8];
    move_str(H(57, 2, pos->flipped), H(57, 2, move_name), H(57, 2, &pv_move));
    putl(move_name);
  }
...
void iteratively_deepen(
...
#endif
  H(224, 1, const i32 pos_history_count),
  H(224, 1, Position* const restrict pos),
  H(224, 1, SearchStack* restrict stack)) {
  G(225, start_time = get_time();)
    G(225, i32 score = 0;)
#ifdef FULL
    ...
    for (i32 depth = 1; depth < max_ply; depth++) {
      ...
      // ASPIRATION WINDOWS
      G(226, i32 window = 15;)
        G(226, size_t elapsed;)
        while (true) {
          G(227, const i32 alpha = score - window;)
            G(227, const i32 beta = G(228, window) + G(228, score);)
            score =
            search(H(170, 4, beta), H(170, 4, alpha), H(170, 4, false),
              H(170, 4, depth), H(170, 4, stack),
#ifdef FULL
              nodes,
#endif
              H(171, 4, pos), H(171, 4, pos_history_count), H(171, 4, 0));
#ifdef FULL
          print_info(pos, depth, alpha, beta, score, *nodes, stack[0].best_move);
#endif
          elapsed = get_time() - start_time;
          G(229, window *= 2;)
            G(229, if (G(230, elapsed > max_time) ||
              G(230, (G(231, score < beta) && G(231, score > alpha)))) {
            break;
          })
        }
  ...
  char move_name[8];
  move_str(H(57, 3, pos->flipped), H(57, 3, move_name),
    H(57, 3, &stack[0].best_move));
  putl("bestmove ");
  puts(move_name);
    }
...
S(1) void display_pos(Position* const pos) {
  ...
  for (i32 rank = 7; rank >= 0; rank--) {
    for (i32 file = 0; file < 8; file++) {
      i32 sq = rank * 8 + file;
      u64 bb = 1ULL << sq;
      i32 piece = piece_on(H(60, 9, sq), H(60, 9, &npos));
      if (bb & npos.colour[0]) {
        if (piece == Pawn) {
          putl("P");
        }
...
S(1) void bench() {
  ...
  iteratively_deepen(23, &nodes, H(224, 2, pos_history_count), H(224, 2, &pos),
    H(224, 2, stack));
...
S(1) void run() {
  ...
  G(232, char line[4096];)
    G(232, Position pos;)
    G(232, init();)
    G(232, // #ifdef LOWSTACK
      //  SearchStack *stack = malloc(sizeof(SearchStack) * 1024);
      // #else
      SearchStack stack[1024];
  // #endif
    )
    G(232, i32 pos_history_count;)
  ...
  while (true) {
    ...
    if (!strcmp(line, "uci")) {
      ...
      max_time = -1ll;
      iteratively_deepen(max_ply, &nodes, H(224, 3, pos_history_count), H(224, 3, &pos),
        H(224, 3, stack));
    }
...
#endif
    G(233, if (G(235, 'i') == G(235, line[0])) { puts("readyok"); })
    else G(233, if (G(234, line[0]) == G(234, 'g')) {
#ifdef FULL
      while (true) {
        getl(line);
      ...
      iteratively_deepen(max_ply, &nodes, H(224, 4, pos_history_count), H(224, 4, &pos),
        H(224, 4, stack));
#else
      ...
      iteratively_deepen(H(224, 5, pos_history_count), H(224, 5, &pos),
        H(224, 5, stack));
#endif
    })
      ...
      G(238, pos = start_pos;)
        ...
        while (true) {
          ...
          const i32 num_moves =
            movegen(H(103, 4, false), H(103, 4, &pos), H(103, 4, stack[0].moves));
          for (i32 i = 0; i < num_moves; i++) {
            char move_name[8];
            move_str(H(57, 4, pos.flipped), H(57, 4, move_name),
              H(57, 4, &stack[0].moves[i]));
            assert(move_string_equal(line, move_name) ==
              !strcmp(line, move_name));
            if (move_string_equal(G(239, line), G(239, move_name))) {
              stack[pos_history_count].position_hash = get_hash(&pos);
              pos_history_count++;
              if (stack[0].moves[i].takes_piece != None) {
                pos_history_count = 0;
              }
              makemove(H(88, 4, &stack[0].moves[i]), H(88, 4, &pos));
              break;
            }
          }
          if (!line_continue) {
    ...
    else G(233, if (G(236, 'q') == G(236, line[0])) { exit_now(); })
  }
}
