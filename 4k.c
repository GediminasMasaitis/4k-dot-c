...
G(7, [[nodiscard]] S(1) A(3, i8, u8, i16, i32, u32, i64, u64) lsb(u64 bb) { return __builtin_ctzll(bb); })
...
G(32, [[nodiscard]] S(0) u64 bishop(H(43, 1, const u64 blockers), H(43, 1, const u64 bb)) {
  assert(count(bb) == 1);
  const A(3, i8, u8, i16, i32, u32, i64, u64) sq = lsb(bb);
...
G(46, S(1) void swapu32(G(47, u32a* const rhs), G(47, u32a* const lhs)) {
  const u32 temp = *lhs;
  *lhs = *rhs;
  *rhs = temp;
}
...
G(46, S(1) void move_str(H(50, 1, const A(2, bool, u8, i32, u32, i64, u64) flip), H(50, 1, const Move* restrict move), H(50, 1, char* restrict str)) {
  assert(move->from >= 0);
  assert(move->from < 64);
  assert(move->to >= 0);
  assert(move->to < 64);
...
G(46, [[nodiscard]] S(0) A(3, i8, u8, i16, i32, u32, i64, u64)
...
G(57, [[nodiscard]] S(1) A(2, bool, u8, i32, u32, i64, u64) is_attacked(H(58, 1, const Position* const restrict pos), H(58, 1, const u64 bb)) {
  assert(count(bb) == 1);
...
G(57, [[nodiscard]] S(1) u64 get_mobility(H(69, 1, const Position* pos), H(69, 1, const A(5, i8, u8, i16, i32, u32, i64, u64) piece),
...
G(57, S(0) void flip_pos(Position* const restrict pos) {
  ...
  for (A(2, i8, u8, i32, u32, i64, u64) i = 0; i < 10; i++) { pos_ptr[i] = flip_bb(pos_ptr[i]); })
  ...
  for (A(3, i8, u8, i32, u32, i64, u64) piece = Knight; piece <= King; piece++) {
    ...
    while (copy) {
      ...
      G(77, u64 moves = G(78, to_mask) & G(78, get_mobility(H(69, 2, pos), H(69, 2, piece), H(69, 2, from)));)
        ...
        while (moves) {
          const A(1, i8, u8, i16, i32, u32, i64, u64) to = lsb(moves);
          assert(to >= 0);
          assert(to < 64);
...
G(74, S(0) Move* generate_pawn_moves(H(93, 1, u64 to_mask), H(93, 1, const Position* const pos), H(93, 1, Move* restrict movelist),
  ...
  while (to_mask) {
    ...
    to_mask &= to_mask - 1;
    const A(1, i8, u8, i16, i32, u32, i64, u64) from = G(94, to) + G(94, offset);
    assert(from >= 0);
    assert(from < 64);
    assert(to >= 0);
    assert(to < 64);
...
G(74, S(0) A(3, bool, u8, i32, u32, i64, u64) makemove(H(80, 1, Position* const restrict pos), H(80, 1, const Move* const restrict move)) {
  assert(move->from >= 0);
  assert(move->from < 64);
  assert(move->to >= 0);
  assert(move->to < 64);
  ...
  G(81, const u64 from = 1ull << move->from;)
    ...
    G(82, const A(3, i8, u8, i16, i32, u32, i64, u64) piece = piece_on(H(55, 4, pos), H(55, 4, move->from)); assert(piece != None);)
...
typedef struct [[nodiscard]] __attribute__((packed)) {
  i16 material[6];
  H(116, 1, H(117, 1, i8 passed_king_distance[2];) H(117, 1, i8 piece_threats[2];) H(117, 1, i8 pawn_threat[5];) H(117, 1, i8 bishop_pawns[2];)
    H(117, 1, i8 king_shield[2];))
    H(116, 1, H(119, 1, i8 open_files[12];) H(119, 1, i8 mobilities[5];) H(119, 1, i8 passed_blocked_pawns[6];) H(119, 1, i8 pst_file[48];) H(119, 1, i8 pawn_attacked_penalty[2];)
      H(119, 1, i8 tempo;))
    H(116, 1, H(118, 1, i8 bishop_pair;) H(118, 1, i8 passed_pawns[6];) H(118, 1, i8 phalanx_pawn[6];) H(118, 1, i8 protected_pawn[6];) H(118, 1, i8 pst_rank[48];)
      H(118, 1, i8 king_attacks[5];))
} EvalParams;

typedef struct [[nodiscard]] __attribute__((packed)) {
  i32 material[6];
  H(116, 2, H(117, 2, i32 passed_king_distance[2];) H(117, 2, i32 piece_threats[2];) H(117, 2, i32 pawn_threat[5];) H(117, 2, i32 bishop_pawns[2];)
    H(117, 2, i32 king_shield[2];))
    H(116, 2, H(119, 2, i32 open_files[12];) H(119, 2, i32 mobilities[5];) H(119, 2, i32 passed_blocked_pawns[6];) H(119, 2, i32 pst_file[48];)
      H(119, 2, i32 pawn_attacked_penalty[2];) H(119, 2, i32 tempo;))
    H(116, 2, H(118, 2, i32 bishop_pair;) H(118, 2, i32 passed_pawns[6];) H(118, 2, i32 phalanx_pawn[6];) H(118, 2, i32 protected_pawn[6];) H(118, 2, i32 pst_rank[48];)
...
G(121, // EVAL PARAMETERS
  __attribute__((aligned(8))) S(1) C(1) EvalParamsInitial initial_params = { .phases = {0, 0, 1, 1, 2, 4},
                                                                            ...
                                                                            G(121, [[nodiscard]] S(1) A(1, i32, i64) combine_eval_param(H(122, 1, const A(0, i32, i64) mg_val), H(122, 1, const A(1, i32, i64) eg_val)) {
...
S(0) A(1, i16, i32, i64) eval(Position* const restrict pos) {
  G(124, A(0, i32, i64) score = eval_params.tempo;)
    G(124, A(3, i8, u8, i16, i32, i64) phase = 0;)

    for (A(2, i8, u8, i32, u32, i64, u64) c = 0; c < 2; c++) {

      G(125, // BISHOP PAIR
        if (count(G(126, pos->pieces[Bishop]) & G(126, pos->colour[0])) > 1) { score += eval_params.bishop_pair; })

        G(125, u64 pawns[2]; for (A(0, i8, u8, i32, u32, i64, u64) i = 0; i < 2; i++) {
...
[[nodiscard]] __attribute__((target("aes"))) S(1) u64 get_hash(const Position* const pos) {
  ...
  for (A(0, i8, u8, i32, u32, i64, u64) i = 0; i < 6; i++) {
    i128 key;
...
#error "Unsupported architecture: get_hash only for x86_64 and aarch64"
  ...
  u64 hash = 0;
  for (A(2, i8, u8, i32, u32, i64, u64) c = 0; c < 2; c++) {
    for (A(2, i8, u8, i32, u32, i64, u64) p = Pawn; p <= Queen; p++) {
...
search(
  ...
  u64* nodes,
#endif
  H(186, 1, H(187, 1, ThreadData* data), H(187, 1, const A(0, i32, i64) beta), H(187, 1, Position* const pos), H(187, 1, A(0, i32, i64) depth)),
  ...
  depth += in_check;)
    ...
    A(0, bool, i8, u8, i32) in_qsearch = depth <= 0;
  ...
  G(192, ss->best_move = (Move){ 0 };)
    ...
    const A(0, bool, i8, u8, i32) tt_hit = G(200, tt_entry->partial_hash) == G(200, tt_hash_partial);
  if (tt_hit) {
      ...
      G(222, // FORWARD FUTILITY PRUNING / DELTA PRUNING
        if (G(225, depth < 5) &&
          G(225, G(226, G(227, 176) * G(227, depth)) + G(226, static_eval) + G(226, initial_params.eg.material[moves[move_index].promo]) +
            ...
            alpha) &&
          G(225, !in_check) && G(225, moves_evaluated)) {
          break;
        })
...
S(1) void init() {
  G(80, // INIT DIAGONAL MASKS
    for (A(2, i8, u8, i32, u32, i64, u64) sq = 0; sq < 64; sq++) {
      const u64 bb = 1ULL << sq;
...
#ifdef FULL
  for (A(3, i8, u8, i16, i32, u32, i64, u64) depth = 1; depth < maxdepth; depth++) {
#else
  for (A(3, i8, u8, i16, i32, u32, i64, u64) depth = 1; depth < max_ply; depth++) {
#endif
    // ASPIRATION WINDOWS
