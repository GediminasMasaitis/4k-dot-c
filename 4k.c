...
__attribute__((aligned(8))) static const i16 material[] = {79,  308, 290,
                                                           470, 945, 0};
__attribute__((aligned(8))) static const i8 pst_rank[] = {
    0,   -13, -14, -13, -1, 41, 117, 0,   // Pawn
    -36, -19, 0,   15,  26, 28, 9,   -24, // Knight
    -15, -4,  1,   3,   7,  11, 1,   -4,  // Bishop
    -12, -17, -17, -9,  5,  15, 21,  14,  // Rook
    -13, -9,  -9,  -6,  2,  13, 5,   17,  // Queen
    -22, -14, -3,  10,  23, 26, 14,  -18, // King
};
__attribute__((aligned(8))) static const i8 pst_file[] = {
    -2,  3,   -5, -2, 0,  4,  9,  -9,  // Pawn
    -28, -7,  6,  17, 15, 13, 0,  -16, // Knight
    -8,  1,   3,  2,  3,  -2, 4,  -3,  // Bishop
    -2,  0,   4,  5,  3,  6,  -3, -14, // Rook
    -19, -10, 0,  4,  4,  4,  6,  10,  // Queen
    -17, 5,   8,  10, 6,  4,  7,  -14, // King
};
__attribute__((aligned(8))) static const i8 mobilities[] = {0, 0, 4, 2, 2, -2};
    ...
    for (i32 p = Pawn; p <= King; p++) {
      ...
      while (copy) {
        ...
        score += mobilities[p - 1] *
                 count(get_mobility(sq, p == King ? Queen : p, pos) &
                       ~pos->colour[0]);
      }
    }
