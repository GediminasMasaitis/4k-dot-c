...
G(32, S(0) void flip_pos(Position* const restrict pos) {
...
typedef struct [[nodiscard]] __attribute__((packed)) {
  i16 material[6];
  H(69, 1, H(70, 1, i8 passed_pawns[6];) H(70, 1, i8 king_attacks[5];)
...
typedef struct [[nodiscard]] __attribute__((packed)) {
  i32 material[6];
  H(69, 2, H(70, 2, i32 passed_pawns[6];) H(70, 2, i32 king_attacks[5];)
...
G(76, __attribute__((aligned(8))) S(1)
  ...
  G(77, i32 score = eval_params.tempo;)
    ...
    for (i32 c = 0; c < 2; c++) {
      ...
      G(78, const u64 opp_pawns = G(79, pos->colour[1]) & G(79, pos->pieces[Pawn]);
      ...
      const u64 no_passers = G(81, opp_pawns) | G(81, attacked_by_pawns);)
        ...
        G(78, const u64 own_pawns = G(82, pos->pieces[Pawn]) & G(82, pos->colour[0]);)
        ...
        for (i32 p = Pawn; p <= King; p++) {
          ...
          while (copy) {
            ...
            G(85, const int file = sq & 7;)
              ...
              G(62, // PASSED PAWNS
                if (G(94, !(G(95, (0x101010101010101ULL << sq)) & G(95, no_passers))) &&
                  G(94, p == Pawn)) {
                  G(96, if (north(1ULL << sq) & pos->colour[1]) {
...
#error "Unsupported architecture: get_hash only for x86_64 and aarch64"
  ...
  S(1)
  i16 search(H(99, 1, const i32 ply), H(99, 1, i32 alpha),
    H(99, 1, i32 depth), H(99, 1, Position* const restrict pos),
  ...
  if (G(107, !in_check) && G(107, alpha == beta - 1)) {
    ...
    // NULL MOVE PRUNING
    if (G(110, do_null) && G(110, depth > 2) && G(110, static_eval >= beta)) {
      Position npos = *pos;
      G(111, flip_pos(&npos);)
        G(111, npos.ep = 0;)
        const i32 score = -search(
          H(99, 2, ply + 1), H(99, 2, -beta), H(99, 2, depth - 3 - depth / 4),
          H(99, 2, &npos), H(100, 2, stack),
#ifdef FULL
          nodes,
#endif
  ...
  G(99, i32 moves_evaluated = 0;)
    ...
    for (i32 move_index = 0; move_index < stack[ply].num_moves; move_index++) {
      ...
      if (G(117, depth < 8) &&
        G(117, G(118, static_eval + 136 * depth) +
          G(118, max_material[stack[ply].moves[move_index].promo]) +
          G(118, max_material[stack[ply].moves[move_index].takes_piece]) <
          alpha) &&
      ...
      while (true) {
        score = -search(
          H(99, 3, ply + 1), H(99, 3, low), H(99, 3, depth - G(121, 1) - G(121, reduction)),
          H(99, 3, &npos), H(100, 3, stack),
#ifdef FULL
          nodes,
#endif
        ...
        if (score > alpha) {
          G(122, tt_flag = Exact;)
            ...
            if (score >= beta) {
              ...
              G(123, tt_flag = Lower;)
                G(123, if (stack[ply].best_move.takes_piece == None) {
                ...
                *this_hist += bonus - bonus * *this_hist / 1024;)
                  G(124, for (i32 prev_index = 0; prev_index < move_index;
                    prev_index++) {
...
#endif
    i32 score =
      search(H(99, 4, 0), H(99, 4, -inf), H(99, 4, depth), H(99, 4, pos),
        H(100, 4, stack),
#ifdef FULL
        nodes,
#endif
