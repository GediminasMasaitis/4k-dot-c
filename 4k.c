...
G(
    35, [[nodiscard]] S(1) u64 knight(const u64 bb) {
      G(800, const u64 east_bb = east(bb);)
      G(800, const u64 west_bb = west(bb);)
      G(801, const u64 horizontal1 = G(804, west_bb) | G(804, east_bb);)
      G(801,
        const u64 horizontal2 = G(805, east(east_bb)) | G(805, west(west_bb));)
      return G(802, horizontal2 << 8) | G(802, horizontal1 >> 16) |
             G(802, horizontal1 << 16) | G(802, horizontal2 >> 8);
    })

G(
    35, [[nodiscard]] S(1) u64 king(const u64 bb) {
      const u64 vertical = G(803, north(bb)) | G(803, south(bb));
      const u64 vertical_inclusive = G(806, bb) | G(806, vertical);
      return G(807, vertical) | G(807, east(vertical_inclusive)) |
             G(807, west(vertical_inclusive));
    })
...
G(
    55, S(1) void move_str(H(62, 1, char *restrict str),
      ...
      G(
          63, // Hack to save bytes, technically UB but works on GCC 14.2
          for (i32 i = 0; i < 2; i++) {
...
G(
    ...
    [[nodiscard]] S(1) i32 is_attacked(H(68, 1,
      ...
      return G(70, G(71, (G(72, sw(pawns)) | G(72, se(pawns)))) & G(71, bb)) ||
             ...
             G(70,
               G(75, knight(bb)) & G(75, theirs) & G(75, pos->pieces[Knight]));
    })
...
typedef struct [[nodiscard]] __attribute__((packed)) {
  ...
  H(129, 1,
    H(131, 1, i8 passed_pawns[6];) H(131, 1, i8 king_attacks[5];)
...
typedef struct [[nodiscard]] __attribute__((packed)) {
  ...
  H(129, 2,
    H(131, 2, i32 passed_pawns[6];) H(131, 2, i32 king_attacks[5];)
