...
__attribute__((aligned(8))) static const i16 material[] = {77,  307, 290,
                                                           470, 943, 0};
__attribute__((aligned(8))) static const i8 pst_rank[] = {
    0,   -12, -13, -13, -1, 40, 115, 0,   // Pawn
    -35, -19, 2,   16,  26, 27, 8,   -25, // Knight
    -14, -4,  3,   3,   7,  10, 0,   -5,  // Bishop
    -9,  -17, -16, -9,  5,  14, 20,  13,  // Rook
    -11, -9,  -7,  -6,  2,  12, 4,   15,  // Queen
    -25, -10, -2,  10,  22, 28, 19,  -20, // King
};
__attribute__((aligned(8))) static const i8 pst_file[] = {
    -2,  3,   -4, -2, 0,  5,  10, -9,  // Pawn
    -28, -7,  6,  16, 15, 14, 0,  -16, // Knight
    -8,  1,   2,  1,  3,  -1, 4,  -3,  // Bishop
    -3,  0,   3,  5,  4,  6,  -2, -13, // Rook
    -19, -10, 0,  3,  4,  5,  7,  10,  // Queen
    -18, 7,   6,  6,  3,  2,  9,  -15, // King
};
__attribute__((aligned(8))) static const i8 mobilities[] = {5, 0, 5, 2, 2, -4};
