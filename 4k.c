...
typedef struct [[nodiscard]] __attribute__((packed)) {
  i16 material[6];
  H(116, 1, H(118, 1, i8 phalanx_pawn;) H(118, 1, i8 passed_pawns[6];)
...
typedef struct [[nodiscard]] __attribute__((packed)) {
  i32 material[6];
  H(116, 2, H(118, 2, i32 phalanx_pawn;) H(118, 2, i32 passed_pawns[6];)
...
i32 search(
  ...
  G(242, // UPDATE CORRECTION HISTORY
    if (G(243, G(245, stack[ply].best_move.takes_piece) == G(245, None)) &&
      G(243, G(244, tt_flag) != G(244, (best_score < stack[ply].static_eval)))) {
