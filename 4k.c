...
G(121, // EVAL PARAMETERS
  __attribute__((aligned(8))) S(1)
      const EvalParamsInitial initial_params = {
          .phases = {0, 0, 1, 1, 2, 4},
          .mg = {.material = {0, 68, 287, 329, 380, 837},
                 .pst_rank =
                     {
                         0,   -15, -17, -5,  7,  30, 127, 0,   // Pawn
                         -16, -3,  10,  23,  27, 36, 17,  -93, // Knight
                         -8,  8,   14,  17,  18, 18, -4,  -64, // Bishop
                         4,   -5,  -10, -13, 3,  13, 1,   8,   // Rook
                         16,  16,  9,   0,   -4, -3, -20, -14, // Queen
                         -7,  0,   -9,  -23, -6, 39, 46,  45,  // King
                     },
                 .pst_file =
                     {
                         -7,  -11, -7,  1,   7,   12,  12, -7,  // Pawn
                         -29, -10, -1,  12,  13,  14,  5,  -5,  // Knight
                         -14, 0,   3,   1,   4,   -1,  11, -4,  // Bishop
                         -12, -8,  -2,  7,   12,  8,   6,  -11, // Rook
                         -14, -8,  -4,  0,   3,   4,   12, 6,   // Queen
                         -10, 15,  -10, -27, -26, -10, 11, 1,   // King
                     },
                 .mobilities = {6, 5, 2, 3, -2},
                 .king_attacks = {9, 13, 19, 14, 0},
                 .pawn_threat = {-19, -8, -8, -8, -1},
                 .open_files = {10, -10, -11, 16, -2, -22, 8, -11, -13, 33, -13,
                                -56},
                 .passed_pawns = {-8, -1, 10, 42, 78, 127},
                 .passed_blocked_pawns = {1, -4, -2, 5, 3, -49},
                 ...
                 .tempo = 28},
          .eg = {.material = {0, 88, 401, 441, 736, 1366},
                 .pst_rank =
                     {
                         0,   -4,  -9,  -8, 0,  20, 94, 0,   // Pawn
                         -32, -20, -8,  16, 23, 8,  2,  11,  // Knight
                         -13, -11, 0,   4,  6,  2,  3,  8,   // Bishop
                         -17, -17, -10, 4,  10, 9,  17, 4,   // Rook
                         -58, -41, -13, 14, 29, 24, 30, 14,  // Queen
                         -35, -4,  4,   18, 30, 29, 17, -38, // King
                     },
                 .pst_file =
                     {
                         ...
                         -23, -8, 3,  8,  15, 14, 0,  -10, // Queen
                         -28, -2, 9,  15, 18, 13, 4,  -28, // King
                     },
                 .mobilities = {5, 3, 3, 2, -3},
                 .king_attacks = {-5, -2, -7, 9, 0},
