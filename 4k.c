...
typedef struct [[nodiscard]] __attribute__((packed)) {
  i16 material[6];
  H(116, 1, H(117, 1, i8 king_shield[2];) H(117, 1, i8 passed_king_distance[2];) H(117, 1, i8 bishop_pawns[2];) H(117, 1, i8 pawn_threat[5];))
  H(116, 1,
    H(119, 1, i8 pawn_attacked_penalty[2];) H(119, 1, i8 passed_blocked_pawns[6];) H(119, 1, i8 mobilities[15];) H(119, 1, i8 pst_file[48];) H(119, 1, i8 tempo;)
...
typedef struct [[nodiscard]] __attribute__((packed)) {
  i32 material[6];
  H(116, 2, H(117, 2, i32 king_shield[2];) H(117, 2, i32 passed_king_distance[2];) H(117, 2, i32 bishop_pawns[2];) H(117, 2, i32 pawn_threat[5];))
  H(116, 2,
    H(119, 2, i32 pawn_attacked_penalty[2];) H(119, 2, i32 passed_blocked_pawns[6];) H(119, 2, i32 mobilities[15];) H(119, 2, i32 pst_file[48];)
...
G(
    ...
    __attribute__((aligned(8))) S(1) C(1) EvalParamsInitial initial_params = {.phases = {0, 0, 1, 1, 2, 4},
                                                                              .mg =
                                                                                  {
                                                                                      .material = {0, 68, 289, 331, 383, 841},
                                                                                      .pst_rank =
                                                                                          {
                                                                                              0,   -15, -18, -4,  6,  30, 126, 0,   // Pawn
                                                                                              -17, -2,  12,  26,  27, 31, 8,   -86, // Knight
                                                                                              -8,  11,  16,  19,  17, 16, -11, -59, // Bishop
                                                                                              7,   -2,  -8,  -11, 4,  13, -2,  1,   // Rook
                                                                                              14,  17,  9,   2,   -3, -3, -21, -14, // Queen
                                                                                              -8,  1,   -9,  -22, -4, 39, 45,  46,  // King
                                                                                          },
                                                                                      .pst_file =
                                                                                          {
                                                                                              -7,  -11, -7,  1,   6,   12,  12, -6,  // Pawn
                                                                                              -29, -9,  -1,  12,  13,  14,  5,  -6,  // Knight
                                                                                              -14, 0,   3,   1,   4,   -1,  10, -4,  // Bishop
                                                                                              -12, -7,  -2,  7,   12,  8,   6,  -12, // Rook
                                                                                      ...
                                                                                      .passed_blocked_pawns = {-1, -6, -3, 3, 3, -48},
                                                                              ...
                                                                              .eg = {
                                                                                  .material = {0, 86, 408, 444, 740, 1370},
                                                                                  .pst_rank =
                                                                                      {
                                                                                          0,   0,   -7,  -6, -1, 14, 94, 0,   // Pawn
                                                                                          -31, -19, -8,  14, 22, 9,  4,  8,   // Knight
                                                                                          -12, -10, 0,   3,  6,  2,  5,  7,   // Bishop
                                                                                          -17, -18, -10, 4,  10, 9,  17, 5,   // Rook
                                                                                          -53, -38, -11, 13, 27, 23, 27, 12,  // Queen
                                                                                          -35, -3,  4,   18, 31, 31, 19, -39, // King
                                                                                      },
                                                                                  .pst_file =
                                                                                      {
                                                                                          2,   7,  -1, -7, -1, 1,  1,  -3,  // Pawn
                                                                                          -19, -6, 8,  17, 17, 4,  -2, -21, // Knight
