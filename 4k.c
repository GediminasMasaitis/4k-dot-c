...
G(
    32, [[nodiscard]] S(1) u64 get_mobility(H(33, 1, const Position *pos),
      ...
      G(34, if (piece == King) { moves = king(bb); })
        ...
        G(
            35, if (G(36, piece == Bishop) || G(36, piece == Queen)) {
              moves |= bishop(H(21, 2, blockers), H(21, 2, bb));
            })
        G(
            35, if (G(37, piece == Rook) || G(37, piece == Queen)) {
...
typedef struct [[nodiscard]] __attribute__((packed)) {
  i16 material[6];
  H(67, 1,
    H(68, 1, i8 king_attacks[5];) H(68, 1, i8 passed_blocked_pawns[4];)
        H(68, 1, i8 mobilities[5];) H(68, 1, i8 passed_pawns[4];)
            H(68, 1, i8 tempo;))
  H(67, 1,
...
typedef struct [[nodiscard]] __attribute__((packed)) {
  i32 material[6];
  H(67, 2,
    H(68, 2, i32 king_attacks[5];) H(68, 2, i32 passed_blocked_pawns[4];)
        H(68, 2, i32 mobilities[5];) H(68, 2, i32 passed_pawns[4];)
            H(68, 2, i32 tempo;))
  H(67, 2,
      ...
      while (copy) {
        ...
        G(
            ...
            if (G(85, p == Pawn) &&
              ...
              G(87, score += eval_params.passed_pawns[rank - 3];)
            })
...
i16 search(H(95, 1, Position *const restrict pos), H(95, 1, const i32 ply),
  ...
  if (G(103, !in_check) && G(103, alpha == beta - 1)) {
    ...
    // NULL MOVE PRUNING
    if (G(106, static_eval >= beta) &&
        G(106, pos->colour[0] & ~pos->pieces[Pawn] & ~pos->pieces[King]) &&
        G(106, do_null) && G(106, depth > 2)) {
      Position npos = *pos;
      flip_pos(&npos);
      npos.ep = 0;
    ...
    if (G(111, depth < 8) &&
        G(111,
          G(112, max_material[stack[ply].moves[move_index].promo]) +
              ...
              alpha) &&
        G(111, !in_check) && G(111, moves_evaluated)) {
      break;
    }
