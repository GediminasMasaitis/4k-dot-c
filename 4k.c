      ...
      C(1)
          EvalParamsInitial initial_params =
              {.phases = {0, 0, 1, 1, 2, 4},
               .mg =
                   {
                       .material = {0, 68, 292, 330, 381, 845},
                       .pst_rank =
                           {
                               0,   -15, -18, -4,  6,  30, 125, 0,   // Pawn
                               -20, -6,  9,   23,  31, 36, 12,  -84, // Knight
                               -7,  11,  14,  18,  17, 16, -9,  -60, // Bishop
                               8,   -1,  -10, -13, 2,  12, -1,  2,   // Rook
                               12,  14,  9,   1,   -3, -2, -20, -12, // Queen
                               -9,  0,   -9,  -21, -2, 40, 45,  43,  // King
                           },
                       .pst_file =
                           {
                               -7,  -12, -8,  1,   7,   12,  12, -6,  // Pawn
                               -30, -11, -1,  12,  14,  14,  7,  -6,  // Knight
                               -13, 0,   3,   1,   4,   -1,  10, -3,  // Bishop
                               -12, -8,  -2,  7,   13,  8,   6,  -11, // Rook
                               -15, -8,  -4,  0,   3,   5,   14, 5,   // Queen
                               -11, 16,  -11, -29, -28, -11, 11, 1,   // King
                           },
                       .mobilities = {6, 5, 2, 3, -3},
                       .king_attacks = {0, 13, 20, 14, 0},
                       .pawn_threat = {-16, -8, -7, -8, -1},
                       .open_files = {8,
                                      -11, -11, 17, -2, -22, 7, -10, -11, 33, -11, -57},
                       .passed_pawns = {-9, -2, 9, 41, 76, 125},
                       .passed_blocked_pawns = {-1, -5, -4, 3, 3, -48},
                       .passed_king_distance = {-1, -2},
                       .protected_pawn = {0, 20, 12, 19, 32, 127},
                       .phalanx_pawn = {7, 12, 21, 38, 127, 127},
                       .protected_piece = {-2, 4, 5, -7, -20},
                       .bishop_pair = 26,
                       .bishop_pawns = {-5, -5},
                       .king_shield = {28, 18},
               ...
               .eg =
                   {
                       .material = {0, 85, 404, 438, 740, 1374},
                       .pst_rank =
                           {
                               0,   -1,  -7,  -6, -1, 15, 93, 0,   // Pawn
                               -26, -15, -8,  14, 19, 6,  3,  8,   // Knight
                               -8,  -7,  -2,  -1, 1,  0,  5,  12,  // Bishop
                               -16, -17, -10, 3,  9,  9,  17, 5,   // Rook
                               -53, -38, -15, 11, 27, 24, 30, 14,  // Queen
                               -34, -3,  3,   16, 28, 28, 18, -37, // King
                           },
                       .pst_file =
                           {
                               3,   6,  -1, -7, -1, 1,  1,  -2,  // Pawn
                               -16, -5, 7,  17, 16, 3,  -3, -19, // Knight
                               -7,  -2, 4,  9,  9,  3,  -6, -11, // Bishop
                               1,   6,  6,  -3, -6, 0,  0,  -4,  // Rook
                               -21, -8, 3,  8,  15, 14, -2, -9,  // Queen
                               -27, -2, 11, 17, 19, 14, 3,  -28, // King
                           },
                       .mobilities = {5, 4, 4, 2, -3},
                       .king_attacks = {0, -3, -7, 8, 0},
                       .pawn_threat = {-2, -5, -17, -13, -6},
                       .open_files = {7, 1, 16, 8, 23, 6, 23, -8, 2, 12, 42, 6},
                       .passed_pawns = {14, 3, 20, 46, 100, 93},
                       .passed_blocked_pawns = {-14, -7, -17, -32, -67, -70},
                       .passed_king_distance = {-5, 9},
                       .protected_pawn = {0, 17, 16, 19, 47, 22},
                       .phalanx_pawn = {5, 15, 25, 81, 127, 127},
                       .protected_piece = {9, 17, 6, 17, 18},
                       .bishop_pair = 59,
                       .bishop_pawns = {-12, -1},
                       .king_shield = {-8, -7},
    ...
    for (i32 p = Pawn; p <= King; p++) {
      ...
      while (copy) {
        ...
        if (p > Pawn &&
          ...
          score += eval_params.protected_piece[p - 2];
        }
