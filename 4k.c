...
i32 search(
  ...
  if (G(195, !in_check) && G(195, G(196, alpha) == G(196, beta - 1))) {
    if (G(197, depth < 9) && G(197, !in_qsearch)) {
      ...
      G(198, // RAZORING
        in_qsearch =
            G(200, static_eval) + G(200, G(201, 111) * G(201, depth)) <= alpha;)
    }
  ...
  for (i32 move_index = 0; move_index < stack[ply].num_moves; move_index++) {
    ...
    for (i32 order_index = move_index; order_index < stack[ply].num_moves;
      ...
      const i32 order_move_score =
          ...
          G(179, // MOST VALUABLE VICTIM
            G(210, moves[order_index].takes_piece) * G(210, 617)) +
    ...
    G(
        ...
        if (G(217, depth < 9) &&
            G(217,
              G(218, static_eval) + G(218, G(219, 148) * G(219, depth)) +
                      G(218,
    ...
    i32 reduction = G(220, depth > 3) && G(220, move_score <= 0)
                        ? G(221, !improving) + G(221, (move_score / -334)) +
  ...
  G(
      ...
      if (G(236,
        ...
        G(237, i32 dd = depth * depth; if (dd > 66) { dd = 66; })
        G(237, i32 target = best_score - stack[ply].static_eval; G(
              239, if (target < -102) { target = -102; })
              G(239, if (target > 102) { target = 102; }))
