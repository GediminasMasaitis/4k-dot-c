...
typedef struct [[nodiscard]] __attribute__((packed)) {
  ...
  H(116, 1,
    H(118, 1, i8 protected_pawn[6];) H(118, 1, i8 passed_pawns[6];)
        H(118, 1, i8 phalanx_pawn[6];) H(118, 1, i8 bishop_pair;)
...
typedef struct [[nodiscard]] __attribute__((packed)) {
  ...
  H(116, 2,
    H(118, 2, i32 protected_pawn[6];) H(118, 2, i32 passed_pawns[6];)
        H(118, 2, i32 phalanx_pawn[6];) H(118, 2, i32 bishop_pair;)
...
G(121,
  __attribute__((aligned(8))) S(1)
      const EvalParamsInitial initial_params = {.phases = {0, 0, 1, 1, 2, 4},
                                                .mg = {.material = {0, 65, 283, 320, 372, 821},
.pst_rank = {0, -13, -17, -4, 7, 28, 96, 0, // Pawn
-17, -6, 6, 18, 27, 39, 18, -85, // Knight
-5, 10, 14, 16, 15, 14, -5, -59, // Bishop
7, -4, -10, -14, 1, 12, 0, 6, // Rook
18, 18, 9, -1, -7, -4, -23, -11, // Queen
-12, -8, -18, -22, 9, 60, 66, 83, // King
},
.pst_file = {-11, -12, -7, 3, 8, 13, 12, -7, // Pawn
-27, -11, -1, 12, 13, 13, 6, -4, // Knight
-13, 0, 3, 1, 4, -1, 10, -4, // Bishop
-11, -8, -3, 7, 11, 8, 5, -9, // Rook
-13, -8, -4, 1, 3, 4, 11, 7, // Queen
-13, 13, -11, -28, -26, -12, 12, 4, // King
},
.mobilities = {6, 5, 2, 2, -2},
.king_attacks = {0, 14, 19, 14, 0},
.pawn_threat = {-14, -6, -7, -7, -1},
.open_files = {6, -9, -10, 16, -1, -24, 8, -12, -14, 33, -12, -57},
.passed_pawns = {-7, -10, -8, 12, 35, 96},
.passed_blocked_pawns = {-1, -3, 4, 12, 13, -41},
.protected_pawn = {0, 19, 11, 17, 35, 127},
.phalanx_pawn = {7, 12, 21, 41, 127, 127},
.bishop_pair = 26,
.bishop_pawns = {-5, -5},
.king_shield = {28, 18},
                                                       .pawn_attacked_penalty =
                                                           {-16, -128},
                                                       .tempo = 17},
                                                .eg = {.material = {0, 86, 393, 431, 721, 1340},
.pst_rank = {0, -2, -8, -7, -1, 18, 103, 0, // Pawn
-33, -21, -7, 17, 22, 9, 3, 9, // Knight
-16, -14, -1, 4, 8, 5, 4, 9, // Bishop
-17, -20, -11, 4, 11, 10, 17, 5, // Rook
-59, -43, -14, 13, 31, 26, 32, 14, // Queen
-42, -1, 7, 19, 29, 28, 14, -56, // King
},
.pst_file = {12, 11, -1, -11, -6, -2, 0, -4, // Pawn
-20, -5, 8, 16, 16, 5, -1, -20, // Knight
-11, 0, 5, 10, 10, 4, -4, -14, // Bishop
1, 6, 6, -2, -5, 0, 0, -6, // Rook
-23, -7, 4, 7, 14, 14, 0, -10, // Queen
-33, 4, 18, 26, 25, 16, 3, -41, // King
},
.mobilities = {4, 3, 4, 2, -6},
.king_attacks = {0, -3, -7, 8, 0},
.pawn_threat = {-3, -5, -17, -14, -8},
.open_files = {21, 0, 13, 5, 21, 13, 23, -8, 2, 12, 42, 10},
.passed_pawns = {8, 16, 40, 66, 114, 103},
.passed_blocked_pawns = {-10, -8, -31, -59, -109, -114},
.protected_pawn = {0, 16, 14, 16, 30, -29},
.phalanx_pawn = {5, 14, 24, 76, 127, 127},
.bishop_pair = 61,
.bishop_pawns = {-11, -1},
.king_shield = {-10, -8},
                                                       .pawn_attacked_penalty =
    ...
    for (i32 p = Pawn; p <= King; p++) {
      ...
      while (copy) {
        ...
        if (p == Pawn) {
          ...
          if (piece_bb & (northeast(pawns[0]) | northwest(pawns[0]))) {
