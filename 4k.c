...
typedef struct [[nodiscard]] __attribute__((packed)) {
  ...
  H(124, 1,
    ...
    H(125, 1, i8 mobilities[5];)
    H(125, 1, i8 tempo;)
    H(125, 1, i8 open_files[6];)
    H(125, 1, i8 pst_file[48];)
    H(125, 1, i8 passed_blocked_pawns[6];))
  H(124, 1,
    H(126, 1, i8 bishop_pair;)
    H(126, 1, i8 protected_pawn;)
    H(126, 1, i8 pst_rank[48];)
    H(126, 1, i8 passed_pawns[6];)
    H(126, 1, i8 king_attacks[5];)
    H(126, 1, i8 phalanx_pawn;))
} EvalParams;
...
typedef struct [[nodiscard]] __attribute__((packed)) {
  ...
  H(124, 2,
    ...
    H(125, 2, i32 mobilities[5];)
    H(125, 2, i32 tempo;)
    H(125, 2, i32 open_files[6];)
    H(125, 2, i32 pst_file[48];)
    H(125, 2, i32 passed_blocked_pawns[6];))
  H(124, 2,
    H(126, 2, i32 bishop_pair;)
    H(126, 2, i32 protected_pawn;)
      ...
      G(135,
        const u64 no_passers = G(136, opp_pawns) | G(136, attacked_by_pawns);)
          G(135, // PROTECTED PAWNS
            score -=
            G(999, eval_params.protected_pawn) *
            G(999, count(G(998, opp_pawns) & G(998, attacked_by_pawns)));)
              G(135, // PHALANX PAWNS
                score -=
                G(997, eval_params.phalanx_pawn) *
                G(997, count(G(996, opp_pawns) & G(996, west(opp_pawns))));))
    G(
        132, // BISHOP PAIR
            ...
            101, if (p > Pawn) {
              ...
              G(147, const u64 mobility =
                         G(149, get_mobility(H(75, 3, pos), H(75, 3, sq),
                                             H(75, 3, p))) &
                         G(149, G(150, ~pos->colour[0]));

                G(151, // MOBILITY
                  score +=
                  G(152, count(G(150, mobility) & G(150, ~attacked_by_pawns))) *
