...
typedef struct [[nodiscard]] __attribute__((packed)) {
  i16 material[6];
  H(116, 1,
    H(118, 1, i8 king_shield[2];) H(118, 1, i8 pawn_threat[6];)
...
typedef struct [[nodiscard]] __attribute__((packed)) {
  i32 material[6];
  H(116, 2,
    H(118, 2, i32 king_shield[2];) H(118, 2, i32 pawn_threat[6];)
