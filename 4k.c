...
__attribute__((aligned(8))) static const i16 material[] = {77,  308, 290,
                                                           471, 936, 0};
__attribute__((aligned(8))) static const i8 pst_rank[] = {
    0,   -13, -14, -13, -1, 40, 116, 0,   // Pawn
    -35, -19, 2,   15,  26, 28, 8,   -25, // Knight
    -14, -4,  3,   4,   7,  10, 0,   -6,  // Bishop
    -9,  -17, -16, -8,  5,  14, 19,  12,  // Rook
    -4,  -2,  -1,  -1,  3,  7,  -2,  0,   // Queen
    -25, -8,  0,   11,  23, 29, 20,  -20, // King
};
__attribute__((aligned(8))) static const i8 pst_file[] = {
    ...
    -14, -6, 2,  5,  5,  3,  3,  1,   // Queen
    -19, 7,  6,  6,  4,  3,  9,  -16, // King
};
