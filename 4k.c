...
G(121, // EVAL PARAMETERS
  __attribute__((aligned(8))) S(1)
      const EvalParamsInitial initial_params = {
          .phases = {0, 0, 1, 1, 2, 4},
          .mg = {.material = {0, 68, 288, 330, 381, 832},
                 .pst_rank =
                     {
                         0,   -14, -16, -5,  6,   29, 126, 0,   // Pawn
                         -16, -6,  7,   21,  30,  40, 18,  -92, // Knight
                         -8,  7,   13,  16,  19,  22, -4,  -65, // Bishop
                         -2,  -9,  -13, -16, 0,   13, 11,  18,  // Rook
                         9,   6,   5,   -1,  -2,  5,  -15, -7,  // Queen
                         1,   -4,  -17, -33, -12, 32, 37,  39,  // King
                     },
                 .pst_file =
                     {
                         -8,  -12, -7,  1,   8,   12,  12, -7, // Pawn
                         -31, -11, -1,  12,  14,  14,  8,  -5, // Knight
                         -15, 0,   4,   1,   4,   -2,  10, -2, // Bishop
                         -15, -10, -3,  7,   13,  8,   10, -9, // Rook
                         -16, -9,  -6,  -4,  -1,  5,   16, 14, // Queen
                         -13, 8,   -14, -30, -27, -13, 13, 7,  // King
                     },
                 .mobilities = {6, 6, 3, 3, -2},
                 .king_attacks = {0, -1, 2, 4, 0},
                 .pawn_threat = {-17, -9, -7, -7, 2},
                 .open_files = {10, -10, -11, 17, -2, -22, 8, -11, -13, 35, -13,
                                -58},
                 .passed_pawns = {-8, -1, 11, 42, 78, 126},
                 .passed_blocked_pawns = {2, -3, -2, 6, 4, -45},
                 ...
                 .tempo = 28},
          .eg = {.material = {0, 88, 399, 441, 732, 1354},
                 .pst_rank =
                     {
                         0,   -4,  -9,  -8, 0,  20, 94, 0,   // Pawn
                         -31, -18, -6,  17, 21, 6,  1,  10,  // Knight
                         -13, -12, 0,   5,  7,  1,  3,  9,   // Bishop
                         -17, -15, -9,  6,  11, 9,  14, 1,   // Rook
                         -88, -49, -16, 18, 36, 31, 42, 26,  // Queen
                         -39, -4,  5,   19, 30, 29, 17, -39, // King
                     },
                 .pst_file =
                     {
                         2,   7,   0,  -6, -1, 2,  1,  -3,  // Pawn
                         -17, -4,  7,  16, 15, 3,  -2, -19, // Knight
                         -10, -1,  4,  10, 10, 5,  -3, -15, // Bishop
                         2,   6,   5,  -3, -6, 1,  -1, -5,  // Rook
                         -24, -10, 0,  7,  15, 17, 4,  -9,  // Queen
                         -27, 0,   11, 17, 18, 14, 3,  -29, // King
                     },
                 .mobilities = {5, 3, 3, 1, -3},
                 .king_attacks = {0, 1, 0, 10, 0},
                 .pawn_threat = {-2, -5, -18, -14, -8},
                 .open_files = {8, 3, 17, 9, 28, 8, 22, -8, 1, 12, 45, 7},
                 .passed_pawns = {15, 3, 21, 49, 101, 94},
                 .passed_blocked_pawns = {-11, -2, -13, -32, -68, -72},
...
S(0) i32 eval(Position *const restrict pos) {
  ...
  for (i32 c = 0; c < 2; c++) {
    ...
    G(125,
      u64 opp_king_zone = G(127, pos->colour[1]) & G(127, pos->pieces[King]);
