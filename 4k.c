...
G(
    46, S(1) void move_str(H(50, 1, const A(1, bool, i8, u8, i16, u16, i32, u32, i64, u64) flip), H(50, 1, const Move *restrict move),
...
G(
    ...
    __attribute__((aligned(8))) S(1) C(1) EvalParamsInitial initial_params = {.phases = {0, 0, 1, 1, 2, 4},
                                                                              .mg =
                                                                                  {
                                                                                      .material = {0, 71, 254, 307, 338, 649},
                                                                                      .pst_rank =
                                                                                          {
                                                                                              0,   -26, -36, -9,  14,   56,   -24,  0,   // Pawn
                                                                                              -42, -17, -1,  18,  30,   48,   36,   -72, // Knight
                                                                                              -13, 4,   11,  13,  7,    24,   -1,   -45, // Bishop
                                                                                              1,   -8,  -9,  -14, 7,    23,   -5,   4,   // Rook
                                                                                              2,   13,  -1,  -5,  -8,   7,    -1,   -7,  // Queen
                                                                                              127, 123, 61,  -86, -128, -128, -128, -78, // King
                                                                                          },
                                                                                      .pst_file =
                                                                                          {
                                                                                              -14, -14, -12, 2,   7,   13,  15, 1,  // Pawn
                                                                                              -35, -10, -5,  12,  17,  16,  9,  -4, // Knight
                                                                                              -13, 6,   2,   -4,  1,   -7,  11, 4,  // Bishop
                                                                                              -19, -13, -6,  7,   15,  1,   17, -2, // Rook
                                                                                              -17, -10, -11, -1,  1,   4,   17, 18, // Queen
                                                                                              -7,  22,  -13, -38, -31, -18, 18, 12, // King
                                                                                          },
                                                                                      .mobilities = {7, 6, 3, 3, -4},
                                                                                      .king_attacks = {0, 13, 26, 10, 0},
                                                                                      .pawn_threat = {-20, -9, -9, -10, 6},
                                                                                      .open_files = {20, -17, -12, 16, 0, -20, 20, -14, -14, 27, -17, -71},
                                                                                      .passed_pawns = {-11, -34, -46, -60, -112, -24},
                                                                                      .passed_blocked_pawns = {-16, -25, -21, -17, -7, -64},
                                                                                      .passed_king_distance = {7, -2},
                                                                                      .protected_pawn = {0, 21, 8, 12, 14, 100},
                                                                                      .phalanx_pawn = {7, 21, 22, 30, 127, 127},
                                                                                      .bishop_pair = 38,
                                                                                      .bishop_pawns = {-10, -5},
                                                                                      .king_shield = {23, 16},
                                                                                      .pawn_attacked_penalty = {-62, -43},
                                                                                      .piece_threats = {25, 18},
                                                                                      .tempo = 40,
                                                                                  },
                                                                              .eg = {
                                                                                  .material = {0, 140, 654, 735, 1134, 2269},
                                                                                  .pst_rank =
                                                                                      {
                                                                                          0,   5,   -9,  -12, -7, 24,  127, 0,   // Pawn
                                                                                          -16, -17, -6,  27,  34, 1,   -9,  -14, // Knight
                                                                                          -12, -8,  5,   4,   14, -1,  -8,  7,   // Bishop
                                                                                          -15, -21, -17, -2,  5,  3,   30,  17,  // Rook
                                                                                          -29, -29, 2,   17,  39, 36,  10,  -46, // Queen
                                                                                          -70, -19, 13,  72,  98, 127, 127, -55, // King
                                                                                      },
                                                                                  .pst_file =
                                                                                      {
                                                                                          -2,  10, 5,  -4, 2,   8,  0,   -19, // Pawn
                                                                                          -8,  -2, 12, 22, 12,  -2, -8,  -26, // Knight
                                                                                          -11, -8, 4,  22, 17,  12, -2,  -34, // Bishop
                                                                                          15,  15, 16, -6, -13, 7,  -17, -19, // Rook
                                                                                          -15, -4, 13, 6,  13,  7,  -7,  -15, // Queen
                                                                                          -51, 5,  38, 47, 28,  23, -3,  -67, // King
                                                                                      },
                                                                                  .mobilities = {13, 5, 6, 4, -4},
                                                                                  .king_attacks = {0, 3, -22, 26, 0},
                                                                                  .pawn_threat = {-11, -13, -21, -27, -19},
                                                                                  .open_files = {2, 12, 9, 20, 36, -9, 29, 5, 2, 34, 61, -10},
                                                                                  .passed_pawns = {4, -9, 9, 48, 112, 127},
                                                                                  .passed_blocked_pawns = {-19, 10, -10, -25, -62, -64},
                                                                                  .passed_king_distance = {-5, 10},
                                                                                  .protected_pawn = {0, 30, 31, 32, 109, 127},
                                                                                  .phalanx_pawn = {7, 18, 29, 103, 127, 119},
                                                                                  .bishop_pair = 92,
                                                                                  .bishop_pawns = {-11, -4},
                                                                                  .king_shield = {-9, -8},
                                                                                  .pawn_attacked_penalty = {-55, -111},
                                                                                  .piece_threats = {62, 32},
                                                                                  .tempo = 29,
                                                                              }};)
...
search(
  ...
  if (tt_hit) {
    ...
    // TT PRUNING
    if (G(194, G(195, tt_entry->flag) != G(195, tt_entry->score <= alpha)) && G(194, tt_entry->depth >= depth) && G(194, G(196, alpha) == G(196, beta - 1))) {
  ...
  if (G(203, !in_check) && G(203, G(204, alpha) == G(204, beta - 1))) {
    if (G(205, depth < 10) && G(205, !in_qsearch)) {
      ...
      G(206, {
        ...
        if (static_eval - G(207, 36) * G(207, (depth - improving)) >= beta) {
          return static_eval;
        }
      })

      G(206, // RAZORING
        in_qsearch = G(208, static_eval) + G(208, G(209, 75) * G(209, depth)) <= alpha;)
    }

    // NULL MOVE PRUNING
    if (G(210, depth > 2) && G(210, do_null) && G(210, static_eval >= beta) &&
        G(210, G(329, pos->colour[0]) & G(329, ~(G(330, pos->pieces[Pawn]) | G(330, pos->pieces[King]))))) {
      Position npos = *pos;
      G(211, flip_pos(&npos);)
      G(211, npos.ep = 0;)
      G(211, A(3, i16, u16, i32, i64) nmp_red = (static_eval - beta) / 114; if (nmp_red > 3) { nmp_red = 3; })
  ...
  for (A(3, u8, i16, u16, i32, u32, i64, u64) move_index = 0; move_index < ss->num_moves; move_index++) {
    ...
    for (A(5, u8, i16, u16, i32, u32, i64, u64) order_index = move_index; order_index < ss->num_moves; order_index++) {
      ...
      const A(1, i32, i64) order_move_score = G(187, // HISTORY HEURISTIC
                                              ...
                                              G(187, // MOST VALUABLE VICTIM
                                                G(219, moves[order_index].takes_piece) * G(219, 557)) +
                                              G(187, // KILLER MOVE
                                                G(216, move_equal(G(217, &moves[order_index]), G(217, &ss->killer))) * G(216, 714)) +
                                              G(187, // COUNTER MOVE
                                                G(327, move_equal(G(328, &moves[order_index]), G(328, &counter))) * G(327, 604)) +
    ...
    G(
        ...
        if (G(225, depth < 5) &&
            G(225, G(226, static_eval) + G(226, G(227, 180) * G(227, depth)) + G(226, initial_params.eg.material[moves[move_index].promo]) +
    ...
    // LATE MOVE REDUCTION
    A(1, i32, i64)
    reduction = G(228, depth > 3) && G(228, move_score <= 0) ? G(229, depth / 11) + G(229, !improving) + G(229, (G(230, alpha) == G(230, beta - 1))) +
                                                                   G(229, (move_score / -334)) + G(229, moves_evaluated / 10)
                                                             : 0;
...
#endif
#else
      for (A(3, i8, u8, i16, u16, i32, u32, i64, u64) i = 2 << main_data->pos.flipped; i > 0; i--) {
        getl(line);
        main_data->max_time = (u64)atoi(line) << 19; // Roughly /2 time
      }
      run_smp();
