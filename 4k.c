...
G(
    1, static ssize_t _sys(H(2, 1, ssize_t arg1), H(2, 1, ssize_t call),
...
G(
    ...
    static bool getl(char *restrict string) {
      while (true) {
        const int result = _sys(H(2, 2, stdin), H(2, 2, 0),
                                H(2, 2, (ssize_t)string), H(2, 2, 1));
...
G(
    14, [[nodiscard]] static u64 ray(H(15, 1, const u64 bb),
...
G(
    17, [[nodiscard]] static u64 bishop(H(21, 1, const u64 blockers),
                                        H(21, 1, const u64 bb)) {
      assert(count(bb) == 1);
      const i32 sq = lsb(bb);
...
G(
    22, static void swapbool(G(23, bool *const restrict rhs),
...
G(
    22,
    static void swapu32(G(27, u32 *const rhs), G(27, u32 *const lhs)) {
      const u32 temp = *lhs;
      *lhs = *rhs;
      *rhs = temp;
    }

    static void swapmoves(G(28, Move *const lhs), G(28, Move *const rhs)) {
      swapu32(G(29, (u32 *)lhs), G(29, (u32 *)rhs));
    })

G(
    22, [[nodiscard]] static bool move_equal(G(30, Move *const lhs),
                                             G(30, Move *const rhs)) {
      return *(u32 *)lhs == *(u32 *)rhs;
    })

G(
    22, static void swapu64(G(31, u64 *const rhs), G(31, u64 *const lhs)) {
      const u64 temp = *lhs;
      *lhs = *rhs;
      *rhs = temp;
    })
...
G(
    32, [[nodiscard]] static u64 get_mobility(H(33, 1, const Position *pos),
                                              H(33, 1, const i32 sq),
...
G(
    32, static void flip_pos(Position *const restrict pos) {
      G(
          34, for (i32 i = 0; i < 2; i++) {
            swapbool(G(35, &pos->castling[i + 2]), G(35, &pos->castling[i]));
          })

      G(34, swapu64(G(36, &pos->colour[1]), G(36, &pos->colour[0]));)
      G(
          34, // Hack to flip the first 10 bitboards in Position.
...
G(
    32, [[nodiscard]] static i32 is_attacked(
            ...
            H(37, 1, const u64 bb), H(37, 1, const i32 them)) {
      assert(count(bb) == 1);
      ...
      const u64 blockers = pos->colour[0] | pos->colour[1];
      return G(38, bishop(H(21, 3, blockers), H(21, 3, bb)) & theirs &
                       (pos->pieces[Bishop] | pos->pieces[Queen])) ||
             G(38, king(bb) & theirs & pos->pieces[King]) ||
             G(38, knight(bb) & theirs & pos->pieces[Knight]) ||
             G(38, rook(H(19, 3, blockers), H(19, 3, bb)) & theirs &
                       (pos->pieces[Rook] | pos->pieces[Queen]));
    })

G(
    39, static Move *generate_pawn_moves(H(40, 1, const Position *const pos),
                                         H(40, 1, const i32 offset),
                                         H(40, 1, u64 to_mask),
      ...
      while (to_mask) {
        ...
        assert(to >= 0);
        assert(to < 64);
        assert(piece_on(H(26, 2, pos), H(26, 2, from)) == Pawn);
        const u8 takes = piece_on(H(26, 3, pos), H(26, 3, to));
        if (to > 55) {
...
G(
    39,
    static Move *generate_piece_moves(H(41, 1, const Position *restrict pos),
                                      H(41, 1, Move *restrict movelist),
                                      H(41, 1, const u64 to_mask)) {
      for (i32 piece = Knight; piece <= King; piece++) {
        ...
        while (copy) {
          ...
          G(42, u64 moves = G(43, get_mobility(H(33, 2, pos), H(33, 2, from),
                                               H(33, 2, piece))) &
                            G(43, to_mask);)
          ...
          while (moves) {
            ...
            G(44, *movelist++ = ((Move){
                      ...
                      .to = to,
                      .promo = None,
                      .takes_piece = piece_on(H(26, 4, pos), H(26, 4, to))});)
            G(44, moves &= moves - 1;)
          }
        }
      }
...
G(
    39, i32 makemove(H(45, 1, Position *const restrict pos),
      ...
      assert(move->takes_piece == piece_on(H(26, 5, pos), H(26, 5, move->to)));

      G(46, const u64 to = 1ull << move->to;)
      G(46, const u64 from = 1ull << move->from;)
      G(47, const u64 mask = from | to;)
      G(47, const i32 piece = piece_on(H(26, 6, pos), H(26, 6, move->from));
        assert(piece != None);)
...
[[nodiscard]] static i32 movegen(H(57, 1, const Position *const restrict pos),
  ...
  if (G(59, !only_captures) && G(59, pos->castling[0]) &&
      G(59, !(all & 0x60ull)) &&
      G(60, !is_attacked(H(37, 3, pos), H(37, 3, 1ULL << 4), H(37, 3, true))) &&
      G(60, !is_attacked(H(37, 4, pos), H(37, 4, 1ULL << 5), H(37, 4, true)))) {
    *movelist++ =
        (Move){.from = 4, .to = 6, .promo = None, .takes_piece = None};
  }
  if (G(61, !only_captures) && G(61, pos->castling[1]) &&
      G(61, !(all & 0xEull)) &&
      G(62, !is_attacked(H(37, 5, pos), H(37, 5, 1ULL << 4), H(37, 5, true))) &&
      G(62, !is_attacked(H(37, 6, pos), H(37, 6, 1ULL << 3), H(37, 6, true)))) {
    *movelist++ =
        (Move){.from = 4, .to = 2, .promo = None, .takes_piece = None};
  }
  movelist = generate_piece_moves(H(41, 2, pos), H(41, 2, movelist),
                                  H(41, 2, to_mask));
...
typedef struct [[nodiscard]] __attribute__((packed)) {
  i16 material[6];
  H(63, 1,
    H(64, 1, i8 passed_blocked_pawns[4];) H(64, 1, i8 mobilities[5];)
        H(64, 1, i8 passed_pawns[4];) H(64, 1, i8 king_attacks[5];)
            H(64, 1, i8 tempo;))
  H(63, 1,
...
typedef struct [[nodiscard]] __attribute__((packed)) {
  i32 material[6];
  H(63, 2,
    H(64, 2, i32 passed_blocked_pawns[4];) H(64, 2, i32 mobilities[5];)
        H(64, 2, i32 passed_pawns[4];) H(64, 2, i32 king_attacks[5];)
            H(64, 2, i32 tempo;))
  H(63, 2,
...
static void init() {
  ...
  G(
      45, for (i32 sq = 0; sq < 64; sq++) {
        const u64 bb = 1ULL << sq;
        diag_mask[sq] =
            G(69, ray(H(15, 4, bb), H(15, 4, ~0x101010101010101ull),
                      H(15, 4, 0), H(15, 4, 9))) | // Northeast
            G(69, ray(H(15, 5, bb), H(15, 5, ~0x8080808080808080ull),
...
static i32 eval(Position *const restrict pos) {
  ...
  for (i32 c = 0; c < 2; c++) {
    ...
    G(
        72, // BISHOP PAIR
        if (count(G(73, pos->pieces[Bishop]) & G(73, pos->colour[0])) > 1) {
          score += eval_params.bishop_pair;
        })
    G(72,
      const u64 own_pawns = G(74, pos->pieces[Pawn]) & G(74, pos->colour[0]);)
    G(72,
      const u64 opp_pawns = G(75, pos->pieces[Pawn]) & G(75, pos->colour[1]);
      const u64 attacked_by_pawns = G(76, se(opp_pawns)) | G(76, sw(opp_pawns));
      const u64 no_passers = G(77, attacked_by_pawns) | G(77, opp_pawns);)
    ...
    for (i32 p = Pawn; p <= King; p++) {
      ...
      while (copy) {
        ...
        G(
            40, // OPEN FILES / DOUBLED PAWNS
            if ((G(80, own_pawns) & G(80, north(0x101010101010101ULL << sq))) ==
        ...
        G(
            ...
            if (G(81, p == Pawn) &&
                ...
                G(81, rank > 2)) {
              G(
                  83, if (north(1ULL << sq) & pos->colour[1]) {
                    score += eval_params.passed_blocked_pawns[rank - 3];
                  })

              G(83, score += eval_params.passed_pawns[rank - 3];)
            })

        G(40, // SPLIT PIECE-SQUARE TABLES FOR FILE
          score += eval_params.pst_file[(p - 1) * 8 + file];)

        G(40, // SPLIT PIECE-SQUARE TABLES FOR RANK
        ...
        G(
            40, if (p > Pawn) {
              ...
              G(84, // KING ATTACKS
                score += G(85, count(G(86, opp_king_zone) & G(86, mobility))) *
                         G(85, eval_params.king_attacks[p - 2]);)
...
static i16 search(H(91, 1, Position *const restrict pos),
  ...
  const bool in_check =
      is_attacked(H(37, 7, pos), H(37, 7, pos->colour[0] & pos->pieces[King]),
                  H(37, 7, true));
  ...
  for (i32 i = G(93, ply) + G(93, pos_history_count);
       G(94, do_null) && G(94, i > 0); i -= 2) {
  ...
  if (tt_entry->partial_hash == tt_hash_partial) {
    ...
    // TT PRUNING
    if (G(96, alpha == beta - 1) && G(96, tt_entry->depth >= depth) &&
  ...
  if (G(99, !in_check) && G(99, alpha == beta - 1)) {
    ...
    // NULL MOVE PRUNING
    if (G(102, static_eval >= beta) &&
        G(102, G(103, pos->colour[0]) & G(103, ~pos->pieces[Pawn]) &
                   G(103, ~pos->pieces[King])) &&
        G(102, do_null) && G(102, depth > 2)) {
      Position npos = *pos;
      flip_pos(&npos);
      npos.ep = 0;
  ...
  for (i32 move_index = 0; move_index < stack[ply].num_moves; move_index++) {
    ...
    for (i32 order_index = move_index; order_index < stack[ply].num_moves;
      ...
      const i32 order_move_score =
          ...
          G(92, // PREVIOUS BEST MOVE FIRST
            (move_equal(G(105, &stack[ply].best_move),
                        G(105, &stack[ply].moves[order_index]))
             << 30)) +
      ...
      if (order_move_score > move_score) {
        G(106, swapmoves(G(107, &stack[ply].moves[move_index]),
                         G(107, &stack[ply].moves[order_index]));)
        G(106, move_score = order_move_score;)
      }
    }
    ...
    if (G(108, depth < 8) &&
        G(108,
          G(109, max_material[stack[ply].moves[move_index].takes_piece]) +
                  G(109, static_eval + 128 * depth) +
                  G(109, max_material[stack[ply].moves[move_index].promo]) <
              alpha) &&
        G(108, !in_check) && G(108, moves_evaluated)) {
      break;
    }
    ...
    i32 reduction = G(110, depth > 1) && G(110, moves_evaluated > 6)
                        ? G(111, 1) + G(111, (alpha == beta - 1)) +
                              G(111, !improving) + G(111, moves_evaluated / 11)
                        : 1;
    ...
    if (score > alpha) {
      G(112, stack[ply].best_move = stack[ply].moves[move_index];)
      G(112, alpha = score;)
      G(112, tt_flag = Exact;)
      if (score >= beta) {
        tt_flag = Lower;
        ...
        G(
            113, if (stack[ply].best_move.takes_piece == None) {
              stack[ply].killer = stack[ply].best_move;
            })
        G(113, const i32 bonus = depth * depth;
          G(114,
            i32 *const this_hist =
            ...
            *this_hist += bonus - bonus * *this_hist / 1024;)
              G(
                  114, for (i32 prev_index = 0; prev_index < move_index;
                            prev_index++) {
    ...
    // LATE MOVE PRUNING
    if (G(115, !in_check) && G(115, alpha == beta - 1) &&
        G(115, quiets_evaluated > 1 + depth * depth >> !improving)) {
      break;
    }
  }
...
#endif
    H(116, 1, Position *const restrict pos),
    H(116, 1, SearchStack *restrict stack),
    H(116, 1, const i32 pos_history_count)) {
  start_time = get_time();
#ifdef FULL
...
static void bench() {
  ...
  iteratively_deepen(20, &nodes, H(116, 2, &pos), H(116, 2, stack),
                     H(116, 2, pos_history_count));
...
static void run() {
  ...
  G(117, Position pos;)
  G(117, char line[4096];)
  G(117, __builtin_memset(move_history, 0, sizeof(move_history));)
  G(117, i32 pos_history_count;)
  G(117, init();)
  ...
  while (true) {
    ...
    if (!strcmp(line, "uci")) {
      ...
      max_time = 99999999999;
      iteratively_deepen(max_ply, &nodes, H(116, 3, &pos), H(116, 3, stack),
                         H(116, 3, pos_history_count));
...
#endif
    G(118, if (line[0] == 'i') { puts("readyok"); })
    else G(118, if (line[0] == 'q') { exit_now(); }) else if (line[0] == 'p') {
      G(119, pos = start_pos;)
      G(119, pos_history_count = 0;)
      while (true) {
        ...
        for (i32 i = 0; i < num_moves; i++) {
          ...
          if (move_string_equal(G(120, line), G(120, move_name))) {
      ...
      iteratively_deepen(max_ply, &nodes, H(116, 4, &pos), H(116, 4, stack),
                         H(116, 4, pos_history_count));
#else
      for (i32 i = 0; i < (pos.flipped ? 4 : 2); i++) {
        getl(line);
        max_time = atoi(line) / 2;
      }
      iteratively_deepen(H(116, 5, &pos), H(116, 5, stack),
                         H(116, 5, pos_history_count));
#endif
    }
  }
}
