...
__attribute__((aligned(8))) static const i16 material[] = {0,   74,  303, 329,
                                                           478, 957, 0};
__attribute__((aligned(8))) static const i8 pst_rank[] = {
    0,   -10, -12, -11, -3, 36, 109, 0,   // Pawn
    -37, -20, -1,  15,  27, 29, 10,  -23, // Knight
    -26, -8,  4,   10,  14, 14, 2,   -11, // Bishop
    -12, -20, -20, -10, 6,  16, 22,  17,  // Rook
    -20, -12, -9,  -3,  6,  16, 7,   16,  // Queen
    -21, -13, -4,  8,   19, 25, 15,  -13, // King
};
__attribute__((aligned(8))) static const i8 pst_file[] = {
    -2,  2,  -5, -2, -1, 5,  10, -8,  // Pawn
    -28, -7, 6,  15, 14, 13, 2,  -14, // Knight
    -13, 0,  3,  5,  6,  1,  4,  -7,  // Bishop
    -3,  0,  3,  4,  3,  7,  -2, -14, // Rook
    -22, -9, 3,  5,  5,  6,  6,  6,   // Queen
    -13, 3,  1,  1,  -1, -2, 6,  -10, // King
};
__attribute__((aligned(8))) static const i8 open_files[] = {0, 28, -10, -8,
                                                            25, 7,  -9};
  ...
  for (i32 c = 0; c < 2; c++) {
    ...
    for (i32 p = Pawn; p <= King; p++) {
      ...
      while (copy) {
        ...
        score += open_files[p] * ((0x101010101010101ULL << sq & ~(1ULL << sq) &
                                   own_pawns) == 0);
