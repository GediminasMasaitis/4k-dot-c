...
__attribute__((aligned(8))) static const i16 material[] = {0,   89,  299, 314,
                                                           486, 963, 0};
__attribute__((aligned(8))) static const i8 pst_rank[] = {
    0,   -10, -12, -11, -3, 36, 113, 0,   // Pawn
    -31, -16, 0,   14,  25, 26, 7,   -26, // Knight
    -25, -7,  4,   9,   13, 14, 2,   -10, // Bishop
    -15, -22, -20, -9,  9,  17, 22,  17,  // Rook
    -22, -14, -9,  -2,  8,  16, 6,   17,  // Queen
    -20, -12, -5,  6,   17, 23, 14,  -13, // King
};
__attribute__((aligned(8))) static const i8 pst_file[] = {
    -2,  3,  -5, -2, -1, 5,  10, -9,  // Pawn
    -28, -7, 6,  16, 15, 12, 1,  -14, // Knight
    -13, 0,  3,  6,  6,  1,  5,  -8,  // Bishop
    -4,  0,  3,  4,  3,  6,  0,  -13, // Rook
    -21, -9, 1,  4,  4,  7,  7,  8,   // Queen
    -13, 2,  1,  0,  -1, -3, 6,  -10, // King
};
__attribute__((aligned(8))) static const i8 open_files[] = {0,  15, -2, -2,
                                                            22, 8,  -7};
