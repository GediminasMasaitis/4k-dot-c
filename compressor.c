...
static void write_html_report(const char *path, const CompStats *s) {
  ...
  fprintf(f,
    ...
    "<style>\n"
    ":root{\n"
    "  --bg:#09090b;--bg2:#0f1013;--bg3:#17181d;--bg4:#212229;\n"
    "  --bdr:#26272e;--bdr2:#35363e;\n"
    "  --fg:#ececee;--fg2:#9da0a8;--fg3:#686b73;\n"
    ...
    "}\n"
    "body.light{\n"
    "  --bg:#f7f7f4;--bg2:#fdfdfc;--bg3:#efefeb;--bg4:#e2e2dc;\n"
    "  --bdr:#dededa;--bdr2:#c6c6bf;\n"
    "  --fg:#171719;--fg2:#4b4c52;--fg3:#85868c;\n"
    ...
    "background-image:"
    "radial-gradient(900px 500px at 80%% -10%%,rgba(34,211,238,.05),transparent 65%%),"
    ...
    ".wrap{padding:28px 32px 72px 32px;margin-left:200px;"
    "max-width:min(1280px,calc(100vw - 200px))}\n"
    "\n"
    "/* ── Sidebar ── */\n"
    ...
    ".sb-brand{display:flex;align-items:center;gap:9px;padding:2px 16px 14px;"
    "border-bottom:1px solid var(--bdr);margin-bottom:8px}\n"
    ".sb-brand .dot{width:8px;height:8px;border-radius:2px;flex-shrink:0;"
    "background:var(--acc);box-shadow:0 0 8px rgba(34,211,238,.55)}\n"
    ".sb-brand span{font-family:var(--mono);font-size:10.5px;font-weight:600;"
    "color:var(--fg);letter-spacing:1.8px;text-transform:uppercase}\n"
    ".sidebar .sb-title{font-family:var(--mono);font-size:9px;font-weight:500;"
    "color:var(--fg3);text-transform:uppercase;letter-spacing:1.6px;"
    "padding:0 16px;margin:14px 0 4px}\n"
    ".sidebar .sb-title::before{content:'// ';color:var(--bdr2)}\n"
    ...
    ".hero-info h1{font-size:26px;font-weight:700;color:var(--fg);"
    "margin-bottom:5px;letter-spacing:-.5px}\n"
    ".hero-info .sub{font-family:var(--mono);font-size:11px;"
    "color:var(--fg3);letter-spacing:.4px}\n"
    ...
    ".hero-stat .lbl{font-family:var(--mono);font-size:9px;color:var(--fg3);"
    ...
    "gap:18px;margin-top:28px;counter-reset:secn}\n"
    ".grid .full{grid-column:1/-1}\n"
    ".card{counter-increment:secn;background:var(--bg2);"
    "border:1px solid var(--bdr);"
    "border-radius:8px;padding:20px 22px;overflow:hidden;"
    "transition:border-color .2s}\n"
    ".card:hover{border-color:var(--bdr2)}\n"
    ".card h2{font-size:12px;font-weight:600;color:var(--fg);"
    "margin-bottom:3px;display:flex;align-items:center;gap:10px;"
    "text-transform:uppercase;letter-spacing:1.5px}\n"
    ".card h2::before{content:counter(secn,decimal-leading-zero);"
    "font-family:var(--mono);font-size:9.5px;font-weight:500;"
    "color:var(--acc);border:1px solid var(--bdr2);border-radius:4px;"
    "padding:1px 5px;flex-shrink:0;letter-spacing:0;line-height:1.4}\n"
    ...
    "th{color:var(--fg3);font-weight:500;text-transform:uppercase;"
    ...
    ".slider-row button{font-size:9px;padding:3px 10px;border:1px solid var(--bdr2);"
    ...
    "border:1px solid var(--bdr2);border-radius:6px;padding:7px 11px;"
    ...
    ".theme-toggle{margin:auto 12px 12px;padding:6px 10px;font-size:9.5px;"
