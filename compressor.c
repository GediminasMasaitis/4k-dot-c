...
#undef CLAMP
  ...
  fprintf(f, "</div><!-- wrap -->\n"
    ...
    "    dfOn=true;dfPh=0;dfI=0;dfFr=0;dfCum=0;\n"
    ...
    "      +'align-items:center;justify-content:center';\n"
    "    dfOv.innerHTML=\n"
    "      '<div style=\"width:'+win+'px;background:#c0c0c0;'\n"
    "      +'border:2px solid;border-color:#fff #404040 #404040 #fff;'\n"
    "      +'box-shadow:6px 6px 0 rgba(0,0,0,.5);cursor:default;'\n"
    "      +'font-family:Tahoma,Verdana,sans-serif;font-size:11px;'\n"
    "      +'color:#000\">'\n"
    "      +'<div style=\"background:linear-gradient(90deg,#000080,'\n"
    "      +'#1084d0);color:#fff;font-weight:bold;padding:3px 6px;'\n"
    "      +'display:flex;justify-content:space-between;'\n"
    "      +'align-items:center\">'\n"
    "      +'<span>Disk Defragmenter - PAQ.EXE</span>'\n"
    "      +'<span id=\"df-x\" style=\"background:#c0c0c0;color:#000;'\n"
    "      +'border:1px solid;border-color:#fff #404040 #404040 #fff;'\n"
    "      +'padding:0 4px;cursor:pointer;font-weight:bold;'\n"
    "      +'line-height:1.2\">\\u00d7</span></div>'\n"
    ...
    "      +'<button id=\"df-stop\" style=\"font-family:inherit;'\n"
    "      +'font-size:11px;padding:3px 16px;background:#c0c0c0;'\n"
    "      +'border:2px solid;border-color:#fff #404040 #404040 #fff;'\n"
    "      +'cursor:pointer\">Stop</button></div>'\n"
    "      +'</div></div>';\n"
    ...
    "    dfFr++;\n"
    "    if(dfPh===0){\n"
    "      if(dfFr>66){dfPh=1;dfFr=0;}\n"
    "    } else if(dfPh===1){\n"
    "      var K=Math.max(1,(dfN/420)|0);\n"
    "      for(var k2=0;k2<K&&dfI<dfN;k2++){dfCum+=BD[dfI].c;dfI++;}\n"
    "      if(dfFr%%3===0) blip(160+Math.random()*760,.012,.025);\n"
    "      if(dfI>=dfN){\n"
    "        dfPh=2;\n"
    ...
    "      dfStatus.textContent='Compacting drive PAQ: '\n"
    "        +((100*dfI/dfN)|0)+'%% ('+dfFmt(inB)+' \\u2192 '\n"
