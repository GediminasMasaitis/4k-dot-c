...
static void write_html_report(const char *path, const CompStats *s) {
  ...
  fprintf(f,
    ...
    "  --sans:'JetBrains Mono',ui-monospace,'Cascadia Code',monospace;\n"
    "  --shadow:5px 5px 0 rgba(0,0,0,.45);\n"
    "}\n"
    "body.light{\n"
    "  --bg:#e8e8ee;--bg2:#f7f7fa;--bg3:#dcdce4;--bg4:#c8c8d4;\n"
    "  --bdr:#b8b8c4;--bdr2:#9494a4;\n"
    "  --fg:#101018;--fg2:#3c3c4c;--fg3:#787888;\n"
    ...
    ".sb-brand{display:flex;align-items:center;gap:10px;padding:2px 16px 14px;"
    "border-bottom:1px solid var(--bdr);margin-bottom:8px}\n"
    ".sb-brand .dot{width:9px;height:9px;border-radius:0;flex-shrink:0;"
    "background:var(--acc);box-shadow:3px 3px 0 var(--pnk)}\n"
    ".sb-brand span{font-family:var(--pix);font-size:8px;font-weight:400;"
    "color:var(--fg);letter-spacing:1px;text-transform:uppercase;"
    "text-shadow:1px 1px 0 rgba(255,63,216,.6)}\n"
    ".sidebar .sb-title{font-family:var(--pix);font-size:7px;font-weight:400;"
    "color:var(--fg3);text-transform:uppercase;letter-spacing:1px;"
    "padding:0 16px;margin:14px 0 5px}\n"
    ".sidebar a{display:block;padding:4px 16px 4px 14px;font-size:11.5px;"
    "color:var(--fg3);text-decoration:none;border-left:2px solid transparent;"
    "transition:color .15s,border-color .15s,background .15s;"
    "line-height:1.5}\n"
    ".sidebar a:hover{color:var(--fg);background:rgba(255,63,216,.07)}\n"
    ".sidebar a.active{color:var(--acc);border-left-color:var(--pnk);"
    ...
    ".hero-pct .lbl{font-family:var(--pix);font-size:7px;color:var(--fg3);"
    "text-transform:uppercase;letter-spacing:1px;margin-top:6px}\n"
    ".hero-info h1{font-family:var(--pix);font-size:14px;font-weight:400;"
    "color:var(--fg);margin-bottom:8px;text-transform:uppercase;"
    "letter-spacing:1px;line-height:1.5;"
    "text-shadow:2px 2px 0 rgba(255,63,216,.55)}\n"
    ".hero-info .sub{font-size:12px;color:var(--fg3)}\n"
    ...
    "line-height:1}\n"
    ".hero-stat .lbl{font-family:var(--pix);font-size:7px;color:var(--fg3);"
    ...
    ".card{position:relative;background:var(--bg2);"
    "border:1px solid var(--bdr);"
    "border-radius:0;padding:24px 24px 22px;overflow:hidden;"
    "box-shadow:var(--shadow);transition:border-color .2s}\n"
    ".card::before{content:'';position:absolute;top:0;left:0;right:0;"
    "height:3px;background:linear-gradient(90deg,var(--pnk),var(--acc),"
    "var(--yel),var(--pnk));background-size:300%% 100%%;"
    "animation:copper 8s linear infinite;opacity:.85}\n"
    ".card:hover{border-color:var(--pnk)}\n"
    ".card h2{font-family:var(--pix);font-size:10px;font-weight:400;"
    "color:var(--fg);margin-bottom:6px;display:flex;align-items:center;"
    "gap:10px;text-transform:uppercase;letter-spacing:1px;line-height:1.6;"
    "text-shadow:2px 2px 0 rgba(255,63,216,.55)}\n"
    ".card h2::before{content:'';width:8px;height:8px;flex-shrink:0;"
    ...
    "border-radius:0;background:var(--bg3);color:var(--fg2);cursor:pointer;"
    "font-family:var(--sans);text-transform:uppercase;letter-spacing:.5px;"
    "box-shadow:2px 2px 0 rgba(0,0,0,.5);"
    "transition:background .1s,color .1s,border-color .1s}\n"
    ".slider-row button:hover{background:var(--bg4);border-color:var(--pnk);"
    "color:var(--fg)}\n"
    ".slider-row button:active{transform:translate(2px,2px);box-shadow:none}\n"
    "\n"
    "/* ── Inspect panel ── */\n"
    ".cd-panel{display:none;margin-top:14px;padding:14px 18px;"
    "background:var(--bg3);border:1px solid var(--bdr2);border-radius:0;"
    ...
    "border:1px solid var(--bdr2);border-radius:0;padding:7px 11px;"
    "font-size:11px;font-family:var(--mono);pointer-events:none;z-index:10;"
    "white-space:nowrap;box-shadow:4px 4px 0 rgba(0,0,0,.55);"
    ...
    ".theme-toggle{margin:auto 12px 12px;padding:6px 10px;font-size:10px;"
...
#undef CLAMP
  ...
  /* footer */
  fprintf(f, "%s",
    "<div class=\"scrolltext\"><span>*** PAQ REPORT *** A CONTEXT-MIXING "
    "CRUNCHER *** SIZE IS EVERYTHING *** GREETINGS TO CRINKLER . FARBRAUSCH "
    ". CONSPIRACY . MERCURY . LOGICOMA . TBC *** KEEP IT UNDER 4K *** "
    "</span></div>\n");
  fprintf(f,
