...
static void emit_report_scripts(FILE *f) {
  fprintf(f, "</div><!-- wrap -->\n"
    ...
    "    gn.gain.exponentialRampToValueAtTime(.001,t+.14);\n"
    "    o.connect(gn);gn.connect(gainM);o.start(t);o.stop(t+.15);\n"
    "    vreg(t,[o]);\n"
    "  }\n"
    ...
    "    fx:0,fe:0,pp:0,str:1,dtn:0,pmp:0,ww:0,sf:0};\n"
    "  var syn={};\n"
