...
static void write_html_report(const char *path, const CompStats *s) {
  ...
  fprintf(f,
    ...
    "family=Inter:wght@400;500;600;700&family=Source+Serif+4:wght@600"
    "&family=JetBrains+Mono:wght@400;500;600&display=swap\" rel=\"stylesheet\">\n"
    "<style>\n"
    ":root{\n"
    "  --bg:#0f1419;--bg2:#161c23;--bg3:#1e252e;--bg4:#28313c;\n"
    "  --bdr:#2c3540;--bdr2:#3b4754;\n"
    "  --fg:#e9edf1;--fg2:#a3adb8;--fg3:#6b7683;\n"
    ...
    "  --shadow:0 1px 2px rgba(16,24,40,.3),0 1px 3px rgba(16,24,40,.25);\n"
    "}\n"
    "body.light{\n"
    "  --bg:#f4f6f8;--bg2:#ffffff;--bg3:#eef1f4;--bg4:#e1e6eb;\n"
    "  --bdr:#dfe3e8;--bdr2:#c5cdd5;\n"
    "  --fg:#1a2332;--fg2:#465364;--fg3:#8593a2;\n"
    "  --acc:#1d4ed8;--acc2:#2563eb;--acc3:#1e40af;\n"
    ...
    ".wrap{padding:24px 32px 64px 32px;margin-left:200px;"
    "max-width:min(1240px,calc(100vw - 200px))}\n"
    "\n"
    "/* ── Sidebar ── */\n"
    ...
    ".sb-brand .dot{width:10px;height:10px;border-radius:3px;flex-shrink:0;"
    "background:var(--acc)}\n"
    ".sb-brand span{font-size:12.5px;font-weight:700;color:var(--fg);"
    "letter-spacing:-.1px}\n"
    ".sidebar .sb-title{font-size:10px;font-weight:600;color:var(--fg3);"
    "text-transform:uppercase;letter-spacing:1px;padding:0 16px;"
    "margin:14px 0 4px}\n"
    ".sidebar a{display:block;padding:5px 16px 5px 14px;font-size:12.5px;"
    "color:var(--fg2);text-decoration:none;border-left:2px solid transparent;"
    "transition:color .15s,border-color .15s,background .15s;"
    "line-height:1.5}\n"
    ".sidebar a:hover{color:var(--fg);background:rgba(37,99,235,.05)}\n"
    ...
    ".hero-info h1{font-family:var(--serif);font-size:30px;font-weight:600;"
    "color:var(--fg);margin-bottom:4px;letter-spacing:-.3px}\n"
    ...
    ".card h2{font-size:13.5px;font-weight:600;color:var(--fg);"
    ...
    "background:var(--bg3);border-bottom:1px solid var(--bdr2)}\n"
    ...
    ".slider-row button{font-size:10.5px;padding:3px 11px;"
    "border:1px solid var(--bdr2);"
    "border-radius:6px;background:var(--bg2);color:var(--fg2);cursor:pointer;"
    "font-family:var(--sans);font-weight:500;"
    "transition:background .12s,color .12s,border-color .12s}\n"
    ".slider-row button:hover{border-color:var(--acc);color:var(--acc)}\n"
    "\n"
    "/* ── Inspect panel ── */\n"
    ...
    "white-space:nowrap;box-shadow:0 8px 24px rgba(16,24,40,.18);"
...
#undef CLAMP
  ...
  fprintf(f, "</div><!-- wrap -->\n"
    ...
    "  }\n"
    "  var saved='light';\n"
    "  try { saved=localStorage.getItem('report-theme')||'light'; } catch(e){}\n"
    "  apply(saved);\n"
