...
#undef CLAMP
  ...
  fprintf(f, "</div><!-- wrap -->\n"
    ...
    "  function blkBuild(){\n"
    "    if(blkW) return;\n"
    "    var nb=Math.min(BD.length,12288);\n"
    "    var BW2=64,tw=32,th=16,hMax=140;\n"
    ...
    "            :'rgba(255,255,255,.85)';\n"
    "          wc.font='8px \"Press Start 2P\",monospace';\n"
    "          wc.fillText(BD[i].ch,sx,ty+3);\n"
    "        }\n"
    "        /* the offset, on the flank of the tall ones */\n"
    "        if(h>=24){\n"
    "          wc.fillStyle='rgba(255,255,255,.45)';\n"
    "          wc.font='8px Consolas,monospace';\n"
    "          wc.fillText(blkHex(i),sx,ty+th/2+12);\n"
    "        }\n"
    "      }\n"
    "    }\n"
    "  }\n"
    ...
    "    var sxc=blkOX+(31.5-blkP)*16;\n"
    "    var syc=blkOY+(31.5+blkP)*8;\n"
    "    var bx=(W/2-sxc+Math.sin(blkT*.2)*50)|0;\n"
    "    var by=(H/2-syc)|0;\n"
