...
#undef CLAMP
  ...
  fprintf(f, "</div><!-- wrap -->\n"
    ...
    "  var glz=document.getElementById('glenz'),glzN=0;\n"
    "  if(glz){\n"
    ...
    "      if(dragOn&&dragged&&ring&&\n"
    "         document.body.classList.contains('party')){\n"
    "        var rr=ring.getBoundingClientRect();\n"
    "        var cr=glz.getBoundingClientRect();\n"
    "        if(!(cr.right<rr.left||cr.left>rr.right||\n"
    "             cr.bottom<rr.top||cr.top>rr.bottom)){\n"
