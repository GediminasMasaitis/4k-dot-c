...
static void emit_report_scripts(FILE *f) {
  fprintf(f, "</div><!-- wrap -->\n"
    ...
    "    scopeCtx.fillStyle='rgba(52,211,153,.10)';\n"
    ...
    "    scopeCtx.shadowColor='#34d399';scopeCtx.shadowBlur=4;\n"
...
static void write_html_report(const char *path, const CompStats *s) {
  ...
  fprintf(f,
    ...
    "   (the typed keyword). the !important flags outrank the panel's\n"
    "   inline neon, which stays the shipped look */\n"
    "#synth-ov .sy-ar{display:none}\n"
    "body.ptsyn #syn-bx{background:#8494a8!important;"
    "border:2px solid!important;"
    "border-color:#c6d2de #404e60 #404e60 #c6d2de!important;"
    "color:#0a0e14!important;"
    "box-shadow:6px 6px 0 rgba(0,0,0,.5)!important}\n"
    "body.ptsyn #syn-ttl{background:#04080c!important;"
    "color:#cfe0f0!important;font-size:9px!important;"
    "text-align:center!important;text-shadow:none!important;"
    "padding:5px 8px;border:1px solid;"
    "border-color:#404e60 #c6d2de #c6d2de #404e60}\n"
    "body.ptsyn #syn-bx>div:last-child{color:#26303c!important}\n"
    "body.ptsyn #synth-ov button{background:#8494a8!important;"
    "color:#0a0e14!important;border:2px solid!important;"
    "border-color:#c6d2de #404e60 #404e60 #c6d2de!important;"
    "text-transform:uppercase}\n"
    "body.ptsyn #synth-ov button:active{"
    "border-color:#404e60 #c6d2de #c6d2de #404e60!important;"
    "background:#76869a!important}\n"
    "body.ptsyn #synth-ov select{background:#04080c!important;"
    "color:#cfe0f0!important;border:1px solid!important;"
    "border-color:#404e60 #c6d2de #c6d2de #404e60!important}\n"
    "body.ptsyn #synth-ov span[id^=\"synv-\"]{background:#04080c;"
    "color:#cfe0f0!important;"
    "border:1px solid;border-color:#404e60 #c6d2de #c6d2de #404e60;"
    "padding:1px 3px}\n"
    "body.ptsyn #synth-ov .sy-ar{display:block;width:13px;flex-shrink:0;"
    "text-align:center;background:#8494a8;border:1px solid;"
    "border-color:#c6d2de #404e60 #404e60 #c6d2de;color:#0a0e14;"
    "cursor:pointer;font-size:7px;line-height:1.5;user-select:none}\n"
    "body.ptsyn #synth-ov .sy-ar:active{"
    "border-color:#404e60 #c6d2de #c6d2de #404e60;background:#76869a}\n"
    "body.ptsyn #synth-ov input[type=range]{-webkit-appearance:none;"
    "appearance:none;height:11px;background:#04080c;border:1px solid;"
    "border-color:#404e60 #c6d2de #c6d2de #404e60;border-radius:0}\n"
    "body.ptsyn #synth-ov input[type=range]::-webkit-slider-thumb{"
    "-webkit-appearance:none;width:16px;height:9px;background:#8494a8;"
    "border:1px solid;border-color:#c6d2de #404e60 #404e60 #c6d2de;"
    "border-radius:0}\n"
    "body.ptsyn #synth-ov input[type=range]::-moz-range-thumb{"
    "width:16px;height:9px;"
    "background:#8494a8;border:1px solid #404e60;border-radius:0}\n"
    "/* the rest of the stage follows the keyword: steel frames,\n"
    "   black-glass displays. the synth is the control panel; the\n"
    "   tracker and the rack are its screens */\n"
    "body.ptsyn #tu-bx,body.ptsyn #au-bx{"
    "border:2px solid!important;"
    "border-color:#c6d2de #404e60 #404e60 #c6d2de!important;"
    "box-shadow:6px 6px 0 rgba(0,0,0,.5)!important}\n"
    "body.ptsyn #tu-ttl,body.ptsyn #au-ttl{color:#cfe0f0!important;"
    "text-shadow:none!important;background:#04080c;text-align:center;"
    ...
    "border:2px solid;border-color:#c6d2de #404e60 #404e60 #c6d2de;"
    "box-shadow:5px 5px 0 rgba(0,0,0,.5)}\n"
    "body.ptsyn #paqtrk.on::before,body.ptsyn #paqscope.on::before,"
    "body.ptsyn #paqspec.on::before,body.ptsyn #paqsg.on::before,"
    "body.ptsyn #paqvec.on::before{animation:none;background:#8494a8}\n"
    "body.ptsyn #paqtrk .pt-head{background:#8494a8;color:#0a0e14;"
    "text-shadow:none;border-bottom:1px solid #404e60}\n"
    "body.ptsyn #paqtrk .pt-head span{color:#26303c;text-shadow:none}\n"
    "body.ptsyn #paqtrk .pt-row.cur{background:rgba(132,148,168,.28);"
    "outline:1px solid #8494a8}\n"
    "body.ptsyn #paqtrk .pt-row.cur .nt{color:#cfe0f0}\n"
    "</style></head><body>\n"
    "<div id=\"stars\"></div>\n"
