...
#undef CLAMP
  ...
  fprintf(f, "</div><!-- wrap -->\n"
    ...
    "  function srcC(i){return (tuOn&&tuCN)?tuCN[i]:BD[i].c;}\n"
    "  function srcH(i){return (tuOn&&tuBytes)?hx2(tuBytes[i]):BD[i].h;}\n"
    ...
    "  var tuBase=null,tuTBase=0,tuSV0=null;\n"
    ...
    "      tuCtx.globalAlpha=.25+.75*Math.min(1,tuCN[i]/8);\n"
    "      tuCtx.fillStyle=tuCN[i]<3?'#34d399':tuCN[i]<6?'#fbbf24':'#f87171';\n"
