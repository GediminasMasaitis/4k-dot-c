...
#undef CLAMP
  ...
  fprintf(f, "</div><!-- wrap -->\n"
    ...
    "      if(!drag) return;\n"
    "      var nl=bx0+e.clientX-sx,nt=by0+e.clientY-sy;\n"
    ...
    "    });\n"
    "    /* a drag must not count as the dismiss-click on modal boxes */\n"
