...
#undef CLAMP
  ...
  fprintf(f, "</div><!-- wrap -->\n"
    ...
    "        if(buf.slice(-5)==='voxel'){buf='';voxToggle();return;}\n"
    ...
    "  var eggSet={},eggN=0,EGG_TOTAL=33;\n"
    ...
    "    }\n"
    "    rotoSize();\n"
    "    flyStop();voxStop();tnStop(); /* one background at a time */\n"
    "    rotoOn=true;\n"
    ...
    "    }\n"
    "    voxSize();\n"
    "    flyStop();rotoStop();tnStop(); /* one background at a time */\n"
    "    voxOn=true;\n"
