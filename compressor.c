...
static void write_html_report(const char *path, const CompStats *s) {
  ...
  fprintf(f,
    ...
    "body.crt .wrap{filter:url(#crtwarp);"
    ...
    "z-index:10001;pointer-events:none;border-radius:38px;"
    "box-shadow:0 0 0 140px #030304,"
    "inset 0 0 150px 36px rgba(0,0,0,.55),"
    "inset 0 0 40px 6px rgba(120,200,255,.05)}\n"
    "body.crt #crt-glass::before{content:'';position:absolute;"
    "inset:0;border-radius:38px;"
    "background:repeating-linear-gradient(90deg,"
    "rgba(255,60,60,.05) 0 1px,rgba(60,255,90,.05) 1px 2px,"
    "rgba(80,120,255,.05) 2px 3px)}\n"
...
#undef CLAMP
  ...
  fprintf(f, "</div><!-- wrap -->\n"
    ...
    "    if(!w) return;\n"
    "    var W=w.offsetWidth,H=w.scrollHeight;\n"
    "    var f=crtSvg.querySelector('filter');\n"
    "    f.setAttribute('x',-60);f.setAttribute('y',-60);\n"
    "    f.setAttribute('width',W+120);f.setAttribute('height',H+120);\n"
