...
static void emit_report_scripts(FILE *f) {
  fprintf(f, "</div><!-- wrap -->\n"
    ...
    "    var mm=0,m0=-1;\n"
    "    /* the payload encodes the ORIGINAL input: while tuner edits\n"
    "       are committed to BD, grade against the pristine snapshot -\n"
    "       the tuned bytes were never encoded */\n"
    ...
    "      showToast(tuned?'TRUE. MINUS YOUR EDITS.':'IT WAS ALL TRUE');\n"
    "      blip(523,.05,.12);\n"
