...
#undef CLAMP
  ...
  fprintf(f, "</div><!-- wrap -->\n"
    ...
    "      out+=trkRow(fi,e.s+k,BD[fi].c,false);\n"
    "    }\n"
    ...
    "  var fp=null,fpH=null,fpDT=null,fpJ=null,fpJN=0;\n"
    "  function fpHdr(){\n"
    "    if(fpH) return fpH;\n"
    ...
    "    fp=null;\n"
    "    return {bits:total,perByte:perByte};\n"
    "  }\n"
    ...
    "  function tuScore(){\n"
    "    var t0=performance.now();\n"
    "    var r=fpScore(tuBytes);\n"
    "    tuMs=performance.now()-t0;\n"
    "    tuCN=r.perByte;tuTN=r.bits;\n"
    "    tuN=0;\n"
    ...
    "      +'<br>BKSP REVERT BYTE - U UNDO - R RESET ALL - ESC OUT'\n"
