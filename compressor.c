...
#undef CLAMP
  ...
  fprintf(f, "</div><!-- wrap -->\n"
    ...
    "  var eggSet={},eggN=0,EGG_TOTAL=53;\n"
    ...
    "  var fp=null,fpH=null,fpDT=null;\n"
    "  function fpHdr(){\n"
    "    if(fpH) return fpH;\n"
    ...
    "    /* the table is kept and re-zeroed, not reallocated: compose\n"
    "       mode will call this once per edit, and fill(0) is cheap */\n"
    ...
    "    document.body.appendChild(ov);\n"
    "    if(!ok) showGuru();\n"
    "    else showToast('RE-PRICED. THE NUMBERS HOLD');\n"
    "  }\n"
