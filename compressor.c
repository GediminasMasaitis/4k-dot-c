...
#undef CLAMP
  ...
  fprintf(f, "</div><!-- wrap -->\n"
    ...
    "    mg.gain.exponentialRampToValueAtTime(fq*idx*.1+.001,t+dur);\n"
    "    m2.connect(mg);mg.connect(c2.frequency);\n"
    "    cg.gain.setValueAtTime(g,t);\n"
    "    cg.gain.exponentialRampToValueAtTime(.001,t+dur);\n"
    "    c2.connect(cg);cg.connect(dest);\n"
    "    m2.start(t);c2.start(t);\n"
    "    m2.stop(t+dur+.01);c2.stop(t+dur+.01);\n"
    "    vreg(t,[c2,m2]);\n"
    "  }\n"
    "  function fmToggle(){\n"
    "    fmOn=!fmOn;\n"
    ...
    "          g2.gain.setValueAtTime((.014+.038*(q/15))*syn.bgx+.001,t);\n"
    "          g2.gain.exponentialRampToValueAtTime(.001,t+syn.ld);\n"
    "          o2.connect(g2);g2.connect(panTo(bandPan(ci)));\n"
    "          o2.start(t);o2.stop(t+syn.ld+.01);\n"
    "          vreg(t,[o2]);\n"
    "        }\n"
    "      }\n"
    "    }\n"
    ...
    "        g.gain.setValueAtTime(syn.lg+.001,t);\n"
    "        g.gain.exponentialRampToValueAtTime(.001,t+syn.ld);\n"
    ...
    "        bg.gain.setValueAtTime(syn.bg+.001,t);\n"
    ...
    "        gainM.connect(rvConv);\n"
    "        rvConv.connect(rvGain);\n"
    "        rvGain.connect(actx.destination);\n"
