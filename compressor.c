...
#undef CLAMP
  ...
  fprintf(f, "</div><!-- wrap -->\n"
    ...
    "  var fp=null,fpH=null,fpDT=null,fpJ=null,fpJN=0,fpM=null;\n"
    "  function fpHdr(){\n"
    "    if(fpH) return fpH;\n"
    ...
    "        var fq=BF[+rects[k].getAttribute('data-b')];\n"
    "        if(!fq){rects[k].setAttribute('fill','var(--bg3)');continue;}\n"
    "        var t=(Math.log2(fq)+1)/(lf+1);\n"
