...
#undef CLAMP
  ...
  fprintf(f, "</div><!-- wrap -->\n"
    ...
    "    if(curE){sonMark(curE.i);trkRender(curE);}\n"
    ...
    "  var flyRaf=null,flyStars=null,flyCur=0,flyConst=false;\n"
    "  function flyInit(){\n"
    ...
    "  var rotoTex=null,rotoImg=null,rotoPix=null,rotoT=0;\n"
    ...
    "    rotoT+=.016;\n"
    "    var sc=1.6+Math.sin(rotoT*.5)*1.1;\n"
    ...
    "  var tnR=null,tnG=null,tnB=null,tnT=0,tnV=0,tnU=0;\n"
    "  function tnBuildTex(){\n"
    "    if(tnR) return;\n"
    "    var nb=BD.length;\n"
    ...
    "  var kfImg=null,kfPix=null,kfVmax=0;\n"
    "  function kfBuild(){\n"
