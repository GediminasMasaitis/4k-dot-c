...
static void emit_report_scripts(FILE *f) {
  fprintf(f, "</div><!-- wrap -->\n"
    ...
    "  function kick(t,g,f0,f1,d2,dest){\n"
    ...
    "      if(c<syn.t1){\n"
    "        var x=4,y=7;\n"
    "        if(sonKey){var sc2=KEYSC[sonKey.mi];x=sc2[2];y=sc2[4];}\n"
    ...
    "        if((0x4444>>sp)&1) gbass(mf(grt-12),.08,.17,t,'square');\n"
    "      } else if(GEN.bs==='psy'){\n"
    ...
    "          fmVoice(mf(n),(syn.lg*1.4+.001)*acc,syn.ld,t,\n"
    "            panTo(notePan),1,fi2);\n"
    "        }else{\n"
    "          var o=actx.createOscillator(),g=actx.createGain();\n"
    "          o.type=syn.wave;o.frequency.value=mf(n);\n"
    "          var te=envA(g,(syn.lg+.001)*acc,t,syn.ld);\n"
    "          fxLead(o,mf(n),t,syn.atk+syn.ld,leadC,step);\n"
    ...
    "            var o2=actx.createOscillator(),g2=actx.createGain();\n"
    "            o2.type=syn.wave;\n"
    "            o2.frequency.value=mf(n)*Math.pow(2,-syn.dtn/1200);\n"
    "            var te2=envA(g2,(syn.lg*.6+.001)*acc,t,syn.ld);\n"
