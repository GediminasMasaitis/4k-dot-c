...
static void emit_report_scripts(FILE *f) {
  fprintf(f, "</div><!-- wrap -->\n"
    ...
    "    s.connect(g);g.connect(panTo(p||0));s.start(t);s.stop(t+.08);\n"
    "    vreg(t,[s]);\n"
    "  }\n"
    ...
    "        fmVoice(mf(n),syn.lg*1.4+.001,syn.ld,t,panTo(notePan),1,fi2);\n"
    "      }else{\n"
    "        var o=actx.createOscillator(),g=actx.createGain();\n"
    "        o.type=syn.wave;o.frequency.value=mf(n);\n"
    "        var te=envA(g,syn.lg+.001,t,syn.ld);\n"
    ...
    "      /* keyed sonify sits on a tonic pedal */\n"
    ...
    "  var eggSet={},eggN=0,EGG_TOTAL=58;\n"
    ...
    "    var num=fpH.num,weights=fpH.weights,ext=fpH.ext;\n"
    ...
    "    if(wfOn) wfStop();\n"
    "    if(sbOn) sbStop();\n"
    "    var file=new Uint8Array(H.co+d.pay);\n"
    ...
    "    var nb=bytes.length;\n"
    "    try{\n"
    "      rc={bytes:bytes,H:H,nb:nb,bitlen:nb*8+1,\n"
    "        num:H.num,weights:H.weights,ext:H.ext,\n"
