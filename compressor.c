...
#undef CLAMP
  ...
  fprintf(f, "</div><!-- wrap -->\n"
    ...
    "  var eggSet={},eggN=0,EGG_TOTAL=36;\n"
    ...
    "    var seq=[rotoToggle,voxToggle,tnToggle,blkToggle],si=0;\n"
    "    finaleCyc=setInterval(function(){seq[si%%4]();si++;},6800);\n"
    "    function endF(){\n"
    "      if(finaleCyc){clearInterval(finaleCyc);finaleCyc=null;}\n"
    "      finaleEnd=null;\n"
    "      noToast=false;\n"
    "      if(ov.parentNode) ov.remove();\n"
    "      rotoStop();voxStop();tnStop();blkStop();\n"
    "      if(document.body.classList.contains('party')){\n"
    "        flyStart();\n"
    ...
    "    }\n"
    "    rotoSize();\n"
    "    flyStop();voxStop();tnStop();blkStop();\n"
    "    rotoOn=true;\n"
    ...
    "    }\n"
    "    voxSize();\n"
    "    flyStop();rotoStop();tnStop();blkStop();\n"
    "    voxOn=true;\n"
    ...
    "    }\n"
    "    tnSize();\n"
    "    flyStop();rotoStop();voxStop();blkStop();\n"
    "    tnOn=true;\n"
    ...
    "    }\n"
    "    blkSize();\n"
    "    flyStop();rotoStop();voxStop();tnStop();\n"
    "    blkOn=true;\n"
